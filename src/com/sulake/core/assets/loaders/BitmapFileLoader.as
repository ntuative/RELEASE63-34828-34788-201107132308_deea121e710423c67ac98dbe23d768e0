package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      {
         super();
         this.var_1147 = param2 == null ? "" : param2.url;
         this._type = param1;
         ...
         {
            this.var_44.load(param2,this.var_1148);
         }
      }
      ...
      {
         this.var_1147 = param1.url;
         var_361 = 0;
         this.var_44.load(param1,this.var_1148);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_361 < var_3056)
            {
               ...
               this.var_44.load(new URLRequest(this.var_1147 + (this.var_1147.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_361),this.var_1148);
               return true;
            }
         }
         return false;
