package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      private var var_545:IConnectionStateListener;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this.var_217 = new Timer(const_1732,1);
      ...
      public function init(param1:String, param2:uint = 0) : Boolean
      {
         ...
         if(this.var_545)
         {
            this.var_545.connectionInit(param1,param2);
         }
         Security.loadPolicyFile("xmlsocket://" + param1 + ":" + param2);
         this.var_217.start();
         this.var_804 = getTimer();
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc6_:ByteArray = this.var_803.encoder.encode(_loc4_,_loc5_,param2);
         if(this.var_545)
         {
            this.var_545.messageSent(String(_loc4_),_loc6_.toString());
         }
      ...
      override public function toString() : String
      {
         ...
         _loc1_ += "Protocol Encoder: " + this.var_803.encoder + "\n";
         _loc1_ += "Protocol Decoder: " + this.var_803.decoder + "\n";
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_803.getMessages(this.var_544,receivedMessages);
         try
         {
            for each(message in receivedMessages)
            {
               ...
               if(this.var_545)
               {
                  this.var_545.messageReceived(String(id),data.toString());
               }
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         {
            this.var_544.writeByte(this.var_84.readUnsignedByte());
         }
      }
      ...
      private function onConnect(param1:Event) : void
      {
         ...
         this.var_217.stop();
         this.var_1821 = true;
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - this.var_804));
      ...
      private function onClose(param1:Event) : void
      {
         ...
         this.var_1821 = false;
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - this.var_804));
         dispatchEvent(param1);
      }
      ...
      private function onComplete(param1:Event) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - this.var_804));
         dispatchEvent(param1);
      }
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - this.var_804));
         dispatchEvent(param1);
      }
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - this.var_804));
         switch(param1.type)
         {
      ...
      private function onTimeOutTimer(param1:TimerEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - this.var_804));
