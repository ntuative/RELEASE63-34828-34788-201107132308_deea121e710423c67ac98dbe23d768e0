package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      protected static const const_469:String = "_INTERNAL_EVENT_UNLOCKED";
      
      public static const COMPONENT_FLAG_NULL:uint = 0;
      
      public static const const_2201:uint = 1;
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            this.var_1431 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(this.var_1431);
         }
         var _loc3_:uint = _loc2_.release();
         if(this.var_1529 & const_1173)
         {
            if(_loc3_ == 0)
            {
      ...
      protected final function unlock() : void
      {
         ...
         {
            this.var_1141 = false;
            this._events.dispatchEvent(new LockEvent(const_469,this));
         }
      }
      
      public function toString() : String
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + this.var_770 + "]";
      }
