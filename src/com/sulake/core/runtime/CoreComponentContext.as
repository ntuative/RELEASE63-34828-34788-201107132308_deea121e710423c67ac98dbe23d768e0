package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1520:String = "asset-libraries";
      
      private static const const_1524:String = "library";
      
      private static const const_1522:String = "service-libraries";
      
      private static const const_1525:String = "library";
      
      private static const const_1523:String = "component-libraries";
      
      private static const const_1518:String = "library";
      
      private static const const_1526:String = "error_data";
      
      private static const const_1521:String = "error_cat";
      
      private static const const_1519:String = "error_desc";
       
      
      private var var_386:LibraryLoaderQueue;
      
      private var var_815:IEventDispatcher;
      
      private var var_550:uint;
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         switch(param2 & 0)
         {
            ...
            case Core.const_990:
               ...
               var_432.addChild(new ProfilerViewer(this.var_219));
               break;
            case Core.const_535:
      ...
      {
         return this.var_550 - this.getNumberOfFilesPending();
      }
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            try
            {
               ...
               {
                  receivers = this.var_282[i] as Array;
      ...
      override public function error(param1:String, param2:Boolean, param3:int = -1, param4:Error = null) : void
      {
         if(param4)
         {
            ErrorReportStorage.setParameter(const_1526,String(param4.getStackTrace()));
         }
         ErrorReportStorage.setParameter(const_1521,String(param3));
         ErrorReportStorage.setParameter(const_1519,param1);
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         this.var_815 = loadingEventDelegate;
         if(this.var_386 == null)
         {
         ...
         try
         {
            node = config.child(const_1520)[0];
            if(node != null)
            {
               list = node.child(const_1524);
         ...
         try
         {
            node = config.child(const_1522)[0];
            if(node != null)
            {
         ...
         try
         {
            node = config.child(const_1523)[0];
            if(node != null)
            {
               list = node.child(const_1518);
               for each(item in list)
               {
                  url = item.attribute("url").toString();
                  loader = new LibraryLoader(context,true,_debug);
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         this.error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1370);
         if(!disposed)
         {
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(this.var_815)
         {
            this.var_815.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(this.var_815)
         {
            ...
            this.var_815.dispatchEvent(new LibraryProgressEvent(_loc2_.url,param1.bytesLoaded,param1.bytesTotal,_loc2_.elapsedTime));
         }
      }
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_815)
                  {
                     this.var_815.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_550 - this.var_386.length,this.var_550,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:int = !!this.var_219 ? 0 : this.var_1529 & 0;
         if(_loc3_ == Core.const_535)
         {
            this.var_282[param2].push(new UpdateDelegate(param1,this,param2));
         }
         else
         {
            this.var_282[param2].push(param1);
         }
      }
      ...
      override public function removeUpdateReceiver(param1:IUpdateReceiver) : void
      {
         ...
         var _loc4_:int = !!this.var_219 ? 0 : this.var_1529 & 0;
         var _loc5_:int = 0;
         while(_loc5_ < CoreComponentContext.const_107)
         {
            _loc3_ = this.var_282[_loc5_] as Array;
            if(_loc4_ == Core.const_535)
            {
      ...
      private function simpleFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         {
            this.var_660[priority] = 0;
            receivers = this.var_282[priority];
            index = 0;
            length = receivers.length;
            while(index != length)
            {
      ...
      private function complexFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         while(priority < CoreComponentContext.const_107)
         {
            ...
            {
               if(this.var_660[priority] < priority)
               {
                  ++this.var_660[priority];
                  skip = true;
               }
            }
            if(!skip)
