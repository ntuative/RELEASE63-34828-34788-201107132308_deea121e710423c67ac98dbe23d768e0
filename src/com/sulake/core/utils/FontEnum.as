package com.sulake.core.utils
{
   ...
   public class FontEnum
   {
      ...
      private static const const_725:Map = new Map();
      
      private static const const_390:Map = new Map();
      
      private static var var_1374:Boolean = false;
      ...
      {
         return const_725.getValue(param1) != null;
      }
      ...
      private static function init() : void
      {
         ...
         if(!var_1374)
         {
            ...
            for each(_loc3_ in _loc1_)
            {
               ...
               {
                  const_725.add(_loc3_.fontName,_loc3_);
               }
            }
            var_1374 = true;
         }
