package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_2063:uint = 1;
      
      protected static const const_2062:uint = 2;
      
      protected static const const_2060:uint = 4;
      
      protected static const const_2061:uint = 3;
      
      protected static const name_5:uint = 7;
      
      public static const const_1843:int = 5;
      
      public static const LIBRARY_LOADER_FINALIZE:String = "LIBRARY_LOADER_FINALIZE";
      
      public static const const_1296:Boolean = false;
      
      public static const const_2006:int = 2;
      
      private static var var_1132:Array = new Array();
      
      private static var var_916:Array = new Array();
      ...
      protected var var_723:Class;
      
      protected var var_515:uint = 0;
      
      protected var _name:String;
      
      protected var var_1155:Boolean = false;
      
      protected var _debug:Boolean = false;
      
      protected var var_1156:Boolean = false;
      
      protected var var_3067:String = "";
      ...
      protected var var_3066:Boolean = true;
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1296)
         {
            ...
            while(_loc2_ > -1)
            {
               _loc1_ = var_916[_loc2_] as LibraryLoader;
               if(_loc1_ && (_loc1_.ready || _loc1_.disposed))
               {
                  var_916.splice(_loc2_,1);
               }
               _loc2_--;
            }
            while(var_916.length < const_2006 && false)
            {
               _loc1_ = var_1132.shift() as LibraryLoader;
      ...
      {
         return !!this.var_1155 ? uint(this.var_1427 - this.var_2274) : uint(getTimer() - this.var_2274);
      }
      ...
      {
         if(this.var_1156 && !_disposed)
         {
            this.var_1156 = false;
            if(!this.var_1155 && this.var_269)
            {
               this.var_1427 = -1;
      ...
      {
         if(!this.var_1155 && !_disposed && this.var_1428 > 0)
         {
            try
            {
               this.var_44.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_269,const_1843 - this.var_1428);
            if(this.var_3066)
            {
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case TimerEvent.TIMER:
               ...
               if(!_disposed)
               {
                  this.var_515 = LibraryLoader.name_5;
         ...
         if(this.var_515 == LibraryLoader.const_2061)
         {
         ...
         if(this.var_515 == LibraryLoader.name_5)
         {
      ...
      protected function prepareLibrary() : Boolean
      {
         ...
         this.var_723 = this.getDefinition(this._name) as Class;
         ...
         try
         {
            xmlClass = this.var_723.manifest as Class;
            if(xmlClass == null)
            {
               return false;
            }
