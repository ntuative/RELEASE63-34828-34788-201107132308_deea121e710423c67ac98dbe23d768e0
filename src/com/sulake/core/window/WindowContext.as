package com.sulake.core.window
{
   ...
   public class WindowContext implements IWindowContext, IDisposable, IUpdateReceiver
   {
      ...
      public static const const_2168:int = 1;
      
      public static const const_2131:int = 2;
      
      public static const const_2320:int = 3;
      ...
      private static var var_746:IEventProcessor;
      
      private static var var_2208:uint = const_572;
      ...
      private var var_3041:EventProcessorState;
      
      private var var_3042:IWindowContextStateListener;
      
      protected var _localization:ICoreLocalizationManager;
      
      protected var var_150:DisplayObjectContainer;
      
      protected var var_3107:Boolean = true;
      
      protected var var_1431:Error;
      ...
      protected var var_3070:IWindowFactory;
      ...
      private var var_3040:Boolean = false;
      ...
      public function WindowContext(param1:String, param2:IWindowRenderer, param3:IWindowFactory, param4:ICoreLocalizationManager, param5:DisplayObjectContainer, param6:Rectangle, param7:IWindowContextStateListener)
      {
         ...
         this.var_3041 = new EventProcessorState(var_180,this.var_96,this.var_96,null,this.var_3042);
         inputMode = const_572;
      ...
      public static function set inputMode(param1:uint) : void
      {
         ...
         if(var_746)
         {
            if(var_746 is IDisposable)
            {
               IDisposable(var_746).dispose();
            }
         }
         switch(value)
         {
            case const_572:
               ...
               var_746 = new MouseEventProcessor();
               try
               {
               }
               catch(e:Error)
            ...
            case const_1896:
               ...
               var_746 = new TabletEventProcessor();
               try
               {
               }
               catch(e:Error)
      ...
      public function create(param1:String, param2:String, param3:uint, param4:uint, param5:uint, param6:Rectangle, param7:Function, param8:IWindow, param9:uint, param10:Array = null, param11:Array = null) : IWindow
      {
         ...
         if(_loc13_ == null)
         {
            this.handleError(WindowContext.const_1870,new Error("Failed to solve implementation for window \"" + param1 + "\"!"));
            return null;
         }
         if(param8 == null)
         {
      ...
      public function destroy(param1:IWindow) : Boolean
      {
         ...
         if(param1.state != WindowState.const_544)
         {
            param1.destroy();
         }
         return true;
      ...
      public function update(param1:uint) : void
      {
         ...
         var_746.process(this.var_3041,var_427);
         this.var_603 = false;
      }
