package com.sulake.core.window.components
{
   ...
   public class BubbleController extends FrameController implements IBubbleWindow
   {
      ...
      private static const const_2067:String = "_POINTER_UP";
      
      private static const const_2065:String = "_POINTER_DOWN";
      
      private static const const_2066:String = "_POINTER_LEFT";
      
      private static const const_2068:String = "_POINTER_RIGHT";
      ...
      public function set direction(param1:String) : void
      {
         ...
         if(param1 != this._direction)
         {
            ...
            this.pointerOffset = this.var_778;
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_969,this._direction,PropertyStruct.const_51,true));
         }
         else
         {
         ...
         if(this.var_778 != 0)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_792,this.var_778,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1995);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_969:
