package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      public function set selection(param1:int) : void
      {
         ...
         var _loc2_:WindowEvent = WindowEvent.allocate(WindowEvent.const_374,this,null,true);
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_196 == null || this.var_196.disposed)
         {
            this.var_196 = context.create(name + "::submenu","",WindowType.const_669,var_92,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_1012 = false;
            this.getTitleLabel().text = this.var_659 < this.var_281.length && this.var_659 > -1 ? this.var_281[this.var_659] : caption;
         }
      }
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_547,var_92,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_412,var_92,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         ...
         {
            _loc4_.getListItemAt(this.var_659).setStateFlag(WindowState.const_57,true);
         }
      }
      ...
      {
         var _loc3_:* = 0;
         if(param1.type == WindowMouseEvent.const_46 || param1.type == WindowTouchEvent.const_845)
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowTouchEvent.const_1200:
            case WindowMouseEvent.const_56:
               ...
               break;
            case WindowTouchEvent.const_778:
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_281.length)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_1024,this.var_281,PropertyStruct.const_156,true));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_1024)
            {
