package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1634:String = "_TITLE";
      
      private static const const_1680:String = "_HEADER";
      
      private static const const_1681:String = "_CONTENT";
      
      private static const const_1679:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1655:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1634) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1655 = findChildByTag(const_1680) as IHeaderWindow;
            if(!this.var_1655)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_211 = findChildByTag(const_1681) as IWindowContainer;
            if(!this.var_211)
            {
      ...
      {
         return findChildByTag(const_1679) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1414,_loc2_,false);
      ...
      {
         return this.content != null && this.var_1155 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_351);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_315);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_246);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_315,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_315,false);
            }
            if(_loc4_ || _loc2_)
            {
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_251,_loc3_.left,PropertyStruct.const_37,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_268,_loc3_.top,PropertyStruct.const_37,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_258,0 - _loc3_.right,PropertyStruct.const_37,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_255,0 - _loc3_.bottom,PropertyStruct.const_37,_loc2_));
         return _loc1_;
      }
