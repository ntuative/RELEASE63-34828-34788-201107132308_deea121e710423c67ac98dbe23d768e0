package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_1086:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_883:String;
      
      private var var_1338:String = null;
      
      private var var_2087:StyleSheet = null;
      ...
      {
         this.var_883 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1338 == param2)
         {
            return;
         }
         param1.var_1338 = param2;
         param1.var_2087 = null;
         if(param1.var_1338 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1338);
            param1.var_2087 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_861.indexOf(param1) > -1)
         {
            this.var_883 = param1;
         }
      }
      ...
      {
         return this.var_883 == LinkTarget.const_31 ? defaultLinkTarget : this.var_883;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_17);
            _field.styleSheet = this.var_2087;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_1363)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_883 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_1005,this.var_883,PropertyStruct.const_51,true,PropertyDefaults.const_861));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_1005)
            {
