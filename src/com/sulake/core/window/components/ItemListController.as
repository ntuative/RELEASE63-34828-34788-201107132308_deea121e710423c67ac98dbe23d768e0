package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_2263:Boolean = false;
      ...
      {
         this._spacing = PropertyDefaults.const_531;
         this.var_934 = PropertyDefaults.const_830;
         this.var_428 = PropertyDefaults.const_1020;
         this.var_1146 = PropertyDefaults.const_957;
         this.var_752 = 0;
         this.var_750 = 0;
         this.var_125 = 0;
         this.var_109 = 0;
         ...
         var_192 = var_514 || !testParamFlag(WindowParam.const_33);
         this._container = _context.create("_CONTAINER","",WindowType.const_412,WindowStyle.const_106,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         this._container.addEventListener(WindowEvent.const_40,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_396,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_151,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_228,this.containerEventHandler);
         this._container.clipping = clipping;
         this.resizeOnItemUpdate = this.var_1146;
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         if(param1 != this.var_752)
         {
            ...
            _loc2_ = WindowEvent.allocate(WindowEvent.const_546,this,null);
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            if(this._horizontal)
            {
               this._container.setParamFlag(WindowParam.const_590,param1);
            }
            else
            {
               this._container.setParamFlag(WindowParam.const_678,param1);
            }
         }
      }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_396,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_151,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_228,this.containerEventHandler);
            super.dispose();
         }
      }
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_188:
               if(this.var_1418)
               {
                  this.var_1417 = this.var_2264 - _loc3_;
                  this.var_1419 = this.var_2265 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1417 != 0 && this.var_125 != 0)
                     {
                        this.scrollH += this.var_1417 / this.var_125;
                     }
                  }
                  else if(this.var_1419 != 0 && this.var_109 != 0)
                  {
                     this.scrollV += this.var_1419 / this.var_109;
                  }
                  this.var_2264 = _loc3_;
                  this.var_2265 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_310:
               if(this.var_1418)
               {
                  if(this._horizontal)
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1417,0);
                  }
                  else
                  {
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_934 && !this.var_603 && this._container)
         {
            this.var_603 = true;
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_531)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_400,this._spacing,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1400);
         }
         if(this.var_934 != PropertyDefaults.const_830)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_857,this.var_934,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1862);
         }
         if(this.var_428 != PropertyDefaults.const_1020)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_869,this.var_428,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1737);
         }
         if(this.var_1146 != PropertyDefaults.const_957)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_929,this.var_1146,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1845);
         }
         if(this.var_749 != PropertyDefaults.const_1239)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_930,this.var_749,PropertyStruct.const_132,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1909);
         }
         if(this.var_751 != PropertyDefaults.const_1182)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_835,this.var_751,PropertyStruct.const_132,true));
         }
         else
         {
