package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1380:IItemListWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_497)
         {
            this.var_497.removeEventListener(WindowEvent.const_313,this.scrollBarEventProc);
            this.var_497.removeEventListener(WindowEvent.const_262,this.scrollBarEventProc);
            this.var_497 = null;
         }
         if(this.var_1380)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1380)
         {
            this.var_1380 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_497)
         {
            ...
            if(this.var_497)
            {
               this.var_497.addEventListener(WindowEvent.const_313,this.scrollBarEventProc);
               this.var_497.addEventListener(WindowEvent.const_262,this.scrollBarEventProc);
            }
         }
         return this.var_497;
      }
