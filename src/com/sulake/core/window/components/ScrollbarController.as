package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1685:String = "increment";
      
      private static const const_1686:String = "decrement";
      
      private static const const_1140:String = "slider_track";
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(this.var_18 != null && !this.var_18.disposed)
         {
            ...
            this.var_18.removeEventListener(WindowEvent.const_546,this.onScrollableScrolled);
         }
         this.var_18 = param1;
         if(this.var_18 != null && !this.var_18.disposed)
         {
            this.var_18.addEventListener(WindowEvent.const_40,this.onScrollableResized);
            this.var_18.addEventListener(WindowEvent.const_546,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         else if(this.var_1105 != null)
         {
            _loc2_ = this.var_1105;
         }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               this.var_1105 = _loc3_.value as String;
               this.var_18 = null;
            }
            _loc4_++;
         }
      ...
      {
         return findChildByName(const_1140) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_717:
               if(param2.type == WindowEvent.const_228)
               {
                  if(!this.var_1361)
                  {
                     if(this._horizontal)
         ...
         if(param2.type == WindowEvent.const_578)
         {
            if(this.var_18 == null)
            {
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_366)
            {
               if(WindowMouseEvent(param2).delta > 0)
               {
                  if(this._horizontal)
                  {
                     this.scrollH -= this.var_759;
                  }
                  else
                  {
                     this.scrollV -= this.var_759;
                  }
               }
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_46 || param1.type == WindowTouchEvent.const_845)
         {
            ...
            else if(param2.name == const_1686)
            {
               if(this.var_18)
               {
                  this.var_1361 = true;
            ...
            else if(param2.name == const_1140)
            {
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         {
            _loc1_ = findParentByName(this.var_1105) as IScrollableWindow;
            if(_loc1_ == null && _parent is IWindowContainer)
            {
               _loc1_ = IWindowContainer(_parent).findChildByName(this.var_1105) as IScrollableWindow;
               if(_loc1_)
               {
