package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1530:String = "_SELECTOR";
      
      private static const const_1529:String = "_CONTENT";
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1149 = findChildByTag(const_1530) as ITabSelectorWindow;
            if(this.var_1149 != null)
            {
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2268 = findChildByTag(const_1529) as IWindowContainer;
         }
      ...
      {
         return !!this.var_792 ? this.selector.iterator : null;
      }
