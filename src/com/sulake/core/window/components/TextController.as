package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_502,this._explicitStyle);
      ...
      private static function method_4(param1:TextController, param2:Number) : void
      {
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_502 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_502,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_232);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_1001 ? true : null;
         }
      ...
      {
         this.var_944 = param1;
         this._field.scrollH = this.var_944 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_944 * this.maxScrollH,this.var_611 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_1002,this._field.antiAliasType,PropertyStruct.const_51,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1188));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1323 ? new PropertyStruct(PropertyDefaults.const_937,this._autoSize,PropertyStruct.const_51,true,PropertyDefaults.const_1244) : PropertyDefaults.const_1837);
         ...
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1176 ? new PropertyStruct(PropertyDefaults.const_1170,this._field.gridFitType,PropertyStruct.const_51,true,PropertyDefaults.const_1252) : PropertyDefaults.const_1971);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_908) ? new PropertyStruct(PropertyDefaults.const_408,this._field.textColor,PropertyStruct.const_153,true) : PropertyDefaults.const_1299);
         ...
         _loc1_.push(this.var_41.left != PropertyDefaults.const_810 ? new PropertyStruct(PropertyDefaults.const_251,this.var_41.left,PropertyStruct.const_37,true) : PropertyDefaults.const_797);
         _loc1_.push(this.var_41.top != PropertyDefaults.const_768 ? new PropertyStruct(PropertyDefaults.const_268,this.var_41.top,PropertyStruct.const_37,true) : PropertyDefaults.const_917);
         _loc1_.push(this.var_41.right != PropertyDefaults.const_1009 ? new PropertyStruct(PropertyDefaults.const_258,this.var_41.right,PropertyStruct.const_37,true) : PropertyDefaults.const_870);
         _loc1_.push(this.var_41.bottom != PropertyDefaults.const_1028 ? new PropertyStruct(PropertyDefaults.const_255,this.var_41.bottom,PropertyStruct.const_37,true) : PropertyDefaults.const_866);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1250 ? new PropertyStruct(PropertyDefaults.const_737,this._field.mouseWheelEnabled,PropertyStruct.const_38,true) : PropertyDefaults.const_1787);
