package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_792:Boolean = false;
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_21)
         {
            var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1213,var_10);
         }
         return var_21;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_792 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_995,false,PropertyStruct.const_38,true) : PropertyDefaults.const_1898);
         _loc1_.push(this.var_1425 != PropertyDefaults.const_1204 ? new PropertyStruct(PropertyDefaults.const_780,this.var_1425,PropertyStruct.const_38,true) : PropertyDefaults.const_1778);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1235 ? new PropertyStruct(PropertyDefaults.const_785,_field.selectable,PropertyStruct.const_38,true) : PropertyDefaults.const_2001);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1232 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_38,true) : PropertyDefaults.const_1892);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_995:
                  ...
                  break;
               case PropertyDefaults.const_1214:
