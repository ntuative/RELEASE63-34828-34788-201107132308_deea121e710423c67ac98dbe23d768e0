   ...
   public class BitmapSkinParser
   {
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_358 = SkinLayoutEntity.const_528;
                  break;
               case "move":
                  _loc5_.var_358 = SkinLayoutEntity.const_354;
                  break;
               case "strech":
                  _loc5_.var_358 = SkinLayoutEntity.const_522;
                  break;
               case "tiled":
                  _loc5_.var_358 = SkinLayoutEntity.const_359;
                  break;
               case "center":
                  _loc5_.var_358 = SkinLayoutEntity.const_511;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_360 = SkinLayoutEntity.const_528;
                  break;
               case "move":
                  _loc5_.var_360 = SkinLayoutEntity.const_354;
                  break;
               case "strech":
                  _loc5_.var_360 = SkinLayoutEntity.const_522;
                  break;
               case "tiled":
                  _loc5_.var_360 = SkinLayoutEntity.const_359;
                  break;
               case "center":
                  _loc5_.var_360 = SkinLayoutEntity.const_511;
            }
         }
