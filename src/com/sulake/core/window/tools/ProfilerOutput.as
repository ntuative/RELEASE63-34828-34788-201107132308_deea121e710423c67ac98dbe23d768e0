package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1533:Class = ProfilerOutput_profiler_dialog_xml;
      
      private static var var_1532:Class = ProfilerOutput_profiler_task_xml;
      ...
      public function ProfilerOutput(param1:IContext, param2:ICoreWindowManager, param3:IWindowRenderer)
      {
         ...
         this.var_3082 = new Array();
         this.var_177 = this.profiler;
         this._windowManager = param2;
         this._windowRenderer = param3;
         var _loc4_:ByteArray = new var_1533() as ByteArray;
      ...
      private function profilerWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param2.name == "footer_enable_toggle")
         {
            ...
            else if(param1.type == WindowEvent.const_648)
            {
               this.var_1907 = false;
               ILabelWindow(this._window.findChildByName("footer")).textColor = 4284900966;
            }
      ...
      private function method_10(param1:IBitmapWrapperWindow, param2:ProfilerAgentTask) : void
      {
      ...
      {
         var _loc2_:ByteArray = new var_1532() as ByteArray;
