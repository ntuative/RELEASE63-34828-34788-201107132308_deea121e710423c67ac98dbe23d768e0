package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected var var_935:IWindowContextStateListener;
      ...
      public function MouseEventProcessor()
      {
         ...
         {
            var_365 = new Array();
            var_365[0] = MouseCursorType.const_332;
            var_365[1] = MouseCursorType.const_31;
            var_365[2] = MouseCursorType.const_332;
            var_365[3] = MouseCursorType.const_332;
            var_365[4] = MouseCursorType.const_332;
            var_365[5] = MouseCursorType.const_31;
            var_365[6] = MouseCursorType.const_332;
         }
         if(var_318 == null)
         {
            var_318 = new Array();
            var_318[0] = WindowState.const_94;
            var_318[1] = WindowState.const_87;
            var_318[2] = WindowState.const_91;
            var_318[3] = WindowState.const_76;
            var_318[4] = WindowState.const_57;
            var_318[5] = WindowState.const_95;
            var_318[6] = WindowState.const_90;
         }
      }
      
      public static function method_17(param1:uint, param2:uint) : void
      {
      ...
      protected static function convertMouseEventType(param1:MouseEvent, param2:IWindow, param3:IWindow) : WindowMouseEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_UP:
               ...
               _loc4_ = !!_loc6_ ? "null" : WindowMouseEvent.const_310;
               break;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         while(true)
         {
            ...
            if(event.stageX != this.var_753.x || event.stageY != this.var_753.y)
            {
               this.var_753.x = event.stageX;
               this.var_753.y = event.stageY;
               array = new Array();
               this.var_96.groupParameterFilteredChildrenUnderPoint(this.var_753,array,WindowParam.const_30);
            }
               ...
               if(child != null && child.visible)
               {
                  ...
                  else if(event.type == MouseEvent.MOUSE_UP || event.type == MouseEvent.CLICK)
                  {
                     if(this.var_71 && !this.var_71.disposed)
                     {
                        ...
                        {
                           this.var_935.mouseEventReceived(event.type,this.var_71);
                        }
                     }
                  }
                  temp = child.parent;
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         if(param1.testParamFlag(WindowParam.const_548))
         {
