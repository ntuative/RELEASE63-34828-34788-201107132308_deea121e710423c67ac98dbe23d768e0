package com.sulake.core.window.utils
{
   ...
   public class PropertyStruct
   {
      ...
      public function PropertyStruct(param1:String, param2:Object, param3:String, param4:Boolean, param5:Array = null)
      {
         ...
         this.var_3094 = param3 == const_250 || param3 == const_156 || param3 == const_256 || param3 == const_263;
      ...
      public function toString() : String
      {
         switch(this._type)
         {
            ...
            case const_38:
               return Boolean(this.var_209) == true ? "true" : "false";
            case const_256:
      ...
      public function toXMLString() : String
      {
         ...
         switch(this._type)
         {
            ...
            case const_263:
               ...
               break;
            case const_153:
               _loc1_ = "<var key=\"" + this.var_724 + "\" value=\"" + "0x" + uint(this.var_209).toString(16) + "\" type=\"" + this._type + "\" />";
               break;
            default:
               _loc1_ = "<var key=\"" + this.var_724 + "\" value=\"" + this.var_209 + "\" type=\"" + this._type + "\" />";
         }
         return _loc1_;
      }
   }
