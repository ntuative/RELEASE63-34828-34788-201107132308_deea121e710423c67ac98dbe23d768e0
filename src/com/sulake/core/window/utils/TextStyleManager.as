package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_232:String = "regular";
      ...
      private static var var_583:Array;
      ...
      private static const const_1687:String = "/*";
      
      private static const const_1688:String = "*/";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_100[const_232],var_100[ITALIC],var_100[BOLD]];
            var_100.reset();
            var_100[const_232] = _loc5_[0];
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_583.indexOf(_loc4_.name) == -1)
            {
               var_583.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         {
            while(_loc5_.indexOf(const_1687) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1688) + 2,_loc5_.length);
            }
