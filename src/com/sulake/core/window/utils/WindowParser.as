package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1304:String = "_EXCLUDE";
      
      public static const const_2229:String = "_INCLUDE";
      
      public static const const_2114:String = "_TEMP";
      
      private static const const_1468:String = "layout";
      
      private static const const_1057:String = "window";
      
      private static const const_1056:String = "variables";
      
      private static const const_1055:String = "filters";
      
      private static const const_683:String = "name";
      
      private static const const_1471:String = "style";
      
      private static const const_685:String = "params";
      
      private static const const_1469:String = "tags";
      ...
      private static const const_1479:String = "visible";
      
      private static const const_1478:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_5:String = "background";
      
      private static const const_1349:String = "blend";
      
      private static const const_1474:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1480:String = "treshold";
      
      private static const const_1470:String = "children";
      
      private static const const_1473:String = "width_min";
      ...
      private static const const_1466:String = "$";
      
      private static const const_1467:String = ",";
      
      private static const const_50:String = "";
      
      private static const const_1477:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1475:RegExp = /(\s|\n|\r|\t|\v)*$/;
      ...
      protected var var_1144:Dictionary;
      
      protected var var_1706:Dictionary;
      
      protected var var_2252:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         ParamCodeTable.fillTables(this.var_1144,this.var_1706);
         this.var_2252 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1475,const_50);
         return param1.replace(const_1477,const_50);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            for(_loc1_ in this.var_1144)
            {
               delete this.var_1144[_loc1_];
            }
            for(_loc1_ in this.var_1706)
            {
               delete this.var_1706[_loc1_];
            }
            this.var_2252.dispose();
            this.var_2252 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1468)
         {
            _loc8_ = param1.child(const_1056);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_1055).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
            ...
            _loc4_ = param1.child(const_1057);
         ...
         if(param1.localName() == const_1057)
         {
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         style = uint(this.parseAttribute(xml,const_1471,variables,style));
         params = uint(this.parseAttribute(xml,const_685,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1469,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_184));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_184));
         rect.width = Number(this.parseAttribute(xml,name_2,variables,const_184));
         rect.height = Number(this.parseAttribute(xml,name_1,variables,const_184));
         visible = this.parseAttribute(xml,const_1479,variables,visible.toString()) == const_684;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_685).length() > 0)
         {
            list = xml.child(const_685).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               ...
               if(this.var_1144[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_683)) + "\"!");
               }
               params |= this.var_1144[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_50) : const_50;
         caption = unescape(String(this.parseAttribute(xml,const_1478,variables,caption)));
         if(tag != const_50)
         {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_1056)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1473,variables,window.limits.minWidth));
         ...
         background = this.parseAttribute(xml,const_5,variables,window.background.toString()) == const_684;
         blend = Number(this.parseAttribute(xml,const_1349,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1474,variables,window.clipping.toString()) == const_684;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1480,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_1055).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
            ...
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  if(window.x != rect.x || window.y != rect.y || window.width != rect.width || window.height != rect.height)
                  {
                     ...
                     if((params & 0) == WindowParam.const_230)
                     {
                        window.y = rect.y;
                     }
                  }
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1304) == -1)
                  {
