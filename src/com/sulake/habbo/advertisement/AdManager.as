package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1240:BitmapData = null;
      
      private var var_1241:BitmapData = null;
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2568 = this._config.getKey("interstitial.enabled","false") == "true";
         this.var_2567 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2570 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_1891 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_1242 == 0)
         {
            this.var_1242 = getTimer();
            return false;
         }
         if(this.var_1891 > 0 && this.var_1892 >= this.var_1891)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1242;
         if(_loc1_ > this.var_2567)
         {
            ++this.var_1892;
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new InterstitialEvent(InterstitialEvent.const_545,param1.bitmapData,this.var_2569));
            this.var_1242 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new InterstitialEvent(InterstitialEvent.const_554));
         }
      }
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_) && this.var_384 != null)
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_492,this.var_384.roomId,this.var_384.roomCategory,_loc4_,_loc2_.assetName,this.var_384.clickURL,this.var_1240,this.var_1241));
            this.var_384 = null;
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1240 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1241 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function dispatchImageAsset(param1:BitmapData, param2:int, param3:int, param4:int, param5:int, param6:String, param7:String) : void
      {
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_787,param2,param3,param1,param6,param7,null,null,param4,param5));
         }
      }
