package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadLibrary extends EventDispatcher
   {
      ...
      private static var var_1779:int = 1;
      ...
      public function AvatarAssetDownloadLibrary(param1:String, param2:String, param3:String, param4:IAssetLibrary)
      {
         ...
         this.var_1183 = param3 + this.var_780 + ".swf";
         this.var_1183 = this.var_1183.replace("%revision%",this._revision);
      ...
      {
         this._state = var_1779;
         var _loc1_:URLRequest = new URLRequest(this.var_1183);
      ...
      {
         Core.error("Could not load avatar asset library " + this.var_780 + " from URL " + this.var_1183,false,Core.const_1370);
      }
