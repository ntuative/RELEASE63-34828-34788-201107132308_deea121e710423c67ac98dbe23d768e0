package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1704:IWindowContainer;
      
      public static var var_2212:int = 6710886;
      
      private static const const_1575:int = 5000;
      
      private static const const_1570:Point = new Point(100,30);
      ...
      private var var_254:ITabSelectorWindow;
      ...
      private var var_2687:Boolean = true;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:Array)
      {
         ...
         var _loc5_:* = null;
         this.var_1276 = [];
         this.var_1548 = [AvatarEditorFigureCategory.const_982,AvatarEditorFigureCategory.const_55,AvatarEditorFigureCategory.const_269,AvatarEditorFigureCategory.const_777,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_112];
         super();
         this.var_23 = param1;
         if(var_1411 == null)
         {
         ...
         if(var_1704 == null)
         {
            ...
            var_1704 = this.var_23.manager.windowManager.buildFromXML(_loc5_.content as XML) as IWindowContainer;
         }
         this.var_688 = new Timer(const_1575,1);
         this.var_688.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param2 == null)
         {
            param2 = this.var_1548;
         }
         for each(_loc3_ in param2)
         {
            this.var_1276.push(_loc3_);
         }
         this.createWindow();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_688.stop();
            this.var_688.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_688 = null;
         }
         if(this.var_254)
         {
      ...
      public function getFrame(param1:Array, param2:String = null) : IFrameWindow
      {
         ...
         this.var_87.position = const_1570;
      ...
      public function embedToContext(param1:IWindowContainer, param2:Array) : Boolean
      {
         ...
         else
         {
            if(this.var_687 == null)
            {
               this.var_687 = this.var_23.manager.windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_79,HabboWindowStyle.const_31,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               this.var_687.addChild(this.var_58);
            }
            _loc3_ = this.var_687.getChildIndex(this.var_58);
            if(_loc3_)
            {
               param1.removeChildAt(_loc3_);
            }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1548);
         }
         if(param1.length != this.var_1276.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1276.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function createWindow() : void
      {
         ...
         this.var_254 = this.var_58.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc1_:int = this.var_254.numSelectables - 1;
         while(_loc1_ >= 0)
         {
            _loc2_ = this.var_254.getSelectableAt(_loc1_);
            if(_loc2_ != null && this.var_1276.indexOf(_loc2_.name) < 0)
            {
               _loc3_ = this.var_254.removeSelectable(_loc2_);
               _loc4_ = _loc1_ + 1;
               while(_loc4_ < this.var_254.numSelectables)
               {
                  this.var_254.getSelectableAt(_loc4_).x = this.var_254.getSelectableAt(_loc4_).x - _loc3_.width;
                  _loc4_++;
               }
            }
            _loc1_--;
         }
         this.var_254.setSelected(this.var_254.getSelectableAt(0));
         this.attachImages();
         this.update();
      }
      ...
      private function attachImages() : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc1_:Array = this.var_1548;
      ...
      public function update() : void
      {
         ...
         if(this.var_23.manager.sessionData && this.var_23.manager.sessionData.clubLevel >= HabboClubLevelEnum.const_35 && (this.var_1573 == AvatarEditorSideCategory.const_112 || this.var_2687))
         {
            _loc4_ = "null";
         }
         ...
         this.setViewToCategory(this.var_379);
      }
      ...
      {
         if(this.var_1573 == AvatarEditorSideCategory.const_112)
         {
            this.var_2687 = false;
            this.setSideContent(AvatarEditorSideCategory.const_672);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_672:
               break;
            case AvatarEditorSideCategory.const_619:
               _loc3_ = this.var_23.getSideContentWindowContainer(AvatarEditorSideCategory.const_619);
               break;
         ...
         {
            _loc5_ = 8;
            this.var_87.content.width = this.var_58.width + _loc5_;
         }
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_379 = param1;
         this.var_254.setSelected(this.var_254.getSelectableByName(param1));
      }
