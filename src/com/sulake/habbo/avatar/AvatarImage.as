package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1437:String = "Default";
      
      private static const const_1436:int = 2;
      
      private static const const_1435:String = AvatarSetType.const_41;
      ...
      protected var var_897:Array;
      
      protected var _assets:AssetAliasCollection;
      
      protected var var_288:AvatarImageCache;
      ...
      private var var_954:IActiveActionData;
      ...
      private var var_2931:String = null;
      
      private var var_2930:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this._figure = param3;
         this.var_288 = new AvatarImageCache(this._structure,this,this._assets,this._scale);
         this.setDirection(const_1435,const_1436);
         this.var_363 = new Array();
         this.var_954 = new ActiveActionData(AvatarAction.const_399);
         this.var_954.definition = this._structure.getActionDefinition(const_1437);
         this.resetActions();
      ...
      {
         param2 += this.var_1758;
         if(param2 < AvatarDirectionAngle.const_1227)
         {
            param2 = AvatarDirectionAngle.const_376 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_376)
         {
            param2 -= NaN;
         }
         ...
         if(param1 == AvatarSetType.const_55 || param1 == AvatarSetType.const_41)
         {
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_720,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_306.length == 1 && this.var_102 == this.var_2108)
         {
            return this.var_102 + this.var_579 + this.var_720 % 4;
         }
         if(this.var_306.length == 2)
         {
            for each(_loc1_ in this.var_306)
            {
               ...
               {
                  _loc2_ = this.var_720 % 11;
                  return this.var_102 + "_" + this.var_2108 + this.var_579 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2929 || param2 != this.var_2931 || param1 != this.var_2930)
         {
            this.var_2929 = param3;
            this.var_2931 = param2;
            this.var_2930 = param1;
            this.var_2128 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_720);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_720);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_363.push(new ActiveActionData(param1,param2,this.var_720));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_315 = this.var_954;
         this.var_315.definition = this.var_954.definition;
         this.resetBodyPartCache(this.var_954);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_579 = "";
         this.var_306 = this._structure.sortActions(this.var_363);
         if(this.var_306 == null)
         {
            this.var_897 = new Array(0,0,0);
            if(this.var_1364 != "")
            {
               _loc1_ = true;
               this.var_1364 = "";
         ...
         {
            this.var_897 = this._structure.getCanvasOffsets(this.var_306,this._scale,this.var_102);
            for each(_loc4_ in this.var_306)
            {
               this.var_579 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_337)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1661 != _loc5_)
                  {
                     _loc2_ = true;
                  }
            ...
            if(this.var_1364 != this.var_579)
            {
               _loc1_ = true;
               this.var_1364 = this.var_579;
            }
         }
         this.var_1454 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_306)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_953 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1758 = _loc2_.directionData.offset;
                     }
               ...
               if(_loc1_.actionType == AvatarAction.const_361 || _loc1_.actionType == AvatarAction.const_276 || _loc1_.actionType == AvatarAction.const_449)
               {
                  this.var_953 = true;
               }
            }
