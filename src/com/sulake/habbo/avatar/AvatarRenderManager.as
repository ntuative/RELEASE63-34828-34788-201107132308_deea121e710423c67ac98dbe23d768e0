package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_2367:String = "hd-99999-99999";
      ...
      private var var_338:PetDataManager;
      
      private var var_843:PaletteManager;
      ...
      private var var_1990:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_641 = RenderMode.const_1884;
         ...
         this.var_121.add(AvatarType.const_121,_loc4_);
         ...
         this.var_338 = new PetDataManager(this,param1.assets as AssetLibraryCollection);
         this.var_843 = new PaletteManager(param1.assets as AssetLibraryCollection);
         var _loc5_:XML = param3.getAssetByName("HabboAvatarPetFigure").content as XML;
         this.var_338.populateFigureData(_loc5_);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_338.init();
         this.var_843.init();
         _loc2_ = this.var_121.getValue(AvatarType.const_121) as AvatarStructure;
         if(_loc2_)
         {
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_121.getValue(AvatarType.const_121) as AvatarStructure;
            if(_loc3_ != null)
            {
      ...
      private function checkIfReady() : void
      {
         if(!this.var_1111)
         {
            if(this.var_2728 && this.var_2727 && this.var_2726)
            {
               this.var_1111 = true;
      ...
      {
         var _loc5_:AvatarStructure = this.var_121.getValue(AvatarType.const_121) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(!this.var_1990)
         {
            this.var_1990 = new AvatarFigureContainer(this.const_2367);
         }
         this.var_256.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1990,param2);
      }
      ...
      public function removePetImageListener(param1:IPetImageListener) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         if(param1 == null || this.var_339 == null)
         {
            return;
         }
         for each(_loc2_ in this.var_339.getKeys())
         {
            _loc3_ = this.var_339.getValue(_loc2_);
            if(_loc3_ != null)
            {
      ...
      public function getPetFigureString(param1:String) : String
      {
         ...
         return this.var_338.createPetFigureString(_loc3_,_loc4_,_loc5_);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1972)
         {
            _loc6_ = !this.var_338.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_338.createPetFigureString(param1,param2,param3);
         ...
         if(param5 != null)
         {
            ...
            this.var_339.add(_loc7_,_loc9_);
         }
      ...
      public function resetPetData() : void
      {
         ...
         this.var_338.populateFigureData(_loc1_);
         var _loc2_:AvatarStructure = this.var_121.getValue(AvatarType.const_58);
         _loc2_.initFigureData(_loc1_);
         _loc2_.resetPartOffsets(context.assets);
         var _loc5_:Array = this.var_339.getKeys();
         for each(_loc6_ in _loc5_)
         {
            _loc4_ = this.var_339.getValue(_loc6_);
            if(_loc4_)
            {
      ...
      {
         var _loc3_:AvatarStructure = this.var_121.getValue(AvatarType.const_121) as AvatarStructure;
      ...
      {
         return this.var_338 as IPetDataManager;
      }
