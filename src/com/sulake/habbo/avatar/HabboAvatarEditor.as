package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor
   {
      ...
      private static const const_1455:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_525:HabboAvatarEditorManager;
      ...
      private var var_1170:IHabboAvatarEditorDataSaver = null;
      ...
      public function HabboAvatarEditor(param1:uint, param2:HabboAvatarEditorManager)
      {
         ...
         this.var_525 = param2;
         this.var_961 = this.var_525.avatarRenderManager.getFigureData(AvatarType.const_121);
      }
      ...
      private function init(param1:Array = null) : void
      {
         ...
         _loc2_.loadAvatarData(const_1456,FigureData.const_89);
         _loc3_.loadAvatarData(const_1455,FigureData.FEMALE);
         this.var_118 = new Map();
         this.var_526 = new Map();
         this.var_118.add(AvatarEditorFigureCategory.const_982,new BodyModel(this));
         this.var_118.add(AvatarEditorFigureCategory.const_55,new HeadModel(this));
         this.var_118.add(AvatarEditorFigureCategory.const_269,new TorsoModel(this));
         this.var_118.add(AvatarEditorFigureCategory.const_777,new LegsModel(this));
         ...
         this.var_526.add(AvatarEditorSideCategory.const_112,new WardrobeModel(this));
         this.var_526.add(AvatarEditorSideCategory.const_619,new ClubPromoModel(this));
      ...
      private function selectDefaultCategory(param1:Array) : void
      {
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_982);
         }
      }
      ...
      {
         return this.var_622[this.var_1138];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         {
            this.var_1170.saveFigure(_loc1_,_loc2_);
         }
         else
         {
            _loc3_ = new UpdateFigureDataMessageComposer(_loc1_,_loc2_);
            this.var_525.communication.getHabboMainConnection(null).send(_loc3_);
            _loc3_.dispose();
            _loc3_ = null;
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_1767;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_773 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < const_681)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1704.clone() as IWindowContainer,param1,_loc13_);
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_525.avatarRenderManager.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_525.avatarRenderManager.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            _loc15_ = Boolean(_loc14_.indexOf(param2) == -1);
            if(_loc15_)
            {
               _loc21_ = this.var_525.assets.getAssetByName("removeSelection") as BitmapDataAsset;
               if(_loc21_)
               {
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_2010)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_773 >= _loc6_.clubLevel))
               {
      ...
      {
         return this.var_525.configuration.getBoolean("avatareditor.allowclubtryout",false);
      }
      ...
      public function hasInvalidClubItems() : Boolean
      {
         ...
         {
            _loc3_ = _loc2_.method_14(this.clubMemberLevel);
            if(_loc3_)
            {
               _loc1_ = true;
            }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_773 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_526.getValue(AvatarEditorSideCategory.const_112);
      }
