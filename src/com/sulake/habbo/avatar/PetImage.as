package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_288:AvatarImageCache;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_55)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1453);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,this.var_720);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(this.var_720);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,this.var_720);
            if(_loc10_ != null)
            {
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(this.var_720);
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_954);
         this.getCache().resetBodyPartCache(this.var_954);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1452 = this._structure.sortActions(this.var_363);
         ...
         {
            this.var_897 = this._structure.getCanvasOffsets(this.var_1452,this._scale,this.var_102);
         }
      }
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               for each(_loc4_ in _loc3_.parts)
               {
                  if(_loc4_.type == "pbd")
                  {
                     this.var_1207 = _loc4_.id;
                     this.var_1757 = _loc4_.breed;
                     break;
                  }
               }
            }
