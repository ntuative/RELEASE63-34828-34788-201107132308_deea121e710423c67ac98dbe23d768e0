package com.sulake.habbo.avatar.animation
{
   ...
   public class Animation implements IAnimation
   {
      ...
      private var var_1881:AvatarDataContainer;
      
      private var var_1516:Array;
      
      private var var_1882:DirectionDataContainer;
      
      private var var_1883:ShadowDataContainer;
      ...
      public function Animation(param1:AvatarStructure, param2:XML)
      {
         ...
         {
            this.var_1733 = String(param2.@desc);
         }
         else
         {
         ...
         if(param2.hasOwnProperty("sprite"))
         {
            ...
            {
               this.var_1515.push(new SpriteDataContainer(this as IAnimation,_loc3_));
            }
         }
         if(param2.hasOwnProperty("avatar"))
         {
            this.var_1881 = new AvatarDataContainer(param2.avatar[0]);
         }
         ...
         {
            this.var_1882 = new DirectionDataContainer(param2.direction[0]);
         }
         if(param2.hasOwnProperty("shadow"))
         {
            this.var_1883 = new ShadowDataContainer(param2.shadow[0]);
         }
         if(param2.hasOwnProperty("remove"))
         {
            for each(_loc5_ in param2.remove)
            {
               this.var_1514.push(String(_loc5_.@id));
            }
         }
         if(param2.hasOwnProperty("add"))
         {
            ...
            {
               this.var_813.push(new AddDataContainer(_loc6_));
            }
         }
         if(param2.hasOwnProperty("override"))
         {
            ...
            for each(_loc7_ in param2.name_6)
            {
               ...
               this.var_654.add(_loc9_,_loc8_);
               _loc10_ = new Array();
      ...
      private function parseFrames(param1:Array, param2:XMLList, param3:AvatarStructure) : void
      {
         ...
         for each(_loc7_ in param2)
         {
            ...
            for each(_loc9_ in _loc7_.fx)
            {
               ...
               _loc11_ = new AnimationLayerData(param3,_loc9_,AnimationLayerData.const_536,_loc6_,_loc5_);
               _loc4_.push(_loc11_);
               if(_loc5_ != null)
               {
               }
      ...
      public function overridingAction(param1:String) : String
      {
         ...
         return this.var_654.getValue(param1);
      }
      ...
      public function getAnimatedBodyPartIds(param1:int, param2:String = null) : Array
      {
         ...
         for each(_loc4_ in this.getFrame(param1,param2))
         {
            ...
            else if(_loc4_.type == AnimationLayerData.const_536)
            {
      ...
      public function getLayerData(param1:int, param2:String, param3:String = null) : AnimationLayerData
      {
         ...
         for each(_loc4_ in this.getFrame(param1,param3))
         {
            ...
            if(_loc4_.type == AnimationLayerData.const_536)
            {
               for each(_loc5_ in this.var_813)
               {
      ...
      {
         return this.var_1515 != null;
      }
      
      public function hasAvatarData() : Boolean
      {
         return this.var_1881 != null;
      }
      ...
      {
         return this.var_1514 != null;
      }
      
      public function hasAddData() : Boolean
      {
         return this.var_813 != null;
      }
