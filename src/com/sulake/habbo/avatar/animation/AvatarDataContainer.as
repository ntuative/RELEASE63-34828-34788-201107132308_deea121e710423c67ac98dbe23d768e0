package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         this.var_819 = new ColorTransform(this.var_2093,this.var_2092,this.var_2094,this._alphaMultiplier);
         this.var_1281 = this.generatePaletteMapForGrayscale(this.var_2704,this.var_2706);
      }
      ...
      {
         return this.var_1281.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1281.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1281.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1281.getValue("alphas") as Array;
      }
