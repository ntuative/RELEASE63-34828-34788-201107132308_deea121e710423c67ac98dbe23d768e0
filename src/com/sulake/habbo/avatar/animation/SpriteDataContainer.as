package com.sulake.habbo.avatar.animation
{
   public class SpriteDataContainer implements ISpriteDataContainer
   {
      ...
      private var var_1152:IAnimation;
      ...
      public function SpriteDataContainer(param1:IAnimation, param2:XML)
      {
         ...
         this.var_1971 = parseInt(param2.@ink);
         this.var_2413 = String(param2.@member);
         this.var_2414 = Boolean(parseInt(param2.@directions));
         this._dx = [];
         this.var_1480 = [];
         this.var_1481 = [];
         for each(_loc3_ in param2.direction)
         {
            ...
            this.var_1480[_loc4_] = parseInt(_loc3_.@dy);
            this.var_1481[_loc4_] = parseInt(_loc3_.@dz);
         }
      }
