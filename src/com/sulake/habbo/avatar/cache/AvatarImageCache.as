package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private var var_1642:IAvatarImage;
      ...
      private var var_2689:Point;
      
      private var var_841:String;
      
      private var var_202:BitmapData;
      ...
      private var var_2690:ByteArray;
      
      private var var_2688:ImageData;
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_288.getKeys();
            for each(_loc3_ in _loc2_)
            {
               _loc1_ = this.var_288.getValue(_loc3_) as AvatarImageBodyPartCache;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      public function disposeInactiveActions(param1:int = 60000) : void
      {
         ...
         var _loc4_:Array = this.var_288.getKeys();
         for each(_loc5_ in _loc4_)
         {
            _loc3_ = this.var_288.getValue(_loc5_) as AvatarImageBodyPartCache;
            if(_loc3_ != null)
            {
      ...
      public function resetBodyPartCache(param1:IActiveActionData) : void
      {
         var _loc2_:* = null;
         var _loc4_:* = null;
         var _loc3_:Array = this.var_288.getKeys();
         for each(_loc4_ in _loc3_)
         {
            _loc2_ = this.var_288.getValue(_loc4_) as AvatarImageBodyPartCache;
            if(_loc2_ != null)
            {
      ...
      public function setGeometryType(param1:String) : void
      {
         ...
         if(this.var_841 == GeometryType.const_1407 && param1 == GeometryType.const_1394 || this.var_841 == GeometryType.const_1394 && param1 == GeometryType.const_1407)
         {
            this.var_841 = param1;
            this.var_99 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         if(this._bodyPartCache == null)
         {
            ...
            this.var_288.add(param1,this._bodyPartCache);
         }
            ...
            if(this.var_397.definition.isAnimation)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc14_ != null)
                  {
                     ...
                     else if(_loc14_.type == AnimationLayerData.const_536)
                     {
                        _loc3_ = _loc11_;
                     }
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1642.getFigure(),_loc5_,this.var_841,_loc3_,_loc6_,_loc7_);
         ...
         if(this.var_467 == null)
         {
            ...
            this.var_467 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_397);
            if(this.var_467 == null)
            {
               return null;
            }
      ...
      {
         var _loc2_:AvatarImageBodyPartCache = this.var_288.getValue(param1) as AvatarImageBodyPartCache;
         if(_loc2_ == null)
         {
            _loc2_ = new AvatarImageBodyPartCache();
            this.var_288.add(param1,_loc2_);
         }
         return _loc2_;
      }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_99)
         {
            this.var_99 = this._structure.getCanvas(this._scale,this.var_841);
            if(!this.var_99)
            {
               return null;
            }
            this.var_2689 = new Point(0,this.var_99.height - int(this.var_99.width / 4));
         }
         var _loc5_:int = param1;
         var _loc6_:Boolean = AvatarDirectionAngle.const_1967[param1];
         var _loc9_:String = param4.definition.assetPartDefinition;
         var _loc10_:String = param4.definition.state;
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_756 || _loc10_ == AvatarAction.const_449;
         ...
         while(_loc8_ >= 0)
         {
            ...
            {
               this.var_1575 = this.var_134.bodyPartId;
               this.var_201 = this.var_134.partType;
               this.var_1964 = this.var_134.partId;
               ...
               if(_loc6_)
               {
                  ...
                  else
                  {
                     ...
                     if(this.var_134.flippedPartType != this.var_201)
                     {
                        this.var_201 = this.var_134.flippedPartType;
                     }
                  }
               }
               this.var_1576 = this._scale + "_" + this.var_134.action.assetPartDefinition + "_" + this.var_201 + "_" + this.var_1964 + "_" + _loc5_ + "_" + this._frame;
               this.var_468 = this._assets.getAssetByName(this.var_1576) as BitmapDataAsset;
               if(this.var_468 == null)
               {
                  this.var_1576 = this._scale + "_std_" + this.var_201 + "_" + this.var_1964 + "_" + _loc5_ + "_0";
                  this.var_468 = this._assets.getAssetByName(this.var_1576) as BitmapDataAsset;
               }
               if(!(!this.var_468 || !this.var_468.content))
               {
                  if(this.var_134.paletteMapId > -1)
                  {
                     this.var_1051 = this._structure.renderManager.paletteManager.getPalette(this.var_134.paletteMapId);
                     if(this.var_1051 != null)
                     {
                        this.var_1049 = this.var_468.content as BitmapData;
                        this.var_202 = new BitmapData(this.var_1049.width,this.var_1049.height);
                        this.var_2690 = this.var_1051.colorize(this.var_1049.getPixels(this.var_1049.rect));
                        this.var_202.setPixels(this.var_202.rect,this.var_2690);
                     }
                     else
                     {
                        this.var_202 = (this.var_468.content as BitmapData).clone();
                     }
                  }
                  else
                  {
                  ...
                  if(_loc11_ && (this.var_1575 == AvatarBodyPartType.const_269 || this.var_1575 == AvatarBodyPartType.const_1768 || this.var_1575 == AvatarBodyPartType.const_2018) && this.var_134.color != null)
                  {
                     _loc16_ = 0.7;
                     ...
                     this.var_202.colorTransform(this.var_202.rect,_loc18_);
                  }
                  else if(this.var_134.isColorable && this.var_134.color != null)
                  {
                     this.var_202.colorTransform(this.var_202.rect,this.var_134.color.colorTransform);
                  }
                  if(this.var_134.isBlendable)
                  {
                     this.var_202.colorTransform(this.var_202.rect,this.var_134.blendTransform);
                  }
                  this.var_1050 = this.var_468.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_61)
                     {
                  ...
                  this.var_2688 = new ImageData(this.var_202,this.var_1050,_loc7_);
                  this.var_1048.push(this.var_2688);
               }
            }
            _loc8_--;
         }
         if(this.var_1048.length == 0)
         {
            return null;
         }
         var _loc13_:ImageData = this.createUnionImage(this.var_1048,_loc6_);
         var _loc14_:Point = new Point(-1 * _loc13_.regpoint.x,this.var_2689.y - _loc13_.regpoint.y);
         if(_loc6_)
         {
            if(this._scale == AvatarScaleType.const_61)
            {
         ...
         _loc8_ = this.var_1048.length - 1;
         while(_loc8_ >= 0)
         {
            _loc15_ = this.var_1048.pop();
            if(_loc15_)
            {
               _loc15_.dispose();
            }
