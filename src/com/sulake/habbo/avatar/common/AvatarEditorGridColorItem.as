package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_1099:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(this.var_665.width,this.var_665.height,true,0);
            _loc1_.bitmap.copyPixels(this.var_665,this.var_665.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = this._window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_1015.width,this.var_1015.height,true,0);
            _loc5_ = this.var_1015.clone();
            _loc5_.colorTransform(_loc5_.rect,this.var_1099.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_1017.width,this.var_1017.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_1017,this.var_1017.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
