package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridPartItem implements IAvatarImageListener
   {
      ...
      private var var_842:IFigurePartSet;
      ...
      public function AvatarEditorGridPartItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:Array, param5:Boolean = true)
      {
         ...
         if(param3 != null)
         {
            ...
            {
               this.var_1969 = Math.max(this.var_1969,_loc6_.colorLayerIndex);
            }
         }
         this.var_469 = this.var_78.controller.manager.avatarRenderManager;
      ...
      private function updateThumbVisualization() : void
      {
         ...
         if(_loc1_)
         {
            if(this.var_754 != null && !this.var_1967)
            {
               _loc3_ = this.var_754;
            }
            else
         ...
         if(this.isSelected)
         {
            this.var_1447.color = this.const_2366;
         }
         else
         {
            this.var_1447.color = this.const_2365;
         }
      ...
      private function analyzePartLayers() : Boolean
      {
         ...
         for each(_loc2_ in this.partSet.parts)
         {
            if(_loc7_)
            {
               _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + this.const_389[_loc6_] + "_" + FigureData.const_164;
      ...
      private function renderThumb() : BitmapData
      {
         ...
         if(this.var_689 == null)
         {
            if(!this.analyzePartLayers())
            {
               if(!this.var_1968)
               {
                  ...
                  this.var_1968 = _loc9_.content as BitmapData;
               }
         ...
         for each(_loc2_ in _loc8_)
         {
            ...
            if(_loc4_)
            {
               ...
               if(this.var_1967 && _loc2_.colorLayerIndex > 0)
               {
