package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarModelGeometry
   {
      ...
      private var var_1216:Matrix4x4;
      
      private var var_990:Vector3D;
      ...
      public function AvatarModelGeometry(param1:XML)
      {
         ...
         var _loc15_:* = null;
         var _loc16_:* = null;
         this.var_990 = new Vector3D(0,0,10);
         super();
         this.var_1216 = new Matrix4x4();
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_990.x = _loc11_;
            this.var_990.y = _loc12_;
            this.var_990.z = _loc13_;
         }
         ...
         for each(_loc6_ in param1.type)
         {
            ...
            this.var_805[String(_loc6_.@id)] = _loc7_;
            this.var_1827[String(_loc6_.@id)] = _loc8_;
         }
      }
      ...
      public function removeDynamicItems() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for each(_loc1_ in this.var_805)
         {
      ...
      {
         return this.var_805[param1] != null;
      }
      ...
      private function hasBodyPart(param1:String, param2:String) : Boolean
      {
         ...
         {
            _loc3_ = this.var_805[param1] as Dictionary;
            return _loc3_[param2] != null;
         }
         return false;
      }
      
      private function method_16(param1:String) : Array
      {
         var _loc4_:* = null;
         var _loc2_:Dictionary = this.getBodyPartsOfType(param1);
         var _loc3_:Array = new Array();
         for(_loc4_ in this.var_805)
         {
            _loc3_.push(_loc4_);
         }
         return _loc3_;
      ...
      private function getBodyPartsOfType(param1:String) : Dictionary
      {
         if(this.typeExists(param1))
         {
            return this.var_805[param1] as Dictionary;
         }
      ...
      public function getBodyPartOfItem(param1:String, param2:String) : GeometryBodyPart
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc3_:Dictionary = this.var_1827[param1];
         if(_loc3_ != null)
         {
      ...
      public function getBodyPartsAtAngle(param1:String, param2:uint, param3:String) : Array
      {
         ...
         this.var_1216 = Matrix4x4.getYRotationMatrix(param2);
         for each(_loc7_ in _loc5_)
         {
            _loc7_.applyTransform(this.var_1216);
            _loc9_ = _loc7_.getDistance(this.var_990);
      ...
      public function getParts(param1:String, param2:String, param3:uint, param4:Array) : Array
      {
         ...
         if(this.hasBodyPart(param1,param2))
         {
            ...
            this.var_1216 = Matrix4x4.getYRotationMatrix(param3);
            return _loc5_.getParts(this.var_1216,this.var_990,param4);
         }
         return [];
      }
