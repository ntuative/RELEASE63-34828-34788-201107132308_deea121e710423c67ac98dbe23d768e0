package com.sulake.habbo.avatar.pets
{
   ...
   public class PetDataManager implements IPetDataManager, IDisposable
   {
      ...
      {
         if(param1 == null || this.var_590 == null)
         {
            return;
         }
      ...
      private function notifyListeners() : void
      {
         ...
         {
            _loc1_ = this.var_590.pop() as IPetDataListener;
            ...
            if(petData != null)
            {
               ...
               for each(breed in petData.breeds)
               {
                  ...
                  for each(targetSetName in targetSets)
                  {
                     ...
                     {
                        figurePart = figureTargetSet.NoSuchFlatEvent.part.(@id == petData.species).(hasOwnProperty("palettemapid") && @palettemapid == breed.patternId)[0];
                        if(figurePart == null)
                        {
                        }
      ...
      public function assetsReady(param1:int, param2:String, param3:IPetDataListener = null) : Boolean
      {
         ...
         {
            if(this.var_1680.indexOf(_loc6_) == -1)
            {
               _loc7_ = false;
               if(this.var_729.getValue(_loc6_) == null)
               {
                  ...
                  this.var_729.add(_loc6_,_loc8_);
                  if(param3 != null && this.var_590.indexOf(param3) == -1)
                  {
                     this.var_590.push(param3);
                  }
               }
            }
         }
      ...
      private function unregisterLoadingAssets(param1:LibraryLoader) : void
      {
         ...
         for each(_loc3_ in this.var_729.getKeys())
         {
            _loc5_ = this.var_729.getValue(_loc3_);
            if(param1 == _loc5_)
            {
               _loc2_.push(_loc3_);
            }
