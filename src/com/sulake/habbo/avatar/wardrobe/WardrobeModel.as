package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeModel implements ISideContentModel
   {
      ...
      private function init() : void
      {
         ...
         while(_loc1_ <= 10)
         {
            this.var_518.add(_loc1_,new WardrobeSlot(this.var_26,_loc1_,this.isSlotEnabled(_loc1_)));
            _loc1_++;
         }
         if(this._view)
         {
      ...
      private function isSlotEnabled(param1:int) : Boolean
      {
         ...
         return this.var_26.manager.sessionData.hasUserRight("fuse_larger_wardrobe",HabboClubLevelEnum.const_43);
      }
