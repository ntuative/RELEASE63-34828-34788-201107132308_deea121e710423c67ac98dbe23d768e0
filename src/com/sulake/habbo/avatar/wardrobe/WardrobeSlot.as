package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit, IAvatarImageListener
   {
      ...
      private var var_426:IBitmapWrapperWindow;
      ...
      private function createView() : void
      {
         ...
         this.var_426 = this._view.findChildByName("image") as IBitmapWrapperWindow;
      }
      ...
      public function updateView() : void
      {
         ...
         if(this._figure && this.var_1702)
         {
            _loc5_ = this.var_26.manager.avatarRenderManager.createAvatarImage(this.figure,AvatarScaleType.const_111,this.var_1138,this);
            if(_loc5_)
            {
               _loc5_.setDirection(AvatarSetType.const_41,parseInt(FigureData.const_888));
         ...
         if(this.var_426)
         {
            if(this.var_426.bitmap)
            {
               this.var_426.bitmap.dispose();
            }
            this.var_426.bitmap = new BitmapData(this.var_426.width,this.var_426.height,true,0);
            _loc7_ = (this.var_426.width - _loc1_.width) / 2;
            _loc8_ = (this.var_426.height - _loc1_.height) / 2;
            this.var_426.bitmap.draw(_loc1_,new Matrix(1,0,0,1,_loc7_,_loc8_));
         }
         if(_loc2_)
         {
            _loc1_.dispose();
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "set_button":
               ...
               this.var_1138 = this.var_26.gender;
               this.var_26.handler.saveWardrobeOutfit(this.var_2199,this);
               this.updateView();
               break;
            case "get_button":
               if(this._figure)
               {
                  this.var_26.loadAvatarInEditor(this._figure,this.var_1138,this.var_26.clubMemberLevel);
               }
         }
      }
