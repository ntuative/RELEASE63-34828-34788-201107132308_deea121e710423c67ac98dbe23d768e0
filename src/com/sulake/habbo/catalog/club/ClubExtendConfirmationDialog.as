package com.sulake.habbo.catalog.club
{
   ...
   public class ClubExtendConfirmationDialog
   {
      ...
      private static const const_1463:String = "your_price_icon";
      
      private static const const_1464:String = "http://images.habbo.com/c_images/catalogue/vip_extend_tsr.png";
      
      private static const const_1461:String = "image/png";
      
      private static const const_1462:int = 2000;
      
      private static const const_1460:int = 75;
      ...
      private var var_623:IRegionWindow;
      
      private var var_625:ITextWindow;
      
      private var var_371:IBitmapWrapperWindow;
      
      private var var_626:Vector.<BitmapData>;
      
      private var var_774:Timer;
      ...
      public function ClubExtendConfirmationDialog(param1:ClubExtendController, param2:ClubOfferExtendData)
      {
         ...
         this.var_26 = param1;
         this.var_105 = param2;
         this.var_626 = new Vector.<BitmapData>(const_386);
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_623)
         {
            this.var_623.removeEventListener(WindowMouseEvent.const_25,this.onMouseOutLaterRegion);
            this.var_623.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onMouseOverLaterRegion);
            this.var_623 = null;
         }
         if(this.var_625)
         {
         ...
         if(this.var_626)
         {
            ...
            {
               this.var_626[_loc1_].dispose();
               this.var_626[_loc1_] = null;
               _loc1_++;
            }
            this.var_626 = null;
         }
      ...
      public function showConfirmation() : void
      {
         ...
         var _loc9_:* = null;
         var _loc10_:* = null;
         if(!this.var_105 || !this.var_26 || this._disposed)
         {
            return;
         }
         ...
         this.var_623 = this._view.findChildByName("maybe_later_region") as IRegionWindow;
         this.var_625 = this._view.findChildByName("maybe_later_link") as ITextWindow;
         if(!this.var_623 || !this.var_625)
         {
            return;
         }
         this.var_623.addEventListener(WindowMouseEvent.const_25,this.onMouseOutLaterRegion);
         this.var_623.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onMouseOverLaterRegion);
         ...
         _loc4_.height = 144;
         _loc4_.width = 133;
         this.loadAssetFromUrl("club_teaser","club_teaser",const_1464,const_1461,this.onTeaserLoaded);
         ...
         this.var_371 = this._view.findChildByName(const_1463) as IBitmapWrapperWindow;
         ...
         while(_loc8_ < const_386)
         {
            ...
            this.var_626[_loc8_] = _loc10_.clone();
            _loc8_++;
         }
         this.startAnimation();
      }
      ...
      private function onMouseOutLaterRegion(param1:WindowMouseEvent) : void
      {
         if(this.var_625)
         {
            this.var_625.textColor = const_2047;
         }
      }
      ...
      private function onMouseOverLaterRegion(param1:WindowMouseEvent) : void
      {
         if(this.var_625)
         {
            this.var_625.textColor = LINK_COLOR_HOVER;
         }
      }
      ...
      private function startAnimation() : void
      {
         ...
         this.var_774 = new Timer(const_1462);
         this.var_774.addEventListener(TimerEvent.TIMER,this.onAnimationTrigger);
         this.var_774.start();
      }
      ...
      private function setAnimationFrame() : void
      {
         ...
         if(this.var_624 < const_386)
         {
            this.var_371.bitmap = new BitmapData(this.var_371.width,this.var_371.height,true,0);
            this.var_371.bitmap.copyPixels(this.var_626[this.var_624],this.var_626[this.var_624].rect,new Point(0,0));
         }
         else
         {
            Logger.log("Animation frame " + this.var_624);
         }
      }
      
      private function startAnimationFrame() : void
      {
         this.var_440 = new Timer(const_1460,const_386 - 1);
      ...
      {
         if(!param1 || !param2 || !this.var_26 || !this.var_105 || this._disposed)
         {
            return;
         }
