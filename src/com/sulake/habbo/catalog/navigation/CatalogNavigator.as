package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_3112:String = "magic.credits";
      
      private var var_3074:String = "magic.pixels";
      
      private var var_3073:String = "catalog.page.club";
      ...
      public function CatalogNavigator(param1:IHabboCatalog, param2:IWindowContainer)
      {
         ...
         if(this._scrollBar != null)
         {
            ...
            this._scrollBar.addEventListener(WindowEvent.const_899,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_313,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_959,this.deActivateScrollbar);
      ...
      {
         this.openPage(this.var_3074);
      }
      
      private function openClubPage() : void
      {
         this._catalog.openCatalogPage(this.var_3073,true);
      }
