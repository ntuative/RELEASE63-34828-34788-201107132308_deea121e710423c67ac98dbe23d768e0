package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1720:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1683:XML;
      
      private static var var_1681:XML;
       
      
      private var var_2162:Number = 4.294967295E9;
      
      private var _icon:BitmapData;
      
      private var _window:IWindowContainer;
      
      private var var_3098:IWindowContainer;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_2162 == 4294967295)
            {
               this.var_2162 = _loc1_.color;
            }
            _loc1_.color = const_1720;
         }
      }
      ...
      {
         this.var_62 = navigator.catalog.windowManager.buildFromXML(var_1681) as IItemListWindow;
         if(this.var_62 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1683) as IWindowContainer;
         }
         else
         {
