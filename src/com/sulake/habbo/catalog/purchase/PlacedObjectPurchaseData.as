package com.sulake.habbo.catalog.purchase
{
   ...
   public class PlacedObjectPurchaseData implements IDisposable
   {
      ...
      private var var_2062:IProductData;
      
      private var var_647:IFurnitureData;
      ...
      {
         this.var_1179 = param1.offerId;
         this.var_2063 = param1.productContainer.firstProduct.productClassId;
         this.var_2062 = param1.productContainer.firstProduct.productData;
         this.var_647 = param1.productContainer.firstProduct.furnitureData;
         this.var_1466 = param1.productContainer.firstProduct.extraParam;
      }
      
      public function toString() : String
      {
         return [this._roomCategory,this._roomId,this.var_239,this._category,this.var_2174,this._x,this.var_172,this._direction,this.var_1179,this.var_2063].toString();
      }
