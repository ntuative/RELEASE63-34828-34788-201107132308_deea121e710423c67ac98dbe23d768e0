package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener, IDisposable
   {
      ...
      private const const_2106:uint = 4.293848814E9;
      
      private const const_2105:uint = 4.294967295E9;
      
      private const const_1643:uint = 4.291613146E9;
      ...
      public function onIsOfferGiftable(param1:IsOfferGiftableMessageParser) : void
      {
         ...
         if(this.var_1179 != param1.offerId)
         {
            return;
         }
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            if(_loc12_ != null)
            {
               _loc12_.addEventListener(WindowEvent.const_374,this.onFreeWrappingSelected);
               _loc12_.addEventListener(WindowEvent.const_648,this.onFreeWrappingUnSelect);
            }
            ...
            this.var_1774 = _loc1_.stuffTypes;
            this.var_775 = _loc1_.boxTypes;
            this.var_776 = _loc1_.ribbonTypes;
            this.var_1180 = this.var_1774[0];
            this.var_375 = this.var_775[0];
            this.var_374 = this.var_776[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         if(this.var_374 < 0)
         {
            this.var_374 = this.var_776.length - 1;
         }
         if(this.var_374 > this.var_776.length - 1)
         {
            this.var_374 = 0;
         }
         if(this.var_375 < 0)
         {
            this.var_375 = this.var_775.length - 1;
         }
         if(this.var_375 > this.var_775.length - 1)
         {
            this.var_375 = 0;
         }
         var _loc1_:int = this.var_775[this.var_375] * 1000 + this.var_776[this.var_374];
         if(this._window == null)
         {
            return;
         }
         ...
         var _loc2_:ImageResult = this._roomEngine.getFurnitureImage(this.var_1180,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc2_ == null)
         {
            return;
         }
         this.var_1467 = _loc2_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         for each(_loc3_ in this.var_1774)
         {
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1180);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_775[this.var_375]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_776[this.var_374]);
         this._catalog.purchaseProductAsGift(this.var_1468,this.var_1179,this.var_1466,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      
      private function onBuyButtonClick(param1:WindowEvent) : void
      {
         this._catalog.purchaseProduct(this.var_1468,this.var_1179,this.var_1466);
         this.dispose();
      }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_777 == null)
         {
            this.var_777 = this.createWindow("suggestion_list_item") as IWindowContainer;
         }
         if(this.var_275 == null || this.var_777 == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_777.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function onSuggestionsMouseOver(param1:WindowEvent) : void
      {
         ...
         var _loc3_:IItemListWindow = this.var_275.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1643;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_2106) : uint(this.const_2105);
      }
      ...
      {
         this.var_1180 = param1.target.id;
         this.updateColorGrid();
         this.updatePreview();
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1180;
               }
            }
            _loc4_++;
         }
