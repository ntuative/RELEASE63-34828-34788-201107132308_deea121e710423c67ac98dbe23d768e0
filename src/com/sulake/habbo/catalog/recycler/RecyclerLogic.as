package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      {
         return this.var_692 != const_1108;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1980 != RecyclerStatusMessageEvent.const_1393;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_692 == const_481;
      }
      ...
      {
         this.var_692 = const_1107;
         this.var_135 = new Array(const_216);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1980)
         {
            case RecyclerStatusMessageEvent.const_2013:
               this.var_692 = const_481;
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1393:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1734:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1379:
               ...
               break;
            case RecyclerFinishedMessageEvent.const_1933:
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_135.length < const_216)
         {
            return false;
         }
         var _loc1_:int = 0;
