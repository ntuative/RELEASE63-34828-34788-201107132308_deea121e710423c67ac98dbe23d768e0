package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_2046:String = "ctlg_";
       
      
      protected var var_2251:XML;
      ...
      private var var_527:EventDispatcher;
      
      private var _catalog:HabboCatalog;
      
      private var var_1172:ItemGridCatalogWidget;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_527 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_1171);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1171);
      }
      ...
      {
         var _loc2_:String = const_2046 + param1;
         ...
         this.var_2251 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2251) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1835:
               if(this.var_1172 == null)
               {
                  this.var_1172 = new ItemGridCatalogWidget(param1,this._catalog.sessionDataManager);
                  this.var_38.push(this.var_1172);
               }
               break;
      ...
      private function initializeWidgets() : void
      {
         ...
         this.var_527.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_527 != null)
         {
            return this.var_527.dispatchEvent(param1);
         }
         return false;
      }
