package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogViewer implements ICatalogViewer
   {
      ...
      public function showCatalogPage(param1:int, param2:String, param3:IPageLocalization, param4:Array, param5:int) : void
      {
         ...
         {
            if(this.var_257.pageId == param1)
            {
               if(param5 > -1)
               {
                  this.var_257.selectOffer(param5);
               }
               return;
            }
            this._container.removeChild(this.var_257.window);
            this.var_257.dispose();
         }
      ...
      {
         return this.var_257.dispatchWidgetEvent(param1);
      }
      ...
      public function getCurrentLayoutCode() : String
      {
         ...
         return this.var_257.layoutCode;
      }
   }
}
