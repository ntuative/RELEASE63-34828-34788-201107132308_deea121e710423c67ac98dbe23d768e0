package com.sulake.habbo.catalog.viewer
{
   ...
   public class ProductGridItem implements IGridItem
   {
      ...
      private static const const_1053:String = "bg";
       
      
      protected var _view:IWindowContainer;
      
      private var var_216:IItemGrid;
      
      protected var _icon:IBitmapWrapperWindow;
      
      private var _disposed:Boolean = false;
      
      private var var_542:Object;
      ...
      {
         this._view.getChildByName(const_1053).style = HabboWindowStyle.const_31;
      }
      
      public function deActivate() : void
      {
         this._view.getChildByName(const_1053).style = 3;
      }
      ...
      public function setDraggable(param1:Boolean) : void
      {
         ...
         {
            (this._view as IInteractiveWindow).setMouseCursorForState(WindowState.const_91,MouseCursorType.const_743);
            (this._view as IInteractiveWindow).setMouseCursorForState(0 | 0,MouseCursorType.const_743);
         }
      }
      ...
      private function eventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_46)
         {
            ...
            this.var_216.select(this);
            this.var_542 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_542 != null && this.var_542 == param2)
         {
            _loc3_ = this.var_216.startDragAndDrop(this);
            if(_loc3_)
            {
               this.var_542 = null;
            }
