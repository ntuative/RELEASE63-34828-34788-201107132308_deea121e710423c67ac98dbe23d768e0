package com.sulake.habbo.catalog.viewer
{
   ...
   public class RoomPreviewer
   {
      ...
      private static const const_244:int = 1;
      ...
      private static const const_1683:int = 64;
      
      private static const const_1684:int = 32;
      
      private static const const_1682:int = 2500;
      ...
      public function RoomPreviewer(param1:IRoomEngine)
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_193,this.onRoomObjectAdded);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_746,this.onRoomObjectAdded);
      ...
      public function dispose() : void
      {
         ...
         {
            this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_193,this.onRoomObjectAdded);
            this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_746,this.onRoomObjectAdded);
      ...
      public function reset() : void
      {
         ...
         this.var_351 = RoomObjectCategoryEnum.const_180;
      }
      ...
      public function addFurnitureIntoRoom(param1:int, param2:IVector3d) : int
      {
         if(this._roomEngine != null)
         {
            if(this.var_351 == RoomObjectCategoryEnum.const_27 && this.var_1358 == param1)
            {
               return const_66;
            }
            this.reset();
            ...
            this.var_1660 = "";
            if(this._roomEngine.addObjectFurniture(const_54,const_53,const_66,param1,new Vector3d(const_715,const_716,0),param2,0,""))
            {
      ...
      public function addWallItemIntoRoom(param1:int, param2:IVector3d, param3:String) : int
      {
         if(this._roomEngine != null)
         {
            if(this.var_351 == RoomObjectCategoryEnum.const_26 && this.var_1358 == param1 && this.var_1660 == param3)
            {
               return const_66;
            }
            this.reset();
      ...
      public function addAvatarIntoRoom(param1:String, param2:int) : int
      {
         if(this._roomEngine != null)
         {
            ...
            if(this._roomEngine.addObjectUser(const_54,const_53,const_66,new Vector3d(const_715,const_716,0),new Vector3d(90,0,0),135,1,param1))
            {
               this.var_1359 = getTimer();
               this.var_1357 = true;
      ...
      public function changeRoomObjectState() : void
      {
         if(this._roomEngine != null)
         {
            ...
            {
               this._roomEngine.changeObjectState(const_54,const_53,const_66,this.var_351);
            }
         }
      }
      ...
      private function checkAutomaticRoomObjectStateChange() : void
      {
         ...
         {
            _loc1_ = getTimer();
            if(_loc1_ > this.var_1359 + const_1682)
            {
               this.var_1359 = _loc1_;
               if(this._roomEngine != null)
               {
                  this._roomEngine.changeObjectState(const_54,const_53,const_66,this.var_351);
               }
      ...
      public function getRoomCanvas(param1:int, param2:int) : DisplayObject
      {
         ...
         if(this._roomEngine != null)
         {
            _loc3_ = this._roomEngine.createRoomCanvas(const_54,const_53,const_244,param1,param2,this.var_1356);
            this._roomEngine.setRoomCanvasMask(const_54,const_53,const_244,true);
            _loc4_ = this._roomEngine.getRoomCanvasGeometry(const_54,const_53,const_244);
            if(_loc4_ != null)
            {
               _loc4_.adjustLocation(new Vector3d(const_715,const_716,0),30);
            }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:Rectangle = this._roomEngine.getRoomObjectBoundingRectangle(const_54,const_53,const_66,this.var_351,const_244);
         if(_loc2_ != null && param1 != null)
         {
            _loc2_.offset(-(this.var_1355 >> 1),-(this.var_1104 >> 1));
            ...
            else
            {
               ...
               if(_loc3_.width - this.var_51.width > this.var_1355 - this.var_51.width >> 1 || _loc3_.height - this.var_51.height > this.var_1104 - this.var_51.height >> 1 || this.var_51.width < 1 || this.var_51.height < 1)
               {
                  this.var_51 = _loc3_;
               }
            }
      ...
      private function validatePreviewSize(param1:Point) : Point
      {
         ...
         var _loc2_:IRoomGeometry = this._roomEngine.getRoomCanvasGeometry(const_54,const_53,const_244);
         if(this.var_51.width > this.var_1355 * (1 + const_487) || this.var_51.height > this.var_1104 * (1 + const_487))
         {
            if(_loc2_.isZoomedIn())
            {
               _loc2_.performZoomOut();
               this.var_1356 = const_1684;
               this.var_2127 = true;
               param1.x >>= 1;
               param1.y >>= 1;
               this.var_51.left >>= 2;
         ...
         else if(this.var_51.width << 1 < this.var_1355 * (1 + const_487) - 5 && this.var_51.height << 1 < this.var_1104 * (1 + const_487) - 5)
         {
            if(!_loc2_.isZoomedIn() && !this.var_2127)
            {
               _loc2_.performZoomIn();
               this.var_1356 = const_1683;
               param1.x <<= 1;
               param1.y <<= 1;
            }
         }
      ...
      private function getCanvasOffset(param1:Point) : Point
      {
         ...
         var _loc4_:* = this.var_1104 - this.var_51.height >> 1;
         if(_loc4_ > 10)
         {
      ...
      public function updatePreviewRoomView() : void
      {
         ...
         if(this._roomEngine != null)
         {
            _loc1_ = this._roomEngine.getRoomCanvasScreenOffset(const_54,const_53,const_244);
            if(_loc1_ != null)
            {
               ...
               if(this.var_51 != null)
               {
                  ...
                  if(_loc3_ != null)
                  {
                     this._roomEngine.setRoomCanvasScreenOffset(const_54,const_53,const_244,_loc3_);
                  }
      ...
      private function onRoomObjectAdded(param1:RoomEngineObjectEvent) : void
      {
         ...
         if(param1.roomId == const_54 && param1.roomCategory == const_53 && param1.objectId == const_66 && param1.category == this.var_351)
         {
            this.var_51 = null;
            this.var_2127 = false;
            ...
            {
               _loc3_ = _loc2_.getModel().getNumber(RoomObjectVariableEnum.const_663);
               _loc4_ = _loc2_.getModel().getNumber(RoomObjectVariableEnum.const_758);
