package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_2354:int = 40;
      
      private const const_2353:int = 10;
      
      private var var_828:Array;
      
      private var var_1545:MarketPlaceOfferData;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_555)
         {
            this.var_555.removeEventListener(TimerEvent.TIMER,this.onPopulationTimer);
            this.var_555 = null;
         }
      }
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         switch(param1)
         {
            ...
            case "search_by_activity":
               _loc5_ = "marketplace_search_simple";
               this.var_828 = [3,4,5,6];
               break;
            case "search_advanced":
               _loc5_ = "marketplace_search_advanced";
               this.var_828 = [1,2,3,4,5,6];
               break;
            default:
               return;
         }
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(this.getSortKeys(this.var_828));
            _loc7_.selection = 0;
         }
      }
      ...
      private function updateList() : void
      {
         ...
         if(!this.var_555)
         {
            this.var_555 = new Timer(25);
            this.var_555.addEventListener(TimerEvent.TIMER,this.onPopulationTimer);
         }
         this.var_1263 = 0;
         this.populateList();
         this.var_555.start();
      ...
      {
         var _loc5_:* = null;
         this.updateStatusDisplay(this.const_2077);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < this.var_828.length)
         {
            _loc4_ = this.var_828[_loc6_.selection];
         }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  this.marketPlace.buyOffer(this.var_1545.offerId);
            }
            return;
         }
         if(param1.type == WindowEvent.const_48)
