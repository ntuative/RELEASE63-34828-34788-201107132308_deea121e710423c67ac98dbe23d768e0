package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_537:IDisplayObjectWrapper;
      
      private var var_1804:Point;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_195.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickRoomView);
            this.var_195 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_984 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1204 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_98 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_195 = _window.findChildByName("room_canvas_container") as IWindowContainer;
         if(this.var_195 != null)
         {
            this.var_195.visible = false;
            this.var_537 = this.var_195.findChildByName("room_canvas") as IDisplayObjectWrapper;
            _loc3_ = (page.viewer.catalog as HabboCatalog).roomPreviewer;
            if(this.var_537 != null && _loc3_ != null)
            {
               this.var_195.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickRoomView);
               _loc3_.reset();
               _loc4_ = _loc3_.getRoomCanvas(this.var_537.width,this.var_537.height);
               if(_loc4_ != null)
               {
                  this.var_537.setDisplayObject(_loc4_);
               }
            }
            else
            {
         ...
         this.var_1804 = new Point(this.var_98.x,this.var_98.y);
         this.var_536 = _window.findChildByName("bundleGrid") as IItemGridWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_984.text = _loc4_;
         this.var_1204.text = _loc5_;
         this.var_984.height = this.var_984.textHeight + 5;
         this.var_1204.y = this.var_984.y + this.var_984.height;
         this.var_1204.height = Math.max(130,this.var_1204.textHeight + 5);
         ...
         else
         {
            ...
            {
               case Offer.const_659:
                  _loc6_ = this._bundlePreview.clone();
                  if(this.var_536 != null)
                  {
                     this.var_536.visible = true;
                     _loc11_ = _loc2_.productContainer as BundleProductContainer;
                     _loc11_.populateItemGrid(this.var_536,this.var_1487,this.var_1846);
                     this.var_536.scrollV = 0;
                  }
                  if(this.var_195 != null)
                  {
                     this.var_195.visible = false;
               ...
               case Offer.const_409:
                  ...
                  if(this.var_195 != null)
                  {
                     if(_loc9_.productType == ProductTypeEnum.const_70 || _loc9_.productType == ProductTypeEnum.const_63 || _loc9_.productType == ProductTypeEnum.const_187)
                     {
                  ...
                  switch(_loc9_.productType)
                  {
                     case ProductTypeEnum.const_70:
                        if(_loc8_ != null && this.var_537 != null)
                        {
                        ...
                        else
                        {
                           ...
                           if(_loc17_.avatarRenderManager != null)
                           {
                              ...
                              if(_loc18_ != null)
                              {
                                 ...
                                 _loc18_.appendAction(AvatarAction.const_380,AvatarAction.const_612);
                                 _loc18_.appendAction(AvatarAction.const_337,_loc9_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2435)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2435 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_98 != null && true)
         {
            ...
            this.var_98.x = this.var_1804.x;
            this.var_98.y = this.var_1804.y;
            if(param3 != null)
            {
