package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_964:ITextFieldWindow;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_965.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_965 = null;
         }
         if(this.var_964 != null)
         {
            this.var_964.removeEventListener(WindowKeyboardEvent.const_191,this.windowKeyEventProcessor);
            this.var_964 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_965 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_965 != null)
         {
            this.var_965.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_964 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_964 != null)
         {
            this.var_964.addEventListener(WindowKeyboardEvent.const_191,this.windowKeyEventProcessor);
         }
         return true;
      }
