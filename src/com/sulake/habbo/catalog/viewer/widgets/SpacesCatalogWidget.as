package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1538:String = "default";
      ...
      private var var_1539:String = "1.1";
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1028 = this.parseElements(_loc2_.floors.pattern);
         this.var_1261 = this.parseElements(_loc2_.walls.pattern);
         this.var_1262 = this.parseElements(_loc2_.landscapes.pattern);
         for each(_loc3_ in page.offers)
         {
            ...
            {
               case "floor":
                  for(_loc10_ in this.var_1028)
                  {
                     _loc11_ = this.var_1028[_loc10_];
         ...
         events.dispatchEvent(new CatalogWidgetUpdateRoomPreviewEvent(this._floorType,this.var_1538,this.var_1539,64));
         return true;
      }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_wall_color_next":
               ...
               break;
            case "ctlg_buy_wall":
               _loc3_ = this.var_1260[this.var_455];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_floor_color_next":
               ...
               break;
            case "ctlg_buy_floor":
               _loc3_ = this.var_1259[this.var_454];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_buy_landscape":
               _loc3_ = this._landscapeOffers[this.var_459];
               if(_loc3_ != null)
               {
      ...
      private function updateConfiguration() : void
      {
         ...
         var _loc2_:String = this.var_669[this.var_454];
         var _loc3_:Array = this.var_1028[_loc2_];
         if(_loc3_ != null && this.var_456 >= 0)
         {
            _loc11_ = _loc3_[this.var_456];
            if(_loc11_ != null)
            {
               this._floorType = _loc11_;
            }
         }
         var _loc4_:Offer = this.var_1259[this.var_454];
         if(_loc4_ != null)
         {
         ...
         var _loc5_:String = this.var_823[this.var_455];
         var _loc6_:Array = this.var_1261[_loc5_];
         if(_loc6_ != null && this.var_458 >= 0)
         {
            _loc13_ = _loc6_[this.var_458];
            if(_loc13_ != null)
            {
               this.var_1538 = _loc13_;
            }
         }
         var _loc7_:Offer = this.var_1260[this.var_455];
         if(_loc7_ != null)
         {
         ...
         var _loc8_:String = this.var_824[this.var_459];
         var _loc9_:Array = this.var_1262[_loc8_];
         if(_loc9_ != null && this.var_457 >= 0)
         {
            _loc15_ = _loc9_[this.var_457];
            if(_loc15_ != null)
            {
               this.var_1539 = _loc15_;
            }
         }
         var _loc10_:Offer = this._landscapeOffers[this.var_459];
         if(_loc10_ != null)
         {
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_117:
               ...
               if(this.var_454 < 0)
               {
                  this.var_454 = this.var_669.length - 1;
               }
               if(this.var_454 >= this.var_669.length)
               {
                  this.var_454 = 0;
               }
               this.var_456 = 0;
               this.var_1025 = 0;
               _loc5_ = this.var_669[this.var_454];
               _loc6_ = this.var_1028[_loc5_];
               if(_loc6_ != null)
               {
            ...
            case const_238:
               ...
               if(this.var_455 < 0)
               {
                  this.var_455 = this.var_823.length - 1;
               }
               if(this.var_455 == this.var_823.length)
               {
                  this.var_455 = 0;
               }
               this.var_458 = 0;
               this.var_1027 = 0;
               _loc7_ = this.var_823[this.var_455];
               _loc8_ = this.var_1261[_loc7_];
               if(_loc8_ != null)
               {
            ...
            case TYPE_LANDSCAPE:
               ...
               if(this.var_459 < 0)
               {
                  this.var_459 = this.var_824.length - 1;
               }
               if(this.var_459 >= this.var_824.length)
               {
                  this.var_459 = 0;
               }
               this.var_457 = 0;
               this.var_1026 = 0;
               _loc9_ = this.var_824[this.var_459];
               _loc10_ = this.var_1262[_loc9_];
               if(_loc10_ != null)
               {
                  this.var_1026 = _loc10_.length;
               }
