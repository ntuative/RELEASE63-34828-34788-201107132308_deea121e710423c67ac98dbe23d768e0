package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesNewCatalogWidget extends ItemGridCatalogWidget implements IDisposable, ICatalogWidget, IItemGrid
   {
      ...
      private var var_496:ISelectorWindow;
      ...
      public function SpacesNewCatalogWidget(param1:IWindowContainer, param2:ISessionDataManager)
      {
         ...
         super(param1,param2);
         this.var_496 = _window.findChildByName("groups") as ISelectorWindow;
         if(this.var_496)
         {
            _loc3_ = 0;
            while(_loc3_ < this.var_496.numSelectables)
            {
               _loc4_ = this.var_496.getSelectableAt(_loc3_);
      ...
      override public function init() : Boolean
      {
         ...
         this.switchCategory(this.var_118[this.var_574]);
      ...
      {
         var _loc2_:int = this.var_653[this.var_574];
         var _loc3_:Offer = this.var_229[this.var_574][_loc2_];
      ...
      public function selectIndex(param1:int) : void
      {
         ...
         {
            _loc2_ = this.var_229[this.var_574][param1];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         this.var_653[this.var_574] = (this.var_229[this.var_574] as Array).indexOf(_loc2_);
         this.updateRoomPreview();
      }
      
      private function updateRoomPreview() : void
      {
         var _loc1_:int = this.var_653[0];
         var _loc2_:int = this.var_653[1];
         var _loc3_:int = this.var_653[2];
      ...
      private function createOfferGroups() : Boolean
      {
         ...
         {
            if(!(_loc1_.pricingModel == Offer.const_420 || _loc1_.pricingModel == Offer.const_409))
            {
               continue;
            }
            ...
            if(!(_loc2_.productType == ProductTypeEnum.const_63 || _loc2_.productType == ProductTypeEnum.const_70))
            {
               continue;
            }
      ...
      private function onSelectGroup(param1:WindowEvent) : void
      {
         ...
         if(_loc2_)
         {
            _loc3_ = this.var_496.getSelectableIndex(_loc2_);
      ...
      private function switchCategory(param1:String) : void
      {
         ...
         if(_loc2_ > -1)
         {
            ...
            page.replaceOffers(this.var_229[this.var_574],false);
            resetTimer();
            populateItemGrid();
            ...
            _loc3_ = this.var_653[this.var_574];
