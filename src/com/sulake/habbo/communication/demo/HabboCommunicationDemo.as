package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2573:PseudoRandom;
      ...
      private const const_2072:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_656 = param1;
            this.var_64.initConnection(HabboConnectionType.const_312);
         }
      }
      ...
      {
         if(this.var_64 && this.var_156 && this.var_15 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_656 = this.var_156.getKey("sso.ticket",null);
         this.var_1893 = this.var_156.getKey("flash.client.url","");
         this.var_2572 = this.var_156.getKey("external.variables.txt","");
         if(this.var_250 == null)
         {
            this.var_250 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc5_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_750,this.onInitConnection);
            }
            else
            {
               Core.crash("Login without an SSO ticket is not supported",Core.const_1853);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_64.mode = HabboConnectionType.const_1331;
            }
         }
         this.var_64.initConnection(HabboConnectionType.const_312);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_1027);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2573 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_64.mode)
         {
            case HabboConnectionType.const_100:
               ...
               this.var_250.loadBannerImage(_loc7_ + "?token=" + this.var_1519,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1331:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1923:
               this.var_1008 = this.generateRandomHexString(30);
               this.var_548 = new DiffieHellman(new BigInteger(this.var_156.getKey("connection.development.prime"),16),new BigInteger(this.var_156.getKey("connection.development.generator"),16));
               this.var_548.init(this.var_1008);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2573);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1893,this.var_2572));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_2072,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_656 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_656);
            _loc2_.send(_loc4_);
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2571)
         {
