package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_750:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_138.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_164,HabboWindowStyle.const_47,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_2072,"/");
         if(_loc5_ != null)
         {
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_2072,"/");
         ...
         {
            dispatchEvent(new Event(const_750));
         }
      }
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_162.removeEventListener(SSOTicket.const_429,this.onParsedTicketSuccess);
            this.var_162.removeEventListener(SSOTicket.const_326,this.onParsedTicketFailure);
            this.var_162 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_162.addEventListener(SSOTicket.const_429,this.onParsedTicketSuccess);
         this.var_162.addEventListener(SSOTicket.const_326,this.onParsedTicketFailure);
      }
