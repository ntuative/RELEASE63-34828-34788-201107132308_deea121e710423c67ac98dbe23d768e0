package com.sulake.habbo.communication.messages.incoming.quest
{
   ...
   public class QuestMessageData
   {
      ...
      public function get waitPeriodSeconds() : int
      {
         ...
         var _loc2_:int = _loc1_.getTime() - this.var_2123.getTime();
         return int(Math.max(0,this.var_1659 - Math.floor(_loc2_ / 1000)));
      }
      
      public function getCampaignLocalizationKey() : String
      {
         return "quests." + this.var_2122;
      }
      
      public function getQuestLocalizationKey() : String
      {
         return this.getCampaignLocalizationKey() + "." + this.var_2124;
      }
      ...
      {
         return this.var_2126 >= this.var_2121;
      }
