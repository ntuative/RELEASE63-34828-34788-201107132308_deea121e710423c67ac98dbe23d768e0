package com.sulake.habbo.friendbar.data
{
   ...
   public class HabboFriendBarData extends Component implements IHabboFriendBarData
   {
      ...
      private static const const_1092:Boolean = false;
      
      private static const const_698:String = "Navigation";
      
      private static const const_699:String = "Friend Bar";
      
      private static const const_1565:String = "go.friendbar";
      
      private static const const_1562:String = "chat_btn_click";
      
      private static const const_1564:String = "find_friends_btn_click";
      
      private static const const_1090:String = "Toolbar";
      
      private static const const_1089:String = "open";
      
      private static const const_1091:String = "close";
      
      private static const const_1563:String = "FRIENDLIST";
      
      private static const const_1561:String = "MESSENGER";
      ...
      private var var_222:IHabboMessenger;
      
      private var var_679:IHabboEventStream;
         ...
         if(!disposed)
         {
            ...
            if(this.var_86)
            {
               if(!this.var_86.disposed)
               {
                  ...
                  this.var_86.events.removeEventListener(FriendRequestEvent.const_210,this.onFriendRequestEvent);
               }
            ...
            if(this.var_222)
            {
               this.var_222.release(new IIDHabboMessenger());
               this.var_222 = null;
            }
            if(this.var_679)
            {
               this.var_679.release(new IIDHabboEventStream());
               this.var_679 = null;
            }
            this.var_111 = null;
      ...
      {
         return this.var_333.getValue(param1);
      }
      ...
      public function followToRoom(param1:int) : void
      {
         if(this.var_94)
         {
            ...
            this.var_94.getHabboMainConnection(null).send(new EventLogMessageComposer(const_698,const_699,const_1565));
         }
      }
      ...
      public function startConversation(param1:int) : void
      {
         if(this.var_222)
         {
            this.var_222.startConversation(param1);
            events.dispatchEvent(new NewMessageEvent(false,param1));
            if(this.var_94)
            {
               this.var_94.getHabboMainConnection(null).send(new EventLogMessageComposer(const_698,const_699,const_1562));
            }
         }
      }
      ...
      public function findNewFriends() : void
      {
         if(this.var_94)
         {
            ...
            this.var_94.getHabboMainConnection(null).send(new EventLogMessageComposer(const_698,const_699,const_1564));
         }
      }
      ...
      public function toggleFriendList() : void
      {
         ...
         if(this.var_86)
         {
            if(!this.var_86.disposed)
            {
               ...
               if(this.var_94)
               {
                  this.var_94.getHabboMainConnection(null).send(new EventLogMessageComposer(const_1090,const_1563,!!this.var_86.isOpen() ? const_1089 : const_1091));
               }
            }
         }
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_222)
         {
            ...
            {
               this.var_222.toggleMessenger();
               if(this.var_94)
               {
                  this.var_94.getHabboMainConnection(null).send(new EventLogMessageComposer(const_1090,const_1561,!!this.var_222.isOpen() ? const_1089 : const_1091));
               }
            }
         }
      }
      ...
      public function toggleOfflineStream() : void
      {
         if(this.var_679)
         {
            if(!this.var_679.disposed)
            {
               this.var_679.visible = !this.var_679.visible;
            }
         }
      }
      ...
      {
         this.var_1039 = param2 as IHabboConfigurationManager;
         this.var_2647 = this.var_1039.getBoolean("friendbar.notifications.enabled",false);
         this.var_1944 = this.var_1039.getBoolean("friendbar.requests.enabled",false);
      }
      ...
      {
         this.var_222 = param2 as IHabboMessenger;
      }
      
      private function onOfflineStreamAvailable(param1:IID, param2:IUnknown) : void
      {
         this.var_679 = param2 as IHabboEventStream;
      }
      ...
      private function onFriendListComponentAvailable(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_86.events.addEventListener(FriendRequestEvent.const_210,this.onFriendRequestEvent);
      }
      ...
      private function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         {
            _loc3_ = this.var_333.getValue(_loc8_);
            if(_loc3_)
            {
               this.var_333.remove(_loc8_);
               this.var_111.splice(this.var_111.indexOf(_loc3_),1);
            }
         }
         for each(_loc4_ in _loc6_)
         {
            _loc3_ = this.var_333.getValue(_loc4_.id);
            if(_loc3_)
            {
            ...
            else if(_loc4_.online || const_317)
            {
               ...
               this.var_333.add(_loc3_.id,_loc3_);
            }
         }
         for each(_loc4_ in _loc7_)
         {
            if(_loc4_.online || const_317)
            {
               if(this.var_333.getValue(_loc4_.id) == null)
               {
                  _loc3_ = new FriendEntity(_loc4_.id,_loc4_.name,_loc4_.realName,_loc4_.motto,_loc4_.gender,_loc4_.online,_loc4_.followingAllowed,_loc4_.figure,_loc4_.categoryId,_loc4_.lastAccess);
      ...
      private function onNewConsoleMessage(param1:NewConsoleMessageEvent) : void
      {
         ...
         this.var_834 = _loc2_.senderId;
         var _loc3_:Boolean = true;
         if(this.var_222)
         {
            if(this.var_222.isOpen())
            {
               _loc4_ = this.var_222.getActiveConversation();
               if(_loc4_)
               {
                  if(_loc4_.id == this.var_834)
                  {
                     _loc3_ = false;
                  }
               }
         ...
         if(_loc3_)
         {
            events.dispatchEvent(new NewMessageEvent(true,this.var_834));
            this.makeNotification(String(this.var_834),FriendNotification.const_398,null,false,false);
         }
      }
      ...
      private function onRoomInvite(param1:RoomInviteEvent) : void
      {
         ...
         this.var_834 = _loc2_.senderId;
         if(this.var_222 && !this.var_222.isOpen())
         {
            events.dispatchEvent(new NewMessageEvent(true,this.var_834));
            this.makeNotification(String(this.var_834),FriendNotification.const_398,null,true,false);
         }
      }
