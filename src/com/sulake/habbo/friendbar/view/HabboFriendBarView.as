package com.sulake.habbo.friendbar.view
{
   ...
   public class HabboFriendBarView extends AbstractView implements IHabboFriendBarView, IAvatarImageListener
   {
      ...
      private static const const_1541:int = 127;
      ...
      private static const const_1539:Boolean = false;
      
      private static const const_693:int = 3;
      
      private static const const_1537:String = "arrow";
      
      private static const const_1533:String = "left";
      
      private static const const_1536:String = "right";
      
      private static const const_1542:String = "bar_xml";
      
      private static const const_1545:String = "toggle_xml";
      
      private static const const_79:String = "container";
      
      private static const const_1080:String = "wrapper";
      
      private static const const_1538:String = "border";
      
      private static const const_695:String = "list";
      ...
      private static const const_1535:String = "button_right";
      
      private static const const_1534:String = "button_left_page";
      
      private static const const_1531:String = "button_right_page";
      
      private static const const_1532:String = "button_left_end";
      
      private static const const_1546:String = "button_right_end";
      
      private static const const_1422:String = "button_close";
      
      private static const const_1540:String = "button_open";
      
      private static const const_1544:String = "link_friendlist";
      
      private static const const_1079:String = "messenger";
      
      private static const const_1078:String = "friendlist";
      
      private static const const_694:String = "stream";
      ...
      private var var_1257:ITab;
      
      private var var_1014:int = -1;
      
      private var _startIndex:int = 0;
      
      private var var_1535:TextCropper;
      
      private var var_552:FriendListIcon;
      
      private var var_388:MessengerIcon;
      
      private var var_818:StreamIcon;
         ...
         if(!disposed)
         {
            ...
            if(this.var_50)
            {
               if(!this.var_50.disposed)
               {
                  ...
                  {
                     this.var_50.events.removeEventListener(FriendBarUpdateEvent.const_753,this.onRefreshView);
                     this.var_50.events.removeEventListener(FindFriendsNotificationEvent.TYPE,this.onFindFriendsNotification);
                     this.var_50.events.removeEventListener(FriendRequestUpdateEvent.const_912,this.onFriendRequestUpdate);
                     this.var_50.events.removeEventListener(NewMessageEvent.const_939,this.onNewInstantMessage);
                     this.var_50.events.removeEventListener(NotificationEvent.const_757,this.onFriendNotification);
                  }
            ...
            if(_windowManager)
            {
               if(true)
               {
                  _windowManager.getWindowContext(const_474).getDesktopWindow().removeEventListener(WindowEvent.const_40,this.onDesktopResized);
               }
            }
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         if(this.var_220)
         {
            this.var_220.visible = !param1;
            if(this.var_45)
            {
               this.var_220.x = this.var_45.x;
               this.var_220.y = this.var_45.y;
               this.var_220.activate();
            }
         }
      }
      ...
      public function populate() : void
      {
         ...
         var _loc15_:int = 0;
         var _loc16_:* = null;
         var _loc1_:int = this.var_1014;
         this.deSelect(false);
         var _loc2_:IWindowContainer = this.var_45.findChildByName(const_79) as IWindowContainer;
         var _loc3_:IItemListWindow = _loc2_.findChildByName(const_695) as IItemListWindow;
         ...
         var _loc9_:int = _loc6_ + (!!this.var_1536 ? 1 : 0) + (_loc7_ > 0 ? 1 : 0);
         ...
         if(this.var_1536)
         {
            ...
            {
               _loc15_ = 1;
               if(this.var_73.length + _loc15_ < const_693)
               {
                  _loc15_ = Math.min(_loc8_ - this.var_73.length,const_693 - this.var_73.length);
               }
      ...
      private function onFriendBarDataAvailable(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_50.events.addEventListener(FriendBarUpdateEvent.const_753,this.onRefreshView);
         this.var_50.events.addEventListener(FindFriendsNotificationEvent.TYPE,this.onFindFriendsNotification);
         this.var_50.events.addEventListener(FriendRequestUpdateEvent.const_912,this.onFriendRequestUpdate);
         this.var_50.events.addEventListener(NewMessageEvent.const_939,this.onNewInstantMessage);
         this.var_50.events.addEventListener(NotificationEvent.const_757,this.onFriendNotification);
      }
      ...
      {
         var _loc2_:* = null;
         Tab.var_359 = this.var_50;
         Tab.var_504 = this;
         Tab.ASSETS = assets;
         Tab.WINDOWING = _windowManager;
         Tab.var_2210 = var_757;
         Tab.var_2237 = this.var_1535;
         Token.WINDOWING = _windowManager;
         Token.ASSETS = assets;
         var _loc1_:IAsset = assets.getAssetByName(const_1542);
         this.var_45 = _windowManager.buildFromXML(_loc1_.content as XML,const_474) as IWindowContainer;
         this.var_45.x = const_696;
         this.var_45.y = this.var_45.parent.height - (this.var_45.height + const_1543);
         this.var_45.width = this.var_45.parent.width - (const_696 + const_1077);
         this.var_45.setParamFlag(WindowParam.const_257,true);
         this.var_45.procedure = this.barWindowEventProc;
         if(const_1539)
         {
            _loc1_ = assets.getAssetByName(const_1545);
            this.var_220 = _windowManager.buildFromXML(_loc1_.content as XML,const_474) as IWindowContainer;
            this.var_220.x = this.var_45.x;
            this.var_220.y = this.var_45.y;
            this.var_220.setParamFlag(WindowParam.const_257,true);
            this.var_220.visible = false;
            this.var_220.procedure = this.toggleWindowEventProc;
         }
         _loc2_ = IWindowContainer(this.var_45.findChildByName(const_1078));
         ...
         this.var_552 = new FriendListIcon(assets,_loc2_.getChildByName(ICON) as IBitmapWrapperWindow);
         _loc2_ = IWindowContainer(this.var_45.findChildByName(const_1079));
         _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onIconMouseEvent);
         _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onIconMouseEvent);
         _loc2_.addEventListener(WindowMouseEvent.const_25,this.onIconMouseEvent);
         this.var_388 = new MessengerIcon(assets,_loc2_.getChildByName(ICON) as IBitmapWrapperWindow);
         this.var_388.enable(false);
         this.visible = true;
         _windowManager.getWindowContext(const_474).getDesktopWindow().addEventListener(WindowEvent.const_40,this.onDesktopResized);
         this.var_45.findChildByName(const_694).visible = var_992.getBoolean("friendbar.stream.enabled",false) == true;
         _loc2_ = IWindowContainer(this.var_45.findChildByName(const_694));
         _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onIconMouseEvent);
         _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onIconMouseEvent);
         _loc2_.addEventListener(WindowMouseEvent.const_25,this.onIconMouseEvent);
         this.var_818 = new StreamIcon(assets,_loc2_.getChildByName(ICON) as IBitmapWrapperWindow);
      }
      ...
      public function getAvatarFaceBitmap(param1:String) : BitmapData
      {
         ...
         if(var_606)
         {
            _loc3_ = var_606.createAvatarImage(param1,AvatarScaleType.const_61,null,this);
            if(_loc3_)
            {
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         var _loc12_:* = null;
         var _loc13_:* = null;
         var _loc3_:IItemListWindow = this.var_45.findChildByName(const_695) as IItemListWindow;
      ...
      {
         return this.var_1014 == param1.id;
      }
      ...
      public function selectTab(param1:ITab, param2:Boolean) : void
      {
         if(!param1.selected)
         {
            ...
            {
               this.var_1014 = FriendEntityTab(param1).friend.id;
            }
         }
      }
      ...
      private function onFindFriendsNotification(param1:FindFriendsNotificationEvent) : void
      {
         ...
         {
            param1.dispose();
         },HabboAlertDialogFlag.const_666);
      }
      ...
      private function onFriendRequestUpdate(param1:FriendRequestUpdateEvent) : void
      {
         if(this.var_552)
         {
            this.var_552.notify(this.var_50.numFriendRequests > 0);
         }
         this.populate();
      }
      ...
      private function onNewInstantMessage(param1:NewMessageEvent) : void
      {
         if(this.var_388)
         {
            if(param1.notify)
            {
               this.var_388.notify(true);
            }
            else
            {
               this.var_388.enable(true);
            }
         }
      }
      ...
      private function barWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_46)
         {
            ...
            _loc4_ = this.var_50.numFriends + (!!this.var_1536 ? 1 : 0) + (this.var_50.numFriendRequests > 0 ? 1 : 0);
            switch(param2.name)
            {
         ...
         if(param1.type == WindowEvent.const_529)
         {
            this.deSelect(true);
         }
      }
      ...
      private function toggleArrowButtons(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc6_:IWindowContainer = this.var_45.findChildByName(const_1080) as IWindowContainer;
         _loc5_ = [];
         ...
         _loc5_ = [];
         _loc6_.groupChildrenWithTag(const_1533,_loc5_);
         for each(_loc4_ in _loc5_)
         {
            if(param2)
            {
         ...
         _loc5_ = [];
         _loc6_.groupChildrenWithTag(const_1536,_loc5_);
         for each(_loc4_ in _loc5_)
         {
            if(param3)
            {
         ...
         if(!disposed)
         {
            if(this.var_45)
            {
               ...
               if(!param1)
               {
                  ...
                  {
                     if(this.var_73.length < const_693)
                     {
                        param1 = true;
                     }
                     else if(this.var_73.length < this.var_50.numFriends + (!!this.var_1536 ? 1 : 0))
                     {
                        param1 = true;
                     }
      ...
      private function get maxNumOfTabsVisible() : int
      {
         ...
         return (_loc1_.width - _loc4_) / (const_1541 + _loc3_.spacing);
      }
