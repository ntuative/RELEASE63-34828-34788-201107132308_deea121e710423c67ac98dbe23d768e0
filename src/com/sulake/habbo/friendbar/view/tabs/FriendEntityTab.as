package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendEntityTab extends Tab
   {
      ...
      private static const const_1623:String = "entity_xml";
      
      private static const const_1625:String = "facebook_piece_xml";
      
      private static const const_1622:String = "controls_piece_xml";
      ...
      protected static const const_1129:String = "btn_message";
      ...
      protected static const const_530:String = "notification";
      
      private static const const_71:uint = 10338138;
      
      private static const const_1048:uint = 13891476;
      
      private static const const_1124:String = null;
      
      private static const const_708:String = "icon_tag_notify";
      
      private static const const_1624:String = "icon_tag_message";
      ...
      private static function purgeEntityPieces(param1:IWindowContainer) : void
      {
         ...
         var _loc4_:* = [];
         _loc2_.groupListItemsWithTag(const_530,_loc4_);
         if(_loc4_.length > 0)
         {
      ...
      override public function select(param1:Boolean) : void
      {
         ...
         if(!selected)
         {
            ...
            {
               _loc3_ = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1625).content as XML) as IWindowContainer;
               _loc3_.name = const_1419;
               _loc6_ = _loc3_.getChildByName(const_683) as ITextWindow;
               _loc6_.caption = this.friend.realName;
               if(!_loc6_.wordWrap)
               {
                  var_2237.crop(_loc6_);
               }
            ...
            {
               _loc3_ = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1622).content as XML) as IWindowContainer;
               _loc3_.name = const_1420;
               _loc8_ = _loc3_.getChildByName(const_1129);
               if(_loc8_)
               {
      ...
      {
         super.expose();
         _window.color = !!exposed ? uint(const_1048) : uint(const_71);
      ...
      protected function refresh() : void
      {
         ...
         if(this.var_168)
         {
            ...
            var_2237.crop(_loc1_.getChildByName(const_683) as ITextWindow);
      ...
      {
         var _loc1_:IWindowContainer = false ? const_484.pop() : WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1623).content as XML) as IWindowContainer;
      ...
      private function onButtonClick(param1:WindowMouseEvent) : void
      {
         if(!disposed && !recycled)
         {
            switch(param1.window.name)
            {
               case const_1129:
               case const_1041:
                  this.removeNotificationToken(FriendNotification.const_398,true);
                  if(var_359 && this.var_168)
                  {
                     var_359.startConversation(this.var_168.id);
                     this.deselect(true);
               ...
               case const_1421:
                  if(var_359 && this.var_168)
                  {
                     var_359.followToRoom(this.var_168.id);
                     this.deselect(true);
                  }
            }
         }
      ...
      public function addNotificationToken(param1:FriendNotification, param2:Boolean) : void
      {
         ...
         switch(param1.typeCode)
         {
            ...
            case FriendNotification.TYPE_ACHIEVEMENT:
               _loc4_ = new AchievementToken(this.friend,param1,param2,var_2210);
               _loc4_.iconElement.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onMouseClick);
               _loc5_ = const_708;
               break;
            case FriendNotification.const_1277:
               _loc4_ = new QuestToken(this.friend,param1,param2,var_2210);
               _loc4_.iconElement.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onMouseClick);
               _loc5_ = const_708;
               break;
            case FriendNotification.const_398:
