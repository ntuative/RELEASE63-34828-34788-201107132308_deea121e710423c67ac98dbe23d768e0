package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendRequestsTab extends Tab
   {
      ...
      protected static const const_2045:String = "friend_requests_tab_xml";
      ...
      protected static const const_2041:String = "badge_counter";
      ...
      protected static const const_2044:String = "button_accept";
      
      protected static const const_1035:String = "click_area_discard";
      
      protected static const const_1411:String = "text_discard";
      
      private static var var_1441:FriendRequestsTab;
      
      private static const const_71:uint = 4294625561;
      
      private static const const_1048:uint = 4294957414;
      
      private static const const_1424:uint = 4289431312;
      
      private static const const_1426:uint = 4290616362;
      
      private static const REGION_REJECT_COLOR_EXPOSED:uint = 16770666;
      
      private static const const_1425:uint = 16777215;
      ...
      public static function allocate(param1:Array) : FriendRequestsTab
      {
         ...
         _loc2_._window.findChildByName(const_2041).caption = String(param1.length);
         return _loc2_;
      }
               ...
               if(_loc2_)
               {
                  ...
                  if(!this.var_1742)
                  {
                     ...
                     if(_loc3_)
                     {
                        ...
                        {
                           _loc4_ = this.var_1164.clone() as IWindowContainer;
                           _loc4_.color = _loc8_ % 2 == 0 ? uint(const_1424) : uint(const_1426);
      ...
      {
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_2045).content as XML) as IWindowContainer;
         ...
         this.var_1164 = _loc7_.removeListItemAt(0) as IWindowContainer;
         return _loc1_;
      }
      ...
      private function bubbleEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case const_1422:
                  ...
                  break;
               case const_2042:
                  var_359.acceptAllFriendRequests();
                  break;
               case const_2043:
                  var_359.declineAllFriendRequests();
                  break;
               case const_2044:
                  var_359.acceptFriendRequest(param2.parent.id);
                  break;
               case const_1035:
                  var_359.declineFriendRequest(param2.parent.id);
            }
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            {
               ITextWindow(IWindowContainer(param2).getChildByName(const_1411)).textColor = REGION_REJECT_COLOR_EXPOSED;
            }
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(param2.name == const_1035)
            {
               ITextWindow(IWindowContainer(param2).getChildByName(const_1411)).textColor = const_1425;
            }
         }
      }
