package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1570:Point = new Point(110,50);
       
      
      private var _friendList:HabboFriendList;
      
      private var var_1960:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1960 = new FriendListTabsView(this._friendList);
      }
      ...
      public function openFriendList() : void
      {
         ...
         {
            this.prepare();
            this.var_16.position = const_1570;
         }
         else
         {
      ...
      private function prepare() : void
      {
         ...
         this.var_966 = IWindowContainer(this.var_16.content.findChildByName("main_content"));
         this.var_308 = IWindowContainer(this.var_16.content.findChildByName("footer"));
         this.var_1960.prepare(this.var_966);
         this.var_16.procedure = this.onWindow;
         this.var_16.content.setParamFlag(HabboWindowParam.const_1271,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_1397,true);
         this.var_16.header.setParamFlag(HabboWindowParam.const_802,false);
         this.var_16.header.setParamFlag(HabboWindowParam.const_860,true);
         this.var_16.content.setParamFlag(HabboWindowParam.const_802,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_860,true);
         this.var_16.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1569 = ITextWindow(this.var_16.findChildByName("info_text"));
         this.var_1569.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1957 == -1 ? 0 : int(this.var_16.height - this.var_1957);
         var _loc4_:int = this.var_1959 == -1 ? 0 : int(this.var_16.width - this.var_1959);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_308.y = Util.getLowestPoint(this.var_16.content);
         this.var_308.width = this._friendList.tabs.windowWidth;
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1374,this._friendList.tabs.findSelectedTab() != null);
         ...
         this.var_1957 = this.var_16.height;
         this.var_1959 = this.var_16.width;
