package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_2070:String = "no_reqs_info";
      ...
      private var var_1812:IContainerButtonWindow;
      
      private var var_1813:IContainerButtonWindow;
      ...
      {
         this.var_1812 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1813 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1813.procedure = this.onDismissAllButtonClick;
         this.var_1812.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         if(param1.state == FriendRequest.const_199)
         {
         ...
         else if(param1.state == FriendRequest.const_1228)
         {
      ...
      public function acceptAllRequests() : void
      {
         ...
         for each(_loc2_ in this._friendList.friendRequests.requests)
         {
            if(_loc2_.state != FriendRequest.const_456 && _loc2_.state != FriendRequest.const_424)
            {
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         if(this._friendList && this._friendList.events)
         {
            this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_210,param1));
         }
      }
      ...
      public function declineAllRequests() : void
      {
         ...
         for each(_loc2_ in this._friendList.friendRequests.requests)
         {
            if(_loc2_.state != FriendRequest.const_456 && _loc2_.state != FriendRequest.const_424)
            {
               ...
               if(this._friendList && this._friendList.events)
               {
                  this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_210,_loc2_.requestId));
               }
            }
         }
         this.refresh();
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1812,_loc1_);
         this.setEnabled(this.var_1813,_loc1_);
      }
