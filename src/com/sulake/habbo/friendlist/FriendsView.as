package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      private var var_2438:IContainerButtonWindow;
      
      private var var_2437:IContainerButtonWindow;
      
      private var var_2439:IContainerButtonWindow;
      
      private var var_2436:IContainerButtonWindow;
      
      private var var_62:IItemListWindow;
      
      private var var_681:AvatarPopupCtrl;
      ...
      public function init(param1:HabboFriendList) : void
      {
         ...
         this.var_681 = new AvatarPopupCtrl(this._friendList);
      }
      ...
      {
         this.var_2438 = this.initButton("open_minimail",this.onMinimailButtonClick,param1);
         this.var_2437 = this.initButton("open_homepage",this.onHomeButtonClick,param1);
         this.var_2439 = this.initButton("room_invite",this.onInviteButtonClick,param1);
         this.var_2436 = this.initButton("remove_friend",this.onRemoveButtonClick,param1);
         this.refreshButtons();
      }
      ...
      private function refreshFigure(param1:IWindowContainer, param2:Friend) : void
      {
         ...
         var _loc3_:IBitmapWrapperWindow = param1.getChildByName(HabboFriendList.const_181) as IBitmapWrapperWindow;
         if(!_loc3_)
         {
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_2438,this.isEnableMinimailButton(_loc1_));
         this.setEnabled(this.var_2437,this.isEnableHomeButton(_loc1_));
         this.setEnabled(this.var_2439,this.isEnableInviteButton(_loc1_));
         this.setEnabled(this.var_2436,this.isEnableRemoveButton(_loc1_));
      }
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_681.setData(_loc3_.online,_loc3_.name,_loc3_.motto,_loc3_.figure,_loc3_.lastAccess);
            this.var_681.showPopup(this._friendList.view.mainWindow,_loc3_.view);
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_681.closePopup();
         }
