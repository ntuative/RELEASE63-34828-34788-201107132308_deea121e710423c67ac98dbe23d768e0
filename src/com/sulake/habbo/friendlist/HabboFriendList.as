package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      public static const const_181:String = "face";
      ...
      private var var_2336:FriendListLookAndFeel;
      
      private var var_496:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1754:OpenedToWebPopup;
      ...
      private var var_1755:AvatarSearchResults;
      ...
      {
         this.var_2336 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_118 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1755 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1754 = new OpenedToWebPopup(this);
         }
         this.var_1754.show(x,y);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_454);
      }
      ...
      {
         var _loc2_:IAvatarImage = this.var_606.createAvatarImage(param1,AvatarScaleType.const_111,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         var _loc1_:String = this.var_144.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      
      private function getVariable(param1:String, param2:Dictionary) : String
      {
         return this.var_144.getKey(param1,param1,param2);
      }
      ...
      {
         this.var_1097 = param2 as IHabboNotifications;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_118.addCategory(new FriendCategory(FriendCategory.const_1366,this.getText("friendlist.friends")));
         this.var_118.addCategory(new FriendCategory(FriendCategory.const_426,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_118.addFriend(new Friend(_loc4_));
         }
         this.var_496 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_620)
         {
         ...
         {
            _loc5_ = this.var_118.findCategory(FriendCategory.const_426);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_496.findTab(FriendListTab.const_88).setNewMessageArrived(true);
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_496.findTab(FriendListTab.const_88);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1755.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_496.findTab(FriendListTab.const_88);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc1_:FriendListTab = this.var_496.findTab(FriendListTab.const_88);
         if(!_loc1_)
         {
            return;
         }
      ...
      {
         if(!this.var_769 || !this.var_120)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_769.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_43))
         {
            _loc2_ = this.var_120.vipLimit;
         }
         else if(this.var_769.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_35))
         {
         ...
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ != null && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     _loc5_ = _loc4_.getChildByName(const_181) as IBitmapWrapperWindow;
