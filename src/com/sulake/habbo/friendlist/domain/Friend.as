package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_2144:int = "F".charCodeAt(0);
      
      public static const const_2174:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_1138 = param1.gender;
         this.var_874 = param1.online;
         this.var_1970 = param1.followingAllowed && param1.online;
         this._figure = param1.figure;
         this.var_1760 = param1.motto;
         this.var_1759 = param1.lastAccess;
         this.var_1671 = param1.categoryId;
         this.var_1761 = param1.realName;
