package com.sulake.habbo.help.cfh.data
{
   ...
   public class UserRegistry
   {
      ...
      public function registerUser(param1:int, param2:String, param3:Boolean = true) : void
      {
         ...
         if(param3)
         {
            _loc4_ = new UserRegistryItem(param1,param2,this.var_1010);
         }
         else
         {
            _loc4_ = new UserRegistryItem(param1,param2);
         }
         if(param3 && this.var_1010 == "")
         {
            this.var_1525.push(param1);
         }
      ...
      {
         var _loc1_:int = 0;
         while(this.var_549.length > const_1517)
         {
      ...
      {
         var _loc1_:* = null;
         while(this.var_1525.length > 0)
         {
            _loc1_ = this.var_549.getValue(this.var_1525.shift());
            if(_loc1_ != null)
            {
               _loc1_.roomName = this.var_1010;
            }
         }
      }
   }
