package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1745:uint = 11129827;
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1747 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this.var_26.localization.registerParameter("help.tutorial.name.available","name",this.var_517);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1142 || param1 == ChangeUserNameResultMessageEvent.var_1143)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1165 = new NameSuggestionListRenderer(this.var_26);
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_517 = this.var_26.myName;
               this.showConfirmationView();
               break;
            ...
            case "confirm_name_button":
               this.var_26.changeName(this.var_517);
               break;
            ...
            case "header_button_close":
               this.var_26.showView(TutorialUI.const_98);
         }
      }
