package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_653:String = "TUI_GUIDEBOT_VIEW";
      ...
      private var var_395:NameChangeView;
      ...
      public function TutorialUI(param1:HabboHelp, param2:Boolean = true)
      {
         ...
         this.var_36.events.addEventListener(HabboHelpTutorialEvent.const_586,this.onTaskDoneEvent);
         this.var_36.events.addEventListener(HabboHelpTutorialEvent.const_638,this.onTaskDoneEvent);
         this.var_36.events.addEventListener(HabboHelpTutorialEvent.const_542,this.onTaskDoneEvent);
         if(this.var_36.sessionDataManager != null)
         {
            this.var_36.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_384,this.onFigureUpdate);
         }
      }
      ...
      {
         return this.var_1272 && this.var_1273 && this.var_1571;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_36)
         {
            this.var_36.events.removeEventListener(HabboHelpTutorialEvent.const_586,this.onTaskDoneEvent);
            this.var_36.events.removeEventListener(HabboHelpTutorialEvent.const_638,this.onTaskDoneEvent);
            this.var_36.events.removeEventListener(HabboHelpTutorialEvent.const_542,this.onTaskDoneEvent);
            if(this.var_36.sessionDataManager != null)
            {
               this.var_36.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_384,this.onFigureUpdate);
            }
            this.var_36 = null;
         }
      }
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_586:
               this.var_1571 = true;
               if(this.var_53 != null && this.var_53.id == const_653)
               {
                  this.showView(const_98);
               }
               break;
      ...
      public function showView(param1:String) : void
      {
         ...
         switch(param1)
         {
            ...
            case const_364:
               ...
               if(this.var_395 == null)
               {
                  this.var_395 = new NameChangeView(this);
               }
               this.var_395.showMainView();
               this.prepareForTutorial();
               break;
            case const_413:
         ...
         this._window.height = _loc2_.height + this.var_2397;
      ...
      public function prepareForTutorial() : void
      {
         ...
         this.var_36.hideUI();
         this.var_36.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_138));
      }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_53 != null && (this.var_53.id == const_364 || this.var_53.id == const_98))
         {
            this.showView(const_98);
         }
      }
      ...
      {
         this.var_1272 = true;
         if(this.var_53 != null && (this.var_53.id == const_413 || this.var_53.id == const_98))
         {
            this.showView(const_98);
         }
      }
      ...
      public function onChangeUserNameResult(param1:ChangeUserNameResultMessageEvent) : void
      {
         ...
         {
            this.var_395.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
         }
      }
      ...
      public function onCheckUserNameResult(param1:CheckUserNameResultMessageEvent) : void
      {
         ...
         if(_loc2_.resultCode == ChangeUserNameResultMessageEvent.var_505)
         {
            this.var_395.checkedName = _loc2_.name;
         }
         else
         {
            this.var_395.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
