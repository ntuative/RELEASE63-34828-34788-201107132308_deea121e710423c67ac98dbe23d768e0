package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private var var_2304:IWindowContainer;
      ...
      private var var_1740:IWindowContainer;
      ...
      {
         return !!this.var_16 ? Boolean(this.var_16.getStateFlag(WindowState.const_94)) : false;
      }
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         this.var_26.inventoryViewOpened(this.var_764);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true, param3:Boolean = false) : void
      {
         ...
         else
         {
            ...
            _loc4_.visible = true;
            _loc4_.activate();
            if(param1 != this.var_367 || !this.var_26.isInventoryCategoryInit(param1))
            {
               this.setViewToCategory(param1);
            }
      ...
      public function updateSubCategoryView() : void
      {
         ...
         this.setSubViewToCategory(this.var_764);
      }
      ...
      private function resetUnseenCounters(param1:String) : void
      {
         switch(param1)
         {
            ...
            case InventoryCategory.const_137:
               ...
               break;
            case InventoryCategory.const_214:
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         _loc2_.container.removeChild(this.var_1741);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_367 == InventoryCategory.const_137)
            {
               this.toggleCategoryView(InventoryCategory.const_137);
            }
            else if(this.var_367 == InventoryCategory.const_75)
            {
               this.toggleCategoryView(InventoryCategory.const_75);
            }
            else if(this.var_26 != null)
            {
               this.var_26.toggleInventoryPage(InventoryCategory.const_75);
            }
         }
      }
      ...
      private function updateUnseenBadgeCount() : void
      {
         if(!this.var_1740)
         {
            this.var_1740 = this.createCounter("badges");
         }
         var _loc1_:int = this.var_26.badgesModel.getUnseenItemCount();
         this.updateCounter(this.var_1740,_loc1_);
