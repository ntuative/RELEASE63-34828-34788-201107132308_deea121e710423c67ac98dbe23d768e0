package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesView implements IInventoryView
   {
      ...
      public function BadgesView(param1:BadgesModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         this.var_706 = this._view.findChildByName("inactive_items") as IItemGridWindow;
         this.var_706.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onInactiveBadgeClick);
         this.var_1079 = this._view.findChildByName("active_items") as IItemGridWindow;
         this.var_1079.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onActiveBadgeClick);
      }
      ...
      private function updateListViews() : void
      {
         ...
         var _loc1_:Number = this.var_706.scrollV;
         this.var_706.removeGridItems();
         this.var_1079.removeGridItems();
         var _loc2_:Array = this.var_78.getBadges(BadgesModel.const_592);
         var _loc4_:int = 0;
         while(_loc4_ < _loc2_.length)
         {
            ...
            if(!_loc3_.isInUse)
            {
               this.var_706.addGridItem(_loc3_.window);
         ...
         while(_loc4_ < _loc5_.length)
         {
            ...
            this.var_1079.addGridItem(_loc3_.window);
      ...
      {
         var _loc2_:int = this.var_706.getGridItemIndex(param1.window);
      ...
      {
         var _loc2_:int = this.var_1079.getGridItemIndex(param1.window);
