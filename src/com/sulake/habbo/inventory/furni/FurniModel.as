package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel extends FurniModelCategory implements IInventoryModel
   {
      ...
      private static const const_1504:int = 100;
      
      private static const const_1505:int = 1000;
      ...
      private var var_1498:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_450 = [];
         this.var_449 = [];
         this.var_646 = new Timer(const_1504,1);
         this.var_646.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc9_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc10_:XmlAsset = XmlAsset(_loc9_);
         this.var_2488 = XML(_loc10_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               this.var_646.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_646.stop();
               this.var_646 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_36)
            {
               ...
               {
                  this.var_1498 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1498;
            }
            else
            {
         ...
         this.var_26.setInventoryCategoryInit(InventoryCategory.const_75);
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         if(this.var_807 == null)
         {
            this.var_807 = this._windowManager.buildFromXML(this.var_2488) as IWindowContainer;
            _loc12_ = this._assets.getAssetByName("thumb_selected_outline_png") as BitmapDataAsset;
            _loc13_ = this.var_807.findChildByName("outline") as IBitmapWrapperWindow;
            _loc13_.bitmap = _loc12_.content as BitmapData;
            _loc13_.disposesBitmap = false;
         }
         var _loc11_:IWindowContainer = this.var_807.clone() as IWindowContainer;
      ...
      {
         if(param1 == InventoryCategory.const_75 && this.var_26.isVisible)
         {
            switch(this._view.visibleCategoryId)
            {
               ...
               case const_44:
                  ...
                  break;
               case const_252:
                  this.var_26.toggleInventoryPage(InventoryCategory.const_137);
            }
         }
      }
      ...
      {
         this.var_26.checkCategoryInitilization(InventoryCategory.const_416);
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_647.add(const_36,new Array());
         this.var_647.add(const_44,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1, param4:Boolean = false) : void
      {
         ...
         if(param4)
         {
            if(this._view.visibleCategoryId == const_252)
            {
      ...
      {
         return getTimer() < this.var_2489 + const_1505;
      }
      ...
      {
         return this.var_26.getSubCategoryViewId() == InventorySubCategory.const_357;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_360 || _loc3_.category == FurniCategory.const_358 || _loc3_.category == FurniCategory.const_320)
         {
            if(param1)
            {
               return false;
      ...
      {
         return this.var_647.getValue(param1);
      }
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_357:
               this.cancelFurniInMover();
               if(this._view != null)
               {
                  this._view.updateActionView();
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         var _loc3_:Array = this.var_647.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            for each(_loc4_ in _loc3_)
            {
               _loc5_ = _loc4_.getTotalCount();
               if(_loc4_.category == FurniCategory.const_734)
               {
                  _loc5_ = 1;
               }
               _loc6_ = 0;
      ...
      public function getUnseenItemCount(param1:int = 0) : int
      {
         switch(param1)
         {
            case UnseenItemCategoryEnum.const_448:
               return this.var_450.length;
            case UnseenItemCategoryEnum.const_421:
               return this.var_449.length;
            default:
               return this.var_450.length + this.var_449.length;
         }
      }
      ...
      public function resetUnseenItems(param1:String = null) : void
      {
         ...
         switch(param1)
         {
            case const_44:
               ...
               {
                  _loc2_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_421));
                  this.var_449 = [];
            ...
            case const_36:
               ...
               {
                  _loc2_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_448));
                  this.var_450 = [];
                  _loc3_ = this.getCategoryContent(param1);
               }
         }
