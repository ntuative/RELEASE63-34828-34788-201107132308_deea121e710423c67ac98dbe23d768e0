package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1937:uint = 9;
      ...
      public static const const_347:uint = 3;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_1295 = false;
         this.var_1949 = param6;
         this.var_840 = true;
         this.state = const_205;
         this.var_59.setup(param1,param3,param4,param6);
         this.var_59.updateItemList(this.var_846);
         this.var_59.updateItemList(this.var_1589);
      ...
      public function close() : void
      {
         if(this.var_840)
         {
            if(this._state != const_213 && this._state != const_267)
            {
      ...
      {
         this.var_59.setMinimized(param1 != InventoryCategory.const_75);
         this.var_12.updateSubView();
      }
      
      public function set state(param1:uint) : void
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_845 + " OTHER: " + this.var_1295);
         ...
         {
            case const_213:
               if(param1 == const_205 || param1 == const_267)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_59.alertPopup(TradingView.const_1261);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_846)
            {
               this.var_845 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_846)
            {
               this.var_59.alertPopup(TradingView.const_1365);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_294.length < const_1937)
         {
