package com.sulake.habbo.localization
{
   ...
   public class HabboLocalizationManager extends CoreLocalizationManager implements IHabboLocalizationManager
   {
      ...
      public function HabboLocalizationManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_2546 = ["I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII","XIII","XIV","XV","XVI","XVII","XVIII","XIX","XX"];
         super(param1,param2,param3);
         this.var_1879 = (param2 & 0) > 0;
         if(!this.var_1879)
         {
            lock();
         }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            if(!this.var_1879)
            {
               if("false" == this.var_144.getKey("use.default.localizations","false"))
               {
                  _loc5_ = this.var_144.getKey("external.texts.txt","external_texts.txt");
                  events.addEventListener(LocalizationEvent.const_190,this.onLocalizationLoaded);
                  super.loadLocalizationFromURL(_loc5_);
               }
            }
            _loc4_ = 1;
            while(this.var_144.keyExists("localization." + _loc4_))
            {
               _loc6_ = this.var_144.getKey("localization." + _loc4_,"");
               _loc7_ = this.var_144.getKey("localization." + _loc4_ + ".name","");
               _loc8_ = this.var_144.getKey("localization." + _loc4_ + ".url","");
      ...
      public function onLocalizationLoaded(param1:Event) : void
      {
         ...
         if(this.var_144.keyExists("external.override.texts.txt"))
         {
            _loc2_ = this.var_144.getKey("external.override.texts.txt");
      ...
      {
         this.var_1878[param1] = param2;
      }
      
      private function getBadgePointLimit(param1:String) : int
      {
         return this.var_1878[param1];
      }
      ...
      {
         return this.var_2546[Math.max(0,param1 - 1)];
      }
