package com.sulake.habbo.messenger
{
   ...
   public class MessengerView implements IDisposable
   {
      ...
      private var var_1031:ConversationsTabView;
      
      private var var_970:ITextFieldWindow;
      
      private var var_16:IFrameWindow;
      
      private var var_1543:ConversationView;
      ...
      public function refresh() : void
      {
         ...
         this.var_1031.refresh();
         this.var_1543.refresh();
         if(this.var_154.conversations.openConversations.length < 1)
         {
            this.var_16.visible = false;
         }
      ...
      public function addMsgToView(param1:Conversation, param2:Message) : void
      {
         ...
         this.var_1543.addMessage(param2);
      }
      ...
      private function prepareContent() : void
      {
         ...
         this.var_1031 = new ConversationsTabView(this.var_154,this.var_16);
         this.var_1031.refresh();
         this.var_970 = ITextFieldWindow(this.var_16.findChildByName("message_input"));
         this.var_970.addEventListener(WindowKeyboardEvent.const_191,this.onMessageInput);
         this.var_1543 = new ConversationView(this.var_154,this.var_16);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1000,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1374,true);
         this.var_16.center();
      }
      ...
      private function onMessageInput(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc2_ = 120;
            _loc3_ = this.var_970.text;
            if(_loc3_.length > _loc2_)
            {
               this.var_970.text = _loc3_.substring(0,_loc2_);
            }
         }
      }
      ...
      private function sendMsg() : void
      {
         ...
         this.var_970.text = "";
         this.var_154.conversations.addMessageAndUpdateView(new Message(Message.const_741,_loc2_.id,_loc1_,Util.getFormattedNow()));
      }
      
      public function getTabCount() : int
      {
         return this.var_1031 == null ? 7 : int(this.var_1031.getTabCount());
      }
   }
}
