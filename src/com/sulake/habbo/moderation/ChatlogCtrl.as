package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1926:int = 1000;
      
      private static var var_1029:Array = [];
      
      private static var var_1925:int = 200;
      ...
      private var var_1927:IMessageComposer;
      ...
      {
         this.var_825 = IWindowContainer(this.var_36.getXmlWindow("chatlog_roomheader"));
         this.var_826 = IWindowContainer(this.var_36.getXmlWindow("chatlog_chatline"));
         this.var_553 = new Timer(1000,1);
         ...
         this.var_36.connection.send(this.var_1927);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = this.method_11();
      ...
      private function method_11() : IWindowContainer
      {
         if(false)
         {
            return var_1029.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_825.clone());
      }
      
      private function storeChatHeaderWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_1029.length < var_1925)
         {
            _loc2_ = ITextWindow(param1.findChildByName("room_name_txt"));
            _loc2_.procedure = null;
            param1.width = this.var_825.width;
            param1.height = this.var_825.height;
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_1928[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1541.getValue(param2.chatterName))
            {
               this.var_1541.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1541.getValue(_loc2_);
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1542)
         {
