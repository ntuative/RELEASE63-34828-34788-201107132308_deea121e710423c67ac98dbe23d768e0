package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2376:String = "my_issues";
      
      private const const_2377:String = "open_issues";
      
      private const include:String = "picked_issues";
      ...
      private var var_417:IIssueBrowserView;
      
      private var var_2147:IIssueBrowserView;
      
      private var var_2148:IIssueBrowserView;
      
      private var var_2146:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_417.view.width = this.var_307.container.width;
         this.var_417.view.height = this.var_307.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2376:
               ...
               {
                  this.var_2147 = new MyIssuesView(this.issueManager,this,this.var_307.container);
               }
               return this.var_2147;
            case this.const_2377:
               if(this.var_2148 == null)
               {
                  this.var_2148 = new OpenIssuesView(this.issueManager,this,this.var_307.container);
               }
               return this.var_2148;
            case this.include:
               if(this.var_2146 == null)
               {
                  this.var_2146 = new PickedIssuesView(this.issueManager,this,this.var_307.container);
               }
