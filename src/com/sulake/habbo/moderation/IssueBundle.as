package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_882:IssueMessageData = null;
      
      private var var_881:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2832 = param2.pickerUserId;
         this.var_2857 = param2.pickerUserName;
         this.var_1537 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         if(this.var_882 == null || param1.timeStamp < this.var_882.timeStamp)
         {
            this.var_882 = param1;
         }
         if(this.var_881 == null || param1.priority > this.var_881.timeStamp)
         {
            this.var_881 = param1;
         }
      }
      ...
      public function removeIssue(param1:int) : IssueMessageData
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(this.var_882 == _loc2_)
            {
               this.var_882 = null;
            }
            if(this.var_881 == _loc2_)
            {
               this.var_881 = null;
            }
         }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_881;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_882;
         if(_loc2_ == null)
         {
