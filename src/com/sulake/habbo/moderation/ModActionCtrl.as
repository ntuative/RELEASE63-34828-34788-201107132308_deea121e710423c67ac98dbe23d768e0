package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1377:IDropMenuWindow;
      ...
      private var var_1120:OffenceCategoryData;
      
      private var var_1119:OffenceData;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         this.var_1376 = IButtonWindow(this.var_36.getXmlWindow("modact_offence"));
         this.var_1378 = IButtonWindow(this.var_36.getXmlWindow("modact_offencectg"));
      }
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Mod action on: " + this.var_1909;
         ...
         this.var_1377 = IDropMenuWindow(this._frame.findChildByName("banLengthSelect"));
         this.prepareBanSelect(this.var_1377);
      ...
      public function refreshCategorization() : void
      {
         ...
         _loc1_.findChildByName("change_categorization_but").visible = this.var_1120 != null;
         if(this.var_1119 != null)
         {
            this._frame.findChildByName("offence_txt").caption = this.var_1119.name;
            this._frame.findChildByName("offence_category").visible = true;
         }
         else if(this.var_1120 != null)
         {
            this.refreshButtons("offences_cont",2,this.var_1120.offences,this.var_1376,this.onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,this.var_36.initMsg.offenceCategories,this.var_1378,this.onOffenceCtgButton);
      ...
      {
         return WindowTracker.const_1855;
      }
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.connection.send(new ModAlertMessageComposer(this.var_1670,this.var_586.text,this.var_1669));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_1120 = this.var_36.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         this.var_1119 = this.var_1120.offences[_loc3_];
         this.var_586.text = this.var_1119.msg;
         this.var_698 = false;
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.connection.send(new ModKickMessageComposer(this.var_1670,this.var_586.text,this.var_1669));
         this.dispose();
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1377.selection < 0)
         {
            this.var_36.windowManager.alert("Alert","You must select ban lenght",0,this.onAlertClose);
            return;
         }
         this.var_36.connection.send(new ModBanMessageComposer(this.var_1670,this.var_586.text,this.getBanLength(),this.var_1669));
         this.dispose();
      }
      ...
      {
         var _loc1_:int = this.var_1377.selection;
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_1376.destroy();
            this.var_1376 = null;
         }
         if(this.var_1378 != null)
         {
            this.var_1378.destroy();
            this.var_1378 = null;
         }
         this.var_1377 = null;
         this.var_586 = null;
