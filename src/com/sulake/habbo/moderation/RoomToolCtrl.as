package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_586:ITextFieldWindow;
      
      private var var_698:Boolean = true;
      
      private var var_1084:ICheckBoxWindow;
      
      private var var_1633:ICheckBoxWindow;
      
      private var var_1634:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_36.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_380));
         Logger.log("BEGINNING TO SHOW: " + this.var_380);
      }
      
      public function getType() : int
      {
         return WindowTracker.const_1863;
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + this.var_380);
         if(param1.flatId != this.var_380)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + this.var_380);
            return;
         }
         this._data = param1;
         this.populate();
      ...
      public function populate() : void
      {
         ...
         this.var_586 = ITextFieldWindow(this._frame.findChildByName("message_input"));
         this.var_586.procedure = this.onInputClick;
         this.var_1250 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1250);
         this.var_1250.procedure = this.onSelectTemplate;
         this.var_1084 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1633 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1634 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_36,WindowTracker.const_1023,this._data.flatId),this._frame,false,false,true);
      }
      ...
      {
         if(this.var_698 || this.var_586.text == "")
         {
            this.var_36.windowManager.alert("Alert","You must input a message to the user",0,this.onAlertClose);
            return;
         }
         var _loc2_:int = this.determineAction(param1,this.var_1084.isSelected);
         this.var_36.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1966,_loc2_,this.var_586.text,"",""));
         if(this.var_1633.isSelected || this.var_1634.isSelected || this.var_1084.isSelected)
         {
            this.var_36.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1633.isSelected,this.var_1634.isSelected,this.var_1084.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         ...
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1834);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_36.initMsg.roomMessageTemplates[this.var_1250.selection];
         if(_loc3_ != null)
         {
            this.var_698 = false;
            this.var_586.text = _loc3_;
         }
      }
   }
}
