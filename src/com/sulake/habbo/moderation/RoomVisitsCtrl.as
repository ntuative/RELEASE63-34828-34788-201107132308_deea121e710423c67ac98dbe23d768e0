package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1072:Array = [];
      
      private static var var_2049:int = 200;
      ...
      {
         this.var_869 = IWindowContainer(this.var_36.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_1919;
      }
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1072.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_869.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_1072.length < var_2049)
         {
            ...
            param1.width = this.var_869.width;
            param1.height = this.var_869.height;
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1615)
         {
