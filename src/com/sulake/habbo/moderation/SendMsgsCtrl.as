package com.sulake.habbo.moderation
{
   ...
   public class SendMsgsCtrl implements IDisposable, TrackedWindow
   {
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Msg To: " + this.var_1909;
      ...
      {
         return WindowTracker.const_1977;
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_36.initMsg.messageTemplates[this.var_1250.selection];
         if(_loc3_ != null)
         {
            this.var_698 = false;
      ...
      private function onSendMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.connection.send(new ModMessageMessageComposer(this.var_1670,this.var_586.text,this.var_1669));
         this.dispose();
      }
