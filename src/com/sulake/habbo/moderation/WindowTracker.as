package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_1977:int = 2;
      ...
      public static const const_1919:int = 6;
      
      public static const const_1855:int = 7;
      ...
      private var var_2102:Dictionary;
      
      public function WindowTracker()
      {
         this.var_2102 = new Dictionary();
         super();
      }
      ...
      {
         var _loc2_:Dictionary = this.var_2102[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            this.var_2102[param1] = _loc2_;
         }
         return _loc2_;
      }
   }
