package com.sulake.habbo.navigator
{
   ...
   public class AlertView implements IDisposable
   {
      ...
      private static var var_693:Dictionary = new Dictionary();
      ...
      public static function method_15(param1:IWindow) : AlertView
      {
         var _loc2_:* = null;
         if(var_693 != null)
         {
      ...
      {
         var _loc1_:AlertView = var_693[this.var_1151] as AlertView;
         if(_loc1_ != null)
         {
            _loc1_.dispose();
         }
