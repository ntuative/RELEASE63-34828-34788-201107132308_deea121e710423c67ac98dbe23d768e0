package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_328:MainViewCtrl;
      
      private var var_645:RoomInfoViewCtrl;
      
      private var var_1217:RoomCreateViewCtrl;
      
      private var _data:NavigatorData;
      
      private var var_496:Tabs;
      ...
      private var var_978:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_328 = new MainViewCtrl(this);
         this.var_645 = new RoomInfoViewCtrl(this);
         this.var_1217 = new RoomCreateViewCtrl(this);
         this.var_2482 = new RoomThumbnailRenderer(this);
         this.var_978 = new GuestRoomPasswordInput(this);
         this.var_331 = new GuestRoomDoorbell(this);
         this.var_496 = new Tabs(this);
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_49)
         {
            ...
            {
               this.var_328.onNavigatorToolBarIconClick();
            }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = this.var_144.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_328.startSearch(Tabs.const_253,Tabs.const_579,param1);
         this.trackNavigationDataPoint("Search","search.tag",param1);
         this.var_328.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_328.startSearch(Tabs.const_286,Tabs.const_272);
         this.var_496.getTab(Tabs.const_286).tabPageDecorator.tabSelected();
      }
