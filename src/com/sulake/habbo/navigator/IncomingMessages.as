package com.sulake.habbo.navigator
{
   ...
   public class IncomingMessages
   {
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.securityLevel >= SecurityLevelEnum.const_1285)
         {
            this._navigator.data.eventMod = true;
         }
         if(_loc2_.securityLevel >= SecurityLevelEnum.const_1908)
         {
      ...
      private function onRoomInfo(param1:IMessageEvent) : void
      {
         ...
         {
            if(_loc2_.data.doorMode == RoomSettingsData.const_224 && this._navigator.sessionData.userName != _loc2_.data.ownerName)
            {
      ...
      private function closeOpenCantConnectAlerts() : void
      {
         ...
         if(this._navigator != null)
         {
            ...
            if(_loc1_.length > 0)
            {
               ...
               {
                  _loc7_ = AlertView.method_15(_loc6_);
                  if(_loc7_ != null)
                  {
                     _loc7_.dispose();
                  }
