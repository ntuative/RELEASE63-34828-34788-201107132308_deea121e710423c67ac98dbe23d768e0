package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_60 == null)
         {
            this.var_60 = IWindowContainer(this._navigator.getXmlWindow(this.var_1151));
            this.var_60.visible = false;
            this.var_60.setParamFlag(HabboWindowParam.const_45,true);
         ...
         this.var_60.x = _loc2_.x + this.var_2342 + param1.width;
