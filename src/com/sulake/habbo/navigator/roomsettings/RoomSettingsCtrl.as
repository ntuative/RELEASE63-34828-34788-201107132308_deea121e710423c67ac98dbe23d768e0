package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_974:IDropMenuWindow;
      
      private var var_977:IDropMenuWindow;
      
      private var var_2415:IWindowContainer;
      ...
      {
         this.var_380 = param1;
         this._navigator.send(new GetRoomSettingsMessageComposer(this.var_380));
         if(this.var_1194 != null)
         {
            this.var_1194.visible = false;
         }
      }
      ...
      {
         if(param1 != this.var_380 || this.var_1192 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1192 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1775)
         {
         ...
         {
            this.var_1193.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1960)
         {
            this.setTagError(this.var_976,param3,"${navigator.roomsettings.unacceptablewords}");
            this.setTagError(this.var_975,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_2023)
         {
            this.setTagError(this.var_976,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            this.setTagError(this.var_975,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1879)
         {
            this.var_978.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_374,this.onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_606,this.onDoorModePasswordUnselect);
         ...
         this.var_1193 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_976 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_975 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_978 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1198 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1196 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1195 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1199 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         ...
         this.var_974 = IDropMenuWindow(this._window.findChildByName("wall_thickness"));
         this.var_977 = IDropMenuWindow(this._window.findChildByName("floor_thickness"));
         this.var_2415 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1197 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1191 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1793 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1482 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_246 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1194 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_1484 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1484.mouseThreshold = 0;
         this.var_1484.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1194.visible = false;
         if(!this.var_1483)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1793.visible = this.var_1483;
         this.populateForm();
         if(this.var_787)
         {
            this.var_1191.visible = true;
            this.var_1482.visible = true;
            this.refreshFlatControllers();
            this.var_1191.height = Util.getLowestPoint(this.var_1191) + 4;
         }
         else
         {
            this.var_1197.visible = true;
            this.var_1482.visible = true;
            this.var_2415.visible = this.var_1483;
            this.var_1197.height = Util.getLowestPoint(this.var_1197) + 4;
         }
         this.var_1484.text = !!this.var_787 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1197.name,this.var_1191.name,this.var_1482.name,this.var_1793.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_1193.setText(_loc1_.description);
         this.var_978.setText("");
         this.var_1198.setText("");
         ...
         {
            case RoomSettingsData.const_224:
         ...
         this.setTag(this.var_976,_loc1_.tags[0]);
         this.setTag(this.var_975,_loc1_.tags[1]);
         if(this.var_1196)
         {
            if(_loc1_.allowPets)
            {
         ...
         if(this.var_1195)
         {
            ...
            {
               this.var_1195.select();
            }
            else
            {
               this.var_1195.unselect();
            }
         }
         if(this.var_1199)
         {
            ...
            {
               this.var_1199.select();
            }
            else
            {
               this.var_1199.unselect();
            }
         }
         if(!this.VIPFeaturesAllowed())
         {
            this.disableWindow(this.var_785);
            this.disableWindow(this.var_974);
            this.disableWindow(this.var_977);
            this.disableWindow(this.var_1791);
         }
         else
         {
            this.enableWindow(this.var_785);
            this.enableWindow(this.var_974);
            this.enableWindow(this.var_977);
         ...
         if(this.var_974)
         {
            this.var_974.selection = this.getThicknessSelectionIndex(_loc1_.wallThickness);
         }
         if(this.var_977)
         {
            this.var_977.selection = this.getThicknessSelectionIndex(_loc1_.floorThickness);
         }
         this.clearErrors();
      }
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.description = this.var_1193.getText();
         var _loc3_:ISelectorWindow = this._window.findChildByName("doormode") as ISelectorWindow;
         var _loc4_:IWindow = _loc3_.getSelected();
         switch(_loc4_.name)
         {
            case "doormode_doorbell":
               _loc2_.doorMode = RoomSettingsFlatInfo.const_224;
               break;
            case "doormode_password":
               _loc2_.doorMode = RoomSettingsFlatInfo.const_133;
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_527;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_133)
         {
            _loc8_ = this.var_978.getText();
            _loc9_ = this.var_1198.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_978.clearErrors();
               this.var_1198.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowFoodConsume = this.var_1195.isSelected;
         _loc2_.allowWalkThrough = this.var_1199.isSelected;
         _loc2_.hideWalls = this.var_785.isSelected;
         _loc2_.wallThickness = this.var_974.selection - 2;
         _loc2_.floorThickness = this.var_977.selection - 2;
         _loc2_.tags = new Array();
         this.addTag(this.var_976,_loc2_.tags);
         this.addTag(this.var_975,_loc2_.tags);
         this.clearErrors();
         this.var_1192 = _loc2_.roomId;
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + this.var_380);
         if(this.var_56 == null)
         {
            return;
         }
         this._navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",this.var_56.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(this._navigator.getXmlWindow("ros_room_delete_confirm")),this,this.onConfirmRoomDelete,[this.var_380]);
         _loc2_.show();
      }
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_79,HabboWindowStyle.const_31,HabboWindowParam.const_64,new Rectangle(0,0,100,20)));
      }
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent) : void
      {
         ...
         this._navigator.send(new RemoveAllRightsMessageComposer(this.var_380));
      }
