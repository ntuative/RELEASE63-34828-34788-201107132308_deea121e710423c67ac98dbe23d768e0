package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1447:String = "pixelbalance";
      
      private static const const_1453:String = "badges";
      
      private static const const_1452:String = "selectbadge";
      
      private static const const_1449:String = "inventory";
      
      private static const const_1450:String = "selectfurni";
      
      private static const UILINK_CREDITS:String = "credits";
      
      private static const const_1451:String = "friendlist";
      
      private static const const_1454:String = "pet_inventory";
      
      private static const const_1448:String = "go_to_room";
      ...
      private var var_1764:IHabboToolbar;
      ...
      private var var_522:HabboNotificationViewManager;
      
      private var var_244:HabboAlertDialogManager;
      
      private var var_771:ParkBusDialogManager;
      
      private var var_2369:Boolean;
      
      private var var_959:ClubGiftNotification;
      
      private var var_958:ClubEndingNotification;
      ...
      private function addItem(param1:String, param2:String, param3:BitmapData, param4:String = null) : int
      {
         ...
         this.var_1168.push(_loc8_);
         return this.var_1168.length;
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = this.var_1168.splice(0,1);
      ...
      {
         this.var_1764 = param2 as IHabboToolbar;
      }
      ...
      {
         this.var_522 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this._config,this.var_1764,this.var_957["styles"],this.var_957["view"]);
         ...
         registerUpdateReceiver(this.var_522,1);
         registerUpdateReceiver(this,2);
         this.var_425.events.addEventListener(BadgeImageReadyEvent.const_209,this.onBadgeImage);
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_425.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_1382,null);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_1382,null);
            }
         }
      }
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1796,null);
         }
      }
      
      public function showGenericNotification(param1:String) : void
      {
         this.addItem(param1,NotificationType.const_946,null);
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         for each(_loc6_ in _loc4_.products)
         {
            if(_loc6_)
            {
               ...
               {
                  _loc7_ = this.var_425.getFloorItemData(_loc6_.furniClassId);
               }
               else if(_loc6_.productType == CatalogPageMessageProductData.const_63)
               {
                  _loc7_ = this.var_425.getWallItemData(_loc6_.furniClassId);
               }
               ...
               {
                  _loc9_ = this.var_425.getProductData(_loc4_.localizationId);
                  if(_loc9_)
                  {
               ...
               if(_loc8_)
               {
                  this.addItem(_loc8_.value,NotificationType.const_1878,_loc5_);
               }
            }
         }
      ...
      private function getProductImage(param1:String, param2:int, param3:String) : BitmapData
      {
         ...
         switch(param1)
         {
            ...
            case CatalogPageMessageProductData.const_63:
               ...
               break;
            case CatalogPageMessageProductData.const_187:
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_1379)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1932,null);
         }
      ...
      private function checkClubEndingNotification(param1:ScrSendUserInfoMessageParser) : void
      {
         ...
         if(_loc2_ > 0 && param1.daysToPeriodEnd > 0 && param1.daysToPeriodEnd <= _loc2_ && param1.periodsSubscribedAhead == 0)
         {
            ...
            this.var_958 = new ClubEndingNotification(param1.daysToPeriodEnd,param1.isVIP,assets,this._windowManager,this._catalog,this._localization);
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_522.isSpaceAvailable() && this.var_1168.length > 0)
         {
            _loc2_ = this.getNextItemFromQueue();
            if(!this.var_522.showItem(_loc2_))
            {
               _loc2_.dispose();
            }
         }
      ...
      {
         if(param1 != null && this.var_522 != null)
         {
            this.var_522.replaceIcon(param1);
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_771 == null)
         {
            this.var_771 = new ParkBusDialogManager(this._windowManager,assets,this._localization);
         }
         if(_loc2_ != null || this.var_771 != null)
         {
            this.var_771.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2369)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_946,null);
            this.var_2369 = true;
      ...
      {
         if(param2.type == WindowEvent.const_142 || param2.type == WindowEvent.const_657)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         if(this.var_959 && this.var_959.visible)
         {
            return;
         }
         this.var_959 = new ClubGiftNotification(_loc2_.numGifts,assets,this._windowManager,this._catalog,this.var_1764);
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_946,_loc6_);
      }
   }
}
