package com.sulake.habbo.quest
{
   ...
   public class AchievementController implements IDisposable, IUpdateReceiver
   {
      ...
      private static const const_1707:int = 8;
      
      private static const const_1701:int = 5;
      
      private static const const_1704:int = 6;
      
      private static const const_1700:int = 3;
      
      private static const const_1708:int = 2;
      
      private static const const_1158:int = 6;
      
      private static const const_1705:int = 180;
      
      private static const const_1702:int = 246;
      
      private static const const_1513:int = 45;
      
      private static const const_1699:Point = new Point(115,93);
      
      private static const const_1698:Point = new Point(72,1);
      
      private static const const_1157:int = 40;
      
      private static const const_1703:int = 20;
      ...
      private var var_727:ProgressBar;
      
      private var var_905:ProgressBar;
      
      private var var_1386:Matrix;
      
      private var var_2152:ColorMatrixFilter;
      
      private var var_1677:AchievementData;
      
      private var var_904:Timer;
      
      private var var_728:Dictionary;
      
      private var var_903:AchievementLevelUp;
      ...
      public function AchievementController(param1:HabboQuestEngine)
      {
         ...
         super();
         this.var_49 = param1;
         this.var_588 = new Timer(100,1);
         this.var_588.addEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
         this.var_904 = new Timer(2000,1);
         this.var_904.addEventListener(TimerEvent.TIMER,this.switchIntoPendingLevel);
         this.var_903 = new AchievementLevelUp(this.var_49);
         this.var_1386 = new Matrix();
         this.var_2152 = this.createGrayscaleFilter();
         this.var_728[16] = 1;
         this.var_728[28] = 6;
         this.var_728[38] = 4;
         this.var_728[39] = 3;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_588)
         {
            this.var_588.removeEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
            this.var_588.reset();
            this.var_588 = null;
         }
         if(this.var_904)
         {
            this.var_904.removeEventListener(TimerEvent.TIMER,this.switchIntoPendingLevel);
            this.var_904.reset();
            this.var_904 = null;
         }
         if(this.var_727)
      ...
      private function refresh() : void
      {
         ...
         this._window.height = getLowestPoint(this._window.content) + const_1513;
      }
      ...
      private function refreshCategoryList() : void
      {
         ...
         this.var_498.height = getLowestPoint(this.var_498);
      }
      ...
      private function refreshCategoryListFooter() : void
      {
         ...
         this.var_905.refresh(this.var_118.getProgress(),this.var_118.getMaxProgress(),0);
      }
      ...
      private function refreshAchievementList() : void
      {
         ...
         this.var_907.height = getLowestPoint(this.var_907);
      }
      ...
      private function refreshAchievementsHeader() : void
      {
         if(this._category == null)
         {
            this.var_1126.visible = false;
            return;
         }
         this.var_1126.visible = true;
         this.var_1126.findChildByName("category_name_txt").caption = this.var_49.getAchievementCategoryName(this._category.code);
         ...
         this.var_49.setupAchievementCategoryImage(this.var_1126,this._category,false);
      }
      ...
      private function refreshAchievementsFooter() : void
      {
         if(this._category == null)
         {
            this.var_1678.visible = false;
            return;
         }
         this.var_1678.visible = true;
      }
      ...
      private function refreshAchievementDetails() : void
      {
         ...
         this.var_499.findChildByName("achievement_name_txt").caption = this.var_49.localization.getBadgeName(_loc1_);
         var _loc2_:String = this.var_49.localization.getBadgeDesc(_loc1_);
         this.var_499.findChildByName("achievement_desc_txt").caption = _loc2_ == null ? "" : _loc2_;
         this.var_49.localization.registerParameter("achievements.details.level","level","" + (!!this.var_75.finalLevel ? this.var_75.level : this.var_75.level - 1));
         this.var_49.localization.registerParameter("achievements.details.level","limit","" + this.var_75.levelCount);
         this.var_49.refreshReward(!this.var_75.finalLevel,this.var_499,this.var_75.levelRewardPointType,this.var_75.levelRewardPoints);
         this.refreshBadgeImageLarge(this.var_499,this.var_75);
         this.var_727.refresh(this.var_75.currentPoints,this.var_75.scoreLimit,this.var_75.type * 10000 + this.var_75.level);
         this.var_727.visible = !this.var_75.finalLevel;
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this._window.center();
         this._window.y = const_1703;
         this.var_498 = IWindowContainer(this._window.findChildByName("categories_cont"));
         this.var_1126 = IWindowContainer(this._window.findChildByName("achievements_header_cont"));
         this.var_907 = IWindowContainer(this._window.findChildByName("achievements_cont"));
         this.var_499 = IWindowContainer(this._window.findChildByName("achievement_cont"));
         this.var_1678 = IWindowContainer(this._window.findChildByName("achievements_footer_cont"));
         this.var_1385 = IWindowContainer(this._window.findChildByName("categories_footer_cont"));
         this.var_727 = new ProgressBar(this.var_49,this.var_499,const_1705,"achievements.details.progress",true,const_1699);
         this.var_905 = new ProgressBar(this.var_49,this.var_1385,const_1702,"achievements.categories.totalprogress",true,const_1698);
      }
      
      private function refreshCategoryEntry(param1:int, param2:AchievementCategory) : Boolean
      {
         var _loc3_:IWindowContainer = IWindowContainer(this.var_498.getChildByName("" + param1));
         var _loc4_:int = Math.floor(param1 / const_727);
         var _loc5_:* = _loc4_ < const_1700;
         if(_loc3_ == null)
         {
            ...
            _loc3_.x = (_loc3_.width + const_1707) * (param1 % const_727);
            _loc3_.y = (_loc3_.height + const_1701) * Math.floor(param1 / const_727) + const_1704;
         }
      ...
      {
         var _loc9_:* = null;
         var _loc3_:IWindowContainer = IWindowContainer(this.var_907.getChildByName("" + param1));
         var _loc4_:int = Math.floor(param1 / const_1158);
         var _loc5_:* = _loc4_ < const_1708;
         if(_loc3_ == null)
         {
            if(param2 == null && !_loc5_)
            {
            ...
            _loc3_.x = _loc3_.width * (param1 % const_1158);
            _loc3_.y = _loc3_.height * _loc4_ + const_1709;
      ...
      private function refreshMouseOver(param1:int) : void
      {
         ...
         var _loc5_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_498.numChildren)
         {
            _loc3_ = _loc2_ == param1;
            _loc4_ = IWindowContainer(this.var_498.getChildAt(_loc2_));
      ...
      private function onSelectAchievement(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.refresh();
         this.var_49.send(new EventLogMessageComposer("Achievements","" + this.var_75.type,"Achievement selected"));
      }
      ...
      private function refreshBadgeImage(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         var _loc5_:BitmapData = this.var_906[_loc4_];
         ...
         if(_loc5_ == null)
         {
            ...
            this.var_906[_loc4_] = _loc5_;
         }
         var _loc7_:int = const_1157 - _loc5_.height + this.getPositionFix(param2.type);
         var _loc8_:Point = new Point((_loc3_.width - _loc5_.width) / 2,!!_loc6_ ? Number(const_1706) : Number(_loc7_));
         ...
         {
            _loc3_.bitmap.applyFilter(_loc5_,_loc5_.rect,_loc8_,this.var_2152);
         }
         _loc3_.visible = false;
         _loc3_.visible = true;
      }
      ...
      private function refreshBadgeImageLarge(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         var _loc6_:int = 2 * (const_1157 - _loc5_.height + this.getPositionFix(param2.type));
         this.var_1386.identity();
         this.var_1386.scale(2,2);
         this.var_1386.translate((_loc3_.width - _loc5_.width * 2) / 2,_loc6_);
         _loc3_.bitmap.fillRect(_loc3_.bitmap.rect,16777215);
         _loc3_.bitmap.draw(_loc5_,this.var_1386);
         if(!param2.firstLevelAchieved)
         {
            _loc3_.bitmap.applyFilter(_loc3_.bitmap,_loc3_.bitmap.rect,new Point(0,0),this.var_2152);
         }
         _loc3_.visible = false;
         _loc3_.visible = true;
      }
      ...
      {
         this.var_75 = this.var_1677;
         this.var_118.update(this.var_1677);
         this.var_1677 = null;
         this.refresh();
      }
      ...
      public function onBadgeImageReady(param1:BadgeImageReadyEvent) : void
      {
         ...
         this.var_906[param1.badgeId] = param1.badgeImage;
         if(!this.var_588.running)
         {
            this.var_588.start();
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            this.var_727.updateView();
         }
         if(this.var_905 != null)
         {
            this.var_905.updateView();
         }
         if(this.var_903 != null)
         {
            this.var_903.update(param1);
         }
      }
      ...
      {
         return !!this.var_728[param1] ? int(this.var_728[param1]) : 0;
      }
