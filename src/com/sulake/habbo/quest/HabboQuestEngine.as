package com.sulake.habbo.quest
{
   ...
   public class HabboQuestEngine extends Component implements IHabboQuestEngine, IUpdateReceiver
   {
      ...
      private static const const_1659:int = 5;
      
      private static const const_1660:int = 800;
      
      private static const const_1662:int = 15;
      
      private static const const_1661:int = 300;
      ...
      private var var_1341:QuestController;
      
      private var var_1089:AchievementController;
      ...
      public function HabboQuestEngine(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1341 = new QuestController(this);
         this.var_1089 = new AchievementController(this);
         ...
         registerUpdateReceiver(this,const_1659);
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_425.events.removeEventListener(BadgeImageReadyEvent.const_209,this.var_1089.onBadgeImageReady);
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_425.events.addEventListener(BadgeImageReadyEvent.const_209,this.var_1089.onBadgeImageReady);
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_49)
         {
            ...
            {
               this.var_1341.onToolbarClick();
            }
            if(param1.iconId == HabboToolbarIconEnum.ACHIEVEMENTS)
            {
               this.var_1089.onToolbarClick();
            }
         }
      }
      ...
      {
         return this.var_1341.questTracker.isVisible();
      }
