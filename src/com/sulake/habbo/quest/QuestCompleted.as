package com.sulake.habbo.quest
{
   ...
   public class QuestCompleted implements IDisposable
   {
      ...
      private static const const_1481:int = 31;
      ...
      public function prepare(param1:QuestMessageData) : void
      {
         ...
         this._window.findChildByName("catalog_link_txt").caption = this.var_49.localization.getKey("quests.completed.cataloglink." + this.var_130.activityPointType);
         var _loc2_:String = "quests.completed.reward." + this.var_130.activityPointType;
         this.var_49.localization.registerParameter(_loc2_,"amount",this.var_130.method_8.toString());
         this._window.findChildByName("reward_txt").caption = this.var_49.localization.getKey(_loc2_,_loc2_);
         this._window.visible = false;
         this._window.findChildByName("congrats_txt").caption = this.var_49.localization.getKey(!!this.var_130.lastQuestInCampaign ? "quests.completed.campaign.caption" : "quests.completed.quest.caption");
         ...
         this.var_49.setupCampaignImage(this._window,param1,this.var_130.lastQuestInCampaign);
         ...
         _loc3_.height = Math.max(const_1481,_loc3_.textHeight + const_1482);
      ...
      {
         this.var_49.localization.registerParameter(param1,"category",this.var_49.getCampaignName(this.var_130));
