package com.sulake.habbo.quest
{
   ...
   public class QuestDetails implements IDisposable
   {
      ...
      private static const const_1513:int = 56;
      
      private static const const_485:int = 5;
      
      private static const const_1482:int = 5;
      
      private static const const_1072:Point = new Point(8,8);
      
      private static const const_1514:Array = ["PLACE_ITEM","PLACE_FLOOR","PLACE_WALLPAPER","PET_DRINK","PET_EAT"];
      ...
      private function openDetails(param1:QuestMessageData) : void
      {
         ...
         if(this._window == null)
         {
            ...
            _loc8_.x = const_1072.x;
            _loc8_.y = const_1072.y;
         ...
         if(!_loc2_)
         {
            ...
            _loc3_.height = _loc3_.textHeight + const_1482;
         }
         _loc3_.visible = !_loc2_;
         var _loc5_:int = this.getTextHeight(_loc3_) - _loc4_;
         var _loc6_:int = this.setupLink("link_region",_loc3_.y + _loc3_.height + const_485);
         ...
         this._window.height = _loc8_.height + const_1513;
      ...
      private function setupLink(param1:String, param2:int) : int
      {
         ...
         {
            _loc7_ = const_485 + _loc6_.height;
         }
         if(!_loc5_ && _loc6_.visible)
         {
            _loc7_ = -const_485 - _loc6_.height;
      ...
      {
         return this.var_130.waitPeriodSeconds < 1 && const_1514.indexOf(this.var_130.type) > -1;
      }
      
      private function hasNavigatorLink() : Boolean
      {
         var _loc1_:Boolean = this.var_49.localization.hasKey(this.var_130.getCampaignLocalizationKey() + ".searchtag");
         var _loc2_:Boolean = this.var_49.localization.hasKey(this.var_130.getCampaignLocalizationKey() + ".searchtag");
      ...
      private function onLinkProc(param1:WindowEvent, param2:IWindow = null) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this.var_49.openCatalog(this.var_130);
            }
            else if(this.hasNavigatorLink())
            {
               this.var_49.openNavigator(this.var_130);
            }
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         this.var_1517 = NextQuestTimer.const_983;
         var _loc2_:Boolean = this.var_49.questController.questsList.refreshDelay(this._window,this.var_130);
         if(_loc2_)
         {
