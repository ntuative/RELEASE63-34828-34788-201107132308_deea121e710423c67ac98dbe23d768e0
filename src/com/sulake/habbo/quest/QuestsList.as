package com.sulake.habbo.quest
{
   ...
   public class QuestsList implements IDisposable
   {
      ...
      private static const const_1629:int = 30;
      ...
      public function onToolbarClick() : void
      {
         ...
         {
            this.var_875 = new WindowToggle(this._window,this._window.desktop,this.requestQuests,this.close);
         }
         this.var_875.toggle();
         this.var_2066 = false;
      }
      ...
      private function refresh(param1:Boolean) : void
      {
         ...
         while(true)
         {
            if(_loc2_ < this.var_1623.length)
            {
               this.refreshEntry(true,_loc2_,this.var_1623[_loc2_],param1);
            }
            else
            {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_611 = IScrollbarWindow(this._window.findChildByName("scroller"));
         this._window.center();
         this.var_62.spacing = const_1631;
      }
      ...
      public function createListEntry() : IWindowContainer
      {
         ...
         _loc6_.x = _loc3_.width - _loc6_.width - const_1630;
         ...
         _loc3_.x = _loc2_.x + _loc2_.width + const_1628;
      ...
      public function setEntryHeight(param1:IWindowContainer) : void
      {
         ...
         _loc2_.findChildByName("completion_txt").y = _loc2_.height - const_1629;
      ...
      private function refreshEntryQuestDetails(param1:IWindowContainer, param2:QuestMessageData) : void
      {
         ...
         this.var_49.refreshReward(param2.waitPeriodSeconds < 1,param1,param2.activityPointType,param2.method_8);
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(_loc3_ && this.var_2066 && !this.var_2065)
            {
               this.var_2066 = false;
