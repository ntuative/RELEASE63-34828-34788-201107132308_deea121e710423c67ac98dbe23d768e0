package com.sulake.habbo.room
{
   ...
   public class RoomObjectFactory extends Component implements IRoomObjectFactory
   {
      ...
      {
         var _loc2_:* = null;
         if(this.var_1087.indexOf(param1) < 0)
         {
            this.var_1087.push(param1);
            if(param1 != null)
            {
               for each(_loc2_ in this.var_1339.getKeys())
               {
      ...
      {
         var _loc2_:* = null;
         var _loc3_:int = this.var_1087.indexOf(param1);
         if(_loc3_ >= 0)
         {
            this.var_1087.splice(_loc3_,1);
            if(param1 != null)
            {
               for each(_loc2_ in this.var_1339.getKeys())
               {
      ...
      {
         var _loc2_:* = null;
         if(this.var_1339.getValue(param1) == null)
         {
            this.var_1339.add(param1,true);
      ...
      public function createRoomObjectLogic(param1:String) : IRoomObjectEventHandler
      {
         ...
         switch(param1)
         {
            ...
            case RoomObjectLogicEnum.const_1881:
               ...
               break;
            case RoomObjectLogicEnum.const_1820:
            ...
            case RoomObjectLogicEnum.const_1793:
               ...
               break;
            case RoomObjectLogicEnum.const_2035:
               _loc2_ = FurnitureSoundMachineLogic;
               break;
            case RoomObjectLogicEnum.const_2022:
         ...
         if(_loc3_ is IRoomObjectEventHandler)
         {
            ...
            if(this.var_2089.getValue(param1) == null)
            {
               this.var_2089.add(param1,true);
