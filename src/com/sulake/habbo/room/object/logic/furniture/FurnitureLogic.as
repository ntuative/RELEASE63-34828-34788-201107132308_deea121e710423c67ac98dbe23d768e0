package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureLogic extends MovingObjectLogic
   {
      ...
      private static const const_1159:Number = 0.0625;
      ...
      private var var_1388:RoomObjectUpdateMessage;
      ...
      {
         var _loc1_:Array = [RoomObjectRoomAdEvent.const_345,RoomObjectRoomAdEvent.const_346,RoomObjectRoomAdEvent.const_656,RoomObjectStateChangeEvent.const_68,RoomObjectMouseEvent.const_157,RoomObjectRoomAdEvent.const_226,RoomObjectMouseEvent.const_597];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc3_.length() == 1)
         {
            this.var_1679 = Number(_loc3_);
         }
         this.var_2529 = this.var_543 / 2;
         this.var_2528 = this.var_643 / 2;
         _loc3_ = _loc2_.@centerZ;
         if(_loc3_.length() == 1)
         {
            this.var_2157 = Number(_loc3_);
         }
         else
         {
            this.var_2157 = this.var_1679 / 2;
         }
         ...
         object.getModelController().setNumber(RoomObjectVariableEnum.const_270,this.var_543,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_353,this.var_643,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_663,this.var_1679,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_1938,this.var_2529,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_1928,this.var_2528,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_758,this.var_2157,true);
         object.getModelController().setNumberArray(RoomObjectVariableEnum.const_1003,this.var_270,true);
      ...
      override public function useObject() : void
      {
         ...
         if(object != null)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               {
                  eventDispatcher.dispatchEvent(new RoomObjectRoomAdEvent(RoomObjectRoomAdEvent.const_656,_loc1_,_loc2_));
               }
            }
            if(eventDispatcher != null)
            {
      ...
      private function handleDataUpdateMessage(param1:RoomObjectDataUpdateMessage) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               _loc2_.setString(RoomObjectVariableEnum.const_381,String(param1.extra));
            }
            _loc2_.setNumber(RoomObjectVariableEnum.const_996,lastUpdateTime);
         }
      }
      ...
      private function handleItemDataUpdateMessage(param1:RoomObjectItemDataUpdateMessage) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1251,param1.itemData);
         }
      }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(param1.dir != null && param1.loc != null)
         {
            if(!(param1 is RoomObjectMoveUpdateMessage))
            {
               ...
               if(_loc4_ != null && _loc4_.x != param1.dir.x && this.var_2156 && _loc5_ != null && _loc5_.x == param1.loc.x && _loc5_.y == param1.loc.y && _loc5_.z == param1.loc.z)
               {
                  this.var_418 = 1;
                  this.var_1388 = new RoomObjectUpdateMessage(param1.loc,param1.dir);
                  param1 = null;
               }
            }
            this.var_2156 = true;
      ...
      override protected function getLocationOffset() : IVector3d
      {
         if(this.var_418 > 0)
         {
            this.var_1127.x = 0;
            this.var_1127.y = 0;
            if(this.var_418 <= const_488 / 2)
            {
               this.var_1127.z = const_1159 * this.var_418;
            }
            else if(this.var_418 <= const_488)
            {
               if(this.var_1388)
               {
                  super.processUpdateMessage(this.var_1388);
                  this.var_1388 = null;
               }
               this.var_1127.z = const_1159 * (const_488 - this.var_418);
            }
