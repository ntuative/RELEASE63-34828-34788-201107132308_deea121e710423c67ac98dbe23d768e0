package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureScoreBoardLogic extends FurnitureLogic
   {
      ...
      private static const const_471:int = 50;
      
      private static const const_1134:int = 3000;
      ...
      private function updateScore(param1:int) : void
      {
         ...
         if(this.var_887 != _loc2_)
         {
            ...
            if(_loc3_ * const_471 > const_1134)
            {
               this.var_1040 = const_1134 / _loc3_;
            }
            else
            {
               this.var_1040 = const_471;
            }
      ...
      override public function update(param1:int) : void
      {
         ...
         if(object != null)
         {
            ...
            if(_loc2_ != this.var_887 && param1 >= this.var_1646 + this.var_1040)
            {
               _loc3_ = param1 - this.var_1646;
               ...
               this.var_1646 = param1 - (_loc3_ - _loc4_ * this.var_1040);
            }
         }
      }
   }
