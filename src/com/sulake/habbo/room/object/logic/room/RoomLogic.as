package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1505:uint = 16777215;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_671,RoomObjectMouseEvent.const_157];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_791,param1.toString());
            _loc2_.setNumber(RoomObjectVariableEnum.const_943,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_817,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_1031,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_882,1);
         }
      }
         ...
         if(this.var_1504)
         {
            if(object != null)
            {
               ...
               if(_loc2_ != null)
               {
                  ...
                  _loc2_.setString(RoomObjectVariableEnum.const_791,_loc3_.toString());
                  _loc2_.setNumber(RoomObjectVariableEnum.const_1341,param1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1231)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1859;
            if(_loc2_ - this.var_1231 >= this.var_1858)
            {
               _loc3_ = this.var_1230;
               _loc4_ = this.var_1856;
               this.var_1231 = 0;
            }
            else
            {
               _loc7_ = this.var_1505 >> 16 & 255;
               _loc8_ = this.var_1505 >> 8 & 255;
               _loc9_ = this.var_1505 & 255;
               _loc10_ = this.var_1230 >> 16 & 255;
               _loc11_ = this.var_1230 >> 8 & 255;
               _loc12_ = this.var_1230 & 255;
               _loc13_ = (_loc2_ - this.var_1231) / this.var_1858;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1857 + (this.var_1856 - this.var_1857) * _loc13_;
               this._color = _loc3_;
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_943,_loc3_);
         }
      }
      ...
      private function updatePlaneTypes(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_975:
            ...
            case RoomObjectRoomUpdateMessage.const_942:
               ...
               break;
            case RoomObjectRoomUpdateMessage.const_1004:
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_667:
               ...
               this.var_546.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_874:
               _loc4_ = this.var_546.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_546.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1402,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1338:
               param2.setNumber(RoomObjectVariableEnum.const_817,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1315:
               param2.setNumber(RoomObjectVariableEnum.const_1031,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_882,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomPlanePropertyUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomPlanePropertyUpdateMessage.const_713:
               param2.setNumber(RoomObjectVariableEnum.const_1196,param1.value);
               break;
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1233:
               param2.setNumber(RoomObjectVariableEnum.const_1224,param1.value);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1319,int(param1.bgOnly));
         this.var_1505 = this._color;
         this.var_1857 = this.var_1859;
         this.var_1230 = _loc3_;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1964,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1993,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1774,_loc21_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_292 || _loc12_ == RoomPlaneData.const_427)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
