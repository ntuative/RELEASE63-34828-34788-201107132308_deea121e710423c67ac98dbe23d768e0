package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class AnimatedFurnitureVisualization extends FurnitureVisualization
   {
      ...
      private var var_131:AnimationStateData;
      ...
      {
         super();
         this.var_131 = new AnimationStateData();
      }
      ...
      {
         return this.var_131.animationId;
      }
      
      protected function getAnimationId(param1:AnimationStateData) : int
      {
         var _loc2_:int = this.animationId;
         if(_loc2_ != const_1172 && this._animationData.hasAnimation(this.var_451,_loc2_))
         {
            return _loc2_;
         }
         return const_1172;
      ...
      override protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(super.updateObject(param1,param2))
         {
            ...
            if(_loc4_ != this._state)
            {
               ...
               if(_loc5_ != null)
               {
                  _loc6_ = _loc5_.getNumber(RoomObjectVariableEnum.const_996);
         ...
         if(super.updateModel(param1))
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc5_ = _loc3_.getNumber(RoomObjectVariableEnum.const_996);
                  ...
                  _loc4_ = _loc3_.getNumber(RoomObjectVariableEnum.const_944);
                  if(!isNaN(_loc4_))
                  {
                     _loc6_ = this._animationData.getAnimationId(this.var_451,_loc4_);
      ...
      protected function setAnimation(param1:int) : void
      {
         ...
         {
            this.setSubAnimation(this.var_131,param1,this._state >= 0);
         }
      }
      ...
      protected function setSubAnimation(param1:AnimationStateData, param2:int, param3:Boolean = true) : Boolean
      {
         ...
         if(param3)
         {
            ...
            if(param2 != _loc5_)
            {
               if(!this._animationData.isImmediateChange(this.var_451,param2,_loc5_))
               {
                  _loc6_ = AnimationData.getTransitionFromAnimationId(_loc5_);
                  if(this._animationData.hasAnimation(this.var_451,_loc6_))
                  {
      ...
      {
         return this.var_131.getLastFramePlayed(param1);
      }
      ...
      protected function resetAllAnimationFrames() : void
      {
         if(this.var_131 != null)
         {
            this.var_131.setLayerCount(this.var_667);
         }
      }
      ...
      {
         var _loc2_:int = 0;
         if(!this.var_131.animationOver || this.var_1009)
         {
            _loc2_ = this.updateFramesForAnimation(this.var_131,param1);
            if(this.var_131.animationOver)
            {
               if(AnimationData.isTransitionFromAnimation(this.var_131.animationId) || AnimationData.isTransitionToAnimation(this.var_131.animationId))
               {
                  this.setAnimation(this.var_131.animationAfterTransitionId);
                  this.var_131.animationOver = false;
               }
            }
         }
         return _loc2_;
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(!_loc9_ || this.var_1009)
            {
               ...
               if(this.var_1009 || _loc11_ == null || _loc11_.remainingFrameRepeats >= 0 && _loc13_ <= 0)
               {
                  ...
                  if(_loc12_ == AnimationFrame.const_1195)
                  {
               ...
               if(_loc11_ == null || _loc11_.remainingFrameRepeats == AnimationFrame.const_537)
               {
                  _loc10_ = true;
                  _loc9_ = true;
               }
      ...
      {
         var _loc3_:AnimationFrame = this.var_131.getFrame(param2);
         if(_loc3_ != null)
         {
            return _loc3_.id;
         }
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         var _loc5_:AnimationFrame = this.var_131.getFrame(param3);
         if(_loc5_ != null)
         {
            _loc4_ += _loc5_.x;
         }
