package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystem
   {
      ...
      private var var_1234:Number = 1.0;
      
      private var var_652:BitmapData;
      
      private var var_812:ColorTransform;
      ...
      public function FurnitureParticleSystem(param1:AnimatedFurnitureVisualization)
      {
         ...
         this.var_812 = new ColorTransform();
         this.var_812.alphaMultiplier = 1;
      ...
      public function setAnimation(param1:int) : void
      {
         ...
         this.var_110 = this.var_1233[param1];
         this.var_1001 = false;
         this.updateCanvas();
      }
      ...
      private function updateCanvas() : void
      {
         ...
         if(this.var_1867 >= 0)
         {
            this.var_280 = this._visualization.getSprite(this.var_1867);
            if(this.var_280 && this.var_280.asset)
            {
               ...
               if(this.var_99 == null)
               {
                  ...
                  if(this.var_812.alphaMultiplier != 1)
                  {
                     this.var_652 = new BitmapData(this.var_99.width,this.var_99.height,true,4278190080);
                  }
               }
               this.var_2529 = -this.var_280.offsetX;
               this.var_2528 = -this.var_280.offsetY;
            ...
            if(this.var_652)
            {
               this.var_652.fillRect(this.var_652.rect,4278190080);
            }
         }
      }
      ...
      public function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         {
            return this.var_110.y * this.var_1234;
         }
         return 0;
      }
      ...
      public function updateAnimation() : void
      {
         ...
         var _loc2_:* = 0;
         var _loc8_:int = 0;
         if(!this.var_1001 && this.var_110.hasIgnited)
         {
            this.var_1001 = true;
         }
         _loc8_ = this.var_1190 * this.var_1234;
         this.var_110.update();
         if(this.var_1001)
         {
            if(this.var_110.roomObjectSpriteId >= 0)
            ...
            {
               this.var_99.draw(this.var_652,this.var_1866,this.var_812,BlendMode.NORMAL,null,false);
            }
            for each(_loc11_ in this.var_110.particles)
            {
               _loc2_ = Number(_loc11_.y);
               _loc3_ = this.var_2529 + (_loc11_.x - _loc11_.z) * 10 / 10 * this.var_1234;
               _loc4_ = this.var_2528 - _loc8_ + (_loc2_ + (_loc11_.x + _loc11_.z) / 2) * 10 / 10 * this.var_1234;
               ...
               if(_loc6_)
               {
                  ...
                  if(_loc11_.fade && _loc11_.alphaMultiplier < 1)
                  {
                     ...
                     this.var_99.draw(_loc7_,this._translationMatrix,this.var_1510,BlendMode.NORMAL,null,false);
                  }
                  else
                  {
