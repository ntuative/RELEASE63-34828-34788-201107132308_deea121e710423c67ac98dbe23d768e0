package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1929:String = "cone";
      
      public static const const_1795:String = "plane";
      
      public static const const_1780:String = "sphere";
      ...
      private var var_948:Number = 0.1;
      ...
      public function reset() : void
      {
         ...
         this.var_947 = 0;
         this.var_1001 = false;
         this.init(0,0,0,this._direction,this.var_2318,this.var_948,this.var_2316,true);
      }
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.var_2317)
         {
            switch(this.var_2319)
            {
               case const_1929:
            ...
            _loc4_.init(param1.x,param1.y,param1.z,_loc3_,this._energy,this.var_948,_loc6_,_loc7_,_loc9_,_loc8_);
      ...
      {
         var _loc1_:int = Math.floor(Math.random() * this.var_1166.length);
         return this.var_1166[_loc1_];
      }
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_947 < this.var_1446)
         {
            if(this.age % this.var_2321 == 0)
            {
               this.releaseParticles(this,this.direction);
            }
         }
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_947 < this.var_1446)
         {
            ...
            _loc4_ = this.y;
            _loc5_ = this.z;
            this.x = (2 - this.var_273) * this.x - (1 - this.var_273) * this.lastX;
            this.y = (2 - this.var_273) * this.y - (1 - this.var_273) * this.lastY + this.var_1750 * this.var_948 * this.var_948;
            this.z = (2 - this.var_273) * this.z - (1 - this.var_273) * this.lastZ;
            this.lastX = _loc3_;
            this.lastY = _loc4_;
            this.lastZ = _loc5_;
         }
         ...
         for each(_loc2_ in this.var_368)
         {
            ...
            _loc4_ = _loc2_.y;
            _loc5_ = _loc2_.z;
            _loc2_.x = (2 - this.var_273) * _loc2_.x - (1 - this.var_273) * _loc2_.lastX;
            _loc2_.y = (2 - this.var_273) * _loc2_.y - (1 - this.var_273) * _loc2_.lastY + this.var_1750 * this.var_948 * this.var_948;
            _loc2_.z = (2 - this.var_273) * _loc2_.z - (1 - this.var_273) * _loc2_.lastZ;
            _loc2_.lastX = _loc3_;
            _loc2_.lastY = _loc4_;
            _loc2_.lastZ = _loc5_;
