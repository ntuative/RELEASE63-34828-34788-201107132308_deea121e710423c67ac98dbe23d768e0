package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlane
   {
      ...
      public function FurniturePlane(param1:IVector3d, param2:IVector3d, param3:IVector3d)
      {
         ...
         this.var_341.assign(param3);
         this.var_849 = new Vector3d();
         this.var_849.assign(param2);
         this.var_848 = new Vector3d();
         this.var_848.assign(param3);
      ...
      public function setRotation(param1:Boolean) : void
      {
         if(param1 != this.var_2767)
         {
            if(!param1)
            {
               this.var_340.assign(this.var_849);
               this.var_341.assign(this.var_848);
            }
            else
            {
               this.var_340.assign(this.var_849);
               this.var_340.mul(this.var_848.length / this.var_849.length);
               this.var_341.assign(this.var_848);
               this.var_341.mul(this.var_849.length / this.var_848.length);
            }
            this.var_1852 = -1;
            this.var_1593 = this.var_1593 - 1;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(this.needsNewTexture(param1))
         {
            ...
            _loc6_ = Number(this.var_341.length * param1.scale);
            if(_loc5_ < 1)
            {
               _loc5_ = 1;
            }
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc9_:* = null;
         if(param1 == null || this.var_106 == null && this.var_1182 != null || this.var_340 == null || this.var_341 == null || this._normal == null)
         {
            return false;
         }
         ...
         if(param1.updateId != this.var_1852)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != this.var_1593 || _loc4_.y != this.var_2517 || _loc4_.z != this.var_2519 || param1.scale != this.var_1854))
            {
               this.var_1593 = _loc4_.x;
               this.var_2517 = _loc4_.y;
               ...
               _loc6_ = param1.getScreenPosition(this.var_1182);
               _loc7_ = _loc6_.z;
               _loc8_ = Math.max(this.var_173.z - _loc7_,this.var_127.z - _loc7_,this.var_97.z - _loc7_,this.var_126.z - _loc7_);
               this.var_2396 = _loc8_;
