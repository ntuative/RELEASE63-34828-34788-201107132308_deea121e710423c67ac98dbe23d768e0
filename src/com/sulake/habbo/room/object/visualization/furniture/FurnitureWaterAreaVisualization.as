package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      {
         if(this.var_2453 == param1 && this.var_2452 == direction)
         {
      ...
      private function updateTopBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc8_ < _loc3_ - 1)
         {
            if(_loc4_[_loc8_] == false)
            {
               ...
               this.var_642[param2] = ShoreMaskCreatorUtility.getBorderType(_loc6_,_loc7_);
            }
            param2++;
            _loc8_++;
         }
      ...
      private function updateRightBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc10_ < _loc4_ - 1)
         {
            ...
            if(_loc7_[_loc3_ - 1] == false)
            {
               ...
               this.var_642[param2] = ShoreMaskCreatorUtility.getBorderType(_loc5_,_loc6_);
            }
            param2++;
            _loc10_++;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_543 == 0 || this.var_643 == 0)
         {
            ...
            this.var_543 = _loc2_.getNumber(RoomObjectVariableEnum.const_270);
            this.var_643 = _loc2_.getNumber(RoomObjectVariableEnum.const_353);
         }
         this.var_448 = [];
         this.var_642 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_543 * 2 + this.var_643 * 2)
         {
            this.var_448.push(false);
            this.var_642.push(ShoreMaskCreatorUtility.const_82);
            _loc1_++;
         }
      }
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_79,getSize(param3),this.var_448,this.var_642,assetCollection);
      }
