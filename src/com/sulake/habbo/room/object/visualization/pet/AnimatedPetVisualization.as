package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1139:int = 1000;
      
      private static const const_1672:String = "pet_experience_bubble_png";
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1672) as BitmapDataAsset;
            if(_loc3_ != null)
            {
               _loc2_ = (_loc3_.content as BitmapData).clone();
               this.var_414 = new ExperienceData(_loc2_);
            }
         }
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != this.var_2903)
            {
               this.var_2903 = _loc3_;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc3_.getUpdateID() != var_146)
         {
            ...
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_176);
            ...
            _loc7_ = _loc3_.getNumber(RoomObjectVariableEnum.const_176);
            if(!isNaN(_loc7_))
            {
            ...
            this.var_2034 = _loc3_.getNumber(RoomObjectVariableEnum.const_308) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_204);
            if(!isNaN(_loc8_))
            {
               this.var_2108 = _loc8_;
            }
            else
            {
               this.var_2108 = direction;
            }
            this.var_1592 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2659 = _loc3_.getNumber(RoomObjectVariableEnum.const_404);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_820);
            if(_loc9_ != this.var_2109)
            {
               this.var_2109 = _loc9_;
               this.var_2904 = this.var_2109.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_414 != null)
         {
            ...
            if(this.var_1592 > 0)
            {
               _loc2_ = param1 - this.var_1592;
               if(_loc2_ < const_1139)
               {
                  this.var_414.alpha = int(Math.sin(_loc2_ / const_1139 * 0) * 255);
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc3_.asset = this.var_414.image;
                     _loc3_.offsetX = -20;
                     _loc3_.offsetY = -80;
                     _loc3_.alpha = this.var_414.alpha;
                     _loc3_.visible = true;
                  }
                  else
                  {
      ...
      {
         return super.getAdditionalSpriteCount() + const_714;
      }
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2904);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_714)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_714))
            {
               if(param2 >= FurnitureVisualizationData.const_560.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_560[param2];
               if(_loc4_ == 1)
               {
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_2108);
         }
         return direction;
      }
      ...
      private function isHeadSprite(param1:int) : Boolean
      {
         ...
         {
            if(this._animationData.getTag(var_103,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1674)
            {
               this.var_1100[param1] = true;
            }
            else
            {
               this.var_1100[param1] = false;
            }
         }
