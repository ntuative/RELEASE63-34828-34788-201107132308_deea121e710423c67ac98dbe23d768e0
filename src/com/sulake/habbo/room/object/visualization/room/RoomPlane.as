package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_1182:Vector3d = null;
      ...
      private var var_782:PlaneMaskManager = null;
      ...
      private var var_245:BitmapData = null;
      ...
      private var var_779:Boolean = true;
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         this.var_341.assign(param4);
         this._normal = Vector3d.crossProduct(this.var_340,this.var_341);
         ...
         this.var_2393 = param9;
         this.var_2391 = param10;
         this.var_2395 = param11;
      ...
      {
         return this._isVisible && this.var_779;
      }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_779 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_377))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(this.needsNewTexture(param1,param2))
         {
            ...
            _loc6_ = this.var_341.length * param1.scale;
            ...
            if(this.var_968 != null)
            {
               _loc3_ = this.var_968.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_1777,this.var_2393,this.var_2391,this.var_2395,this.var_2394,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(!geometryChanged || !this.var_779)
         {
            if(!this.visible)
            {
               return false;
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1470.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1470[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            originPos = geometry.getScreenPosition(this.var_1182);
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_173.z - originZ,this.var_127.z - originZ,this.var_97.z - originZ,this.var_126.z - originZ);
            if(this._type == TYPE_LANDSCAPE)
            {
               relativeDepth += 0.02;
            }
            this.var_2396 = relativeDepth;
         ...
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2392);
      ...
      private function updateCorners(param1:IRoomGeometry) : void
      {
         ...
         this.var_127.assign(param1.getScreenPosition(Vector3d.sum(this.var_106,this.var_341)));
         this.var_97.assign(param1.getScreenPosition(Vector3d.sum(Vector3d.sum(this.var_106,this.var_340),this.var_341)));
         this.var_126.assign(param1.getScreenPosition(Vector3d.sum(this.var_106,this.var_340)));
         this._offset = param1.getScreenPoint(this.var_1182);
         ...
         var _loc2_:Number = Math.min(this.var_173.x,this.var_127.x,this.var_97.x,this.var_126.x);
         var _loc3_:Number = Math.max(this.var_173.x,this.var_127.x,this.var_97.x,this.var_126.x);
         var _loc4_:Number = Math.min(this.var_173.y,this.var_127.y,this.var_97.y,this.var_126.y);
         var _loc5_:Number = Math.max(this.var_173.y,this.var_127.y,this.var_97.y,this.var_126.y);
         _loc3_ -= _loc2_;
      ...
      {
         if(this.var_173 == null || this.var_127 == null || this.var_97 == null || this.var_126 == null || param2 == null || this._bitmapData == null)
         {
            return;
         }
      ...
      public function addRectangleMask(param1:Number, param2:Number, param3:Number, param4:Number) : Boolean
      {
         ...
         if(this.var_969)
         {
            _loc5_ = null;
            _loc6_ = 0;
            while(_loc6_ < this.var_376.length)
            {
               _loc5_ = this.var_376[_loc6_] as RoomPlaneRectangleMask;
               if(_loc5_ != null)
               {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_276.length == this.var_967.length)
         {
         ...
         if(this.var_376.length > this.var_1469.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_969 || this.var_276.length == 0 && this.var_376.length == 0 && !this.var_377 || this.var_782 == null)
         {
            return;
         }
         ...
         if(this.var_377)
         {
            ...
            while(_loc5_ < this.var_276.length)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_79.width - this.var_79.width * _loc3_.leftSideLoc / this.var_340.length;
                  _loc11_ = this.var_79.height - this.var_79.height * _loc3_.rightSideLoc / this.var_341.length;
                  _loc12_ = _loc3_.type;
                  this.var_782.updateMask(this.var_79,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
            ...
            while(_loc6_ < this.var_376.length)
            {
               _loc4_ = this.var_376[_loc6_] as RoomPlaneRectangleMask;
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_79.width - this.var_79.width * _loc4_.leftSideLoc / this.var_340.length;
                  _loc11_ = this.var_79.height - this.var_79.height * _loc4_.rightSideLoc / this.var_341.length;
                  _loc13_ = this.var_79.width * _loc4_.leftSideLength / this.var_340.length;
                  _loc14_ = this.var_79.height * _loc4_.rightSideLength / this.var_341.length;
                  this.var_79.fillRect(new Rectangle(_loc10_ - _loc13_,_loc11_ - _loc14_,_loc13_,_loc14_),4278190080);
                  this.var_1469.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            this.var_377 = false;
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         if(this.var_245 != null && (this.var_245.width != param1.width || this.var_245.height != param1.height))
         {
            this.var_245.dispose();
            this.var_245 = null;
         }
         if(this.var_245 == null)
         {
            this.var_245 = new BitmapData(param1.width,param1.height,true,4294967295);
         }
         this.var_245.copyChannel(param1,param1.rect,const_682,BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         this.var_245.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(this.var_245,this.var_245.rect,const_682,BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
   }
}
