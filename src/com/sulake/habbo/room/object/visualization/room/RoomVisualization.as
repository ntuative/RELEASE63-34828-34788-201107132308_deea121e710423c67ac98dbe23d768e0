package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1930:int = 16777215;
      
      public static const const_1836:int = 13421772;
      
      private static const const_1066:int = 16777215;
      
      private static const const_1065:int = 13421772;
      
      private static const const_1064:int = 10066329;
      
      private static const const_1067:int = 10066329;
      
      public static const const_1842:int = 16777215;
      
      public static const const_1792:int = 13421772;
      
      public static const const_1926:int = 10066329;
      ...
      private var var_546:RoomPlaneBitmapMaskParser = null;
      ...
      private var var_1094:Number = NaN;
      
      private var var_1502:Number = NaN;
      
      private var var_2518:Number = NaN;
      
      private var var_1853:String = null;
      
      private var var_1228:uint = 16777215;
      
      private var var_2521:int = 255;
      ...
      private const const_2351:int = 250;
      ...
      private var var_1854:Number = 0.0;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_546 = new RoomPlaneBitmapMaskParser();
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         if(!isNaN(this.var_1094))
         {
            this._planeParser.floorThicknessMultiplier = this.var_1094;
         }
         if(!isNaN(this.var_1502))
         {
            this._planeParser.wallThicknessMultiplier = this.var_1502;
         }
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_791);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1297);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_427)
            {
            ...
            else if(_loc12_ == RoomPlaneData.const_1979)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_77,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_427)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this._lastUpdateTime + this.const_2351 && !_loc6_ && !_loc8_)
         {
            return;
         }
         ...
         {
            _loc10_ = 0;
            while(_loc10_ < this.var_382.length)
            {
               _loc11_ = this.var_650[_loc10_];
               _loc12_ = getSprite(_loc11_);
               _loc13_ = this.var_382[_loc10_] as RoomPlane;
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1855)
                  {
                     _loc14_ = uint(_loc13_.color);
                     _loc15_ = uint((_loc14_ & 255) * this.var_2516 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2520 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2521 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1852)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1593 || _loc3_.y != this.var_2517 || _loc3_.z != this.var_2519 || param1.scale != this.var_1854))
            {
               this.var_1593 = _loc3_.x;
               this.var_2517 = _loc3_.y;
               this.var_2519 = _loc3_.z;
               this.var_1854 = param1.scale;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1402);
            if(_loc3_ != this.var_1853)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_1853 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_943));
            if(_loc4_ != this.var_1228)
            {
               this.var_1228 = _loc4_;
               this.var_2516 = this.var_1228 & 255;
               this.var_2520 = this.var_1228 >> 8 & 255;
               this.var_2521 = this.var_1228 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1319));
            if(_loc5_ != this.var_1855)
            {
               this.var_1855 = _loc5_;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_146 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_208);
            ...
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1031));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_882));
      ...
      private function updatePlaneThicknesses(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_146 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1196);
            _loc3_ = param1.getNumber(RoomObjectVariableEnum.const_1224);
            if(!isNaN(_loc2_) && !isNaN(_loc3_) && (_loc2_ != this.var_1094 || _loc3_ != this.var_1502))
            {
               this.var_1094 = _loc2_;
               this.var_1502 = _loc3_;
               this.resetRoomPlanes();
               return true;
            }
         }
      ...
      private function updateFloorHoles(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_146 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1341);
            if(!isNaN(_loc2_) && _loc2_ != this.var_2518)
            {
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_382;
         if(this.var_382.length == 0)
         {
            _loc6_ = this.var_155;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_382.length > 0;
         var _loc9_:int = 0;
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc11_.visible)
                  {
                     if(!_loc8_)
                     {
                        this.var_382.push(_loc12_);
                        this.var_650.push(_loc9_);
                     }
                  }
               }
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.asset = this.method_9(param2,param3);
         param1.assetName = param3 + "_" + this.var_1229;
      }
      
      private function method_9(param1:RoomPlane, param2:String) : BitmapData
      {
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_546.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_546.maskCount)
         {
            _loc10_ = this.var_546.getMaskType(_loc8_);
            _loc11_ = this.var_546.getMaskLocation(_loc8_);
            _loc12_ = this.var_546.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
                     ...
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_77 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_289)
                              {
