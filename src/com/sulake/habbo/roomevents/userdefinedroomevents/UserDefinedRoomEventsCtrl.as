package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private static var var_1501:int = 2;
      ...
      private var var_1849:TriggerConfs;
      
      private var var_1851:ActionTypes;
      ...
      private var var_1227:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1849 = new TriggerConfs();
         this.var_1851 = new ActionTypes();
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1227 = new SliderWindowController(this.var_93,IWindowContainer(this.find(this.var_57,"delay_slider_container")),this.var_93.assets,0,20,1);
         this.var_1227.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1227.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_809.hideAll(this.var_279);
         }
      }
      ...
      public function prepareForUpdate(param1:Triggerable) : void
      {
         ...
         this.var_809.showAll(this.var_279);
         if(this.var_37 as ActionDefinition != null)
         {
            _loc5_ = ActionDefinition(this.var_37);
            _loc6_ = _loc5_.delayInPulses;
            this.var_1227.setValue(_loc6_);
         }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1227.getValue()) : 0;
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = this.var_37.stuffTypeSelectionCode < 1 ? int(var_1501) : int(this.var_37.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = (this.var_37.stuffTypeSelectionCode + 1) % (var_1501 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1851);
