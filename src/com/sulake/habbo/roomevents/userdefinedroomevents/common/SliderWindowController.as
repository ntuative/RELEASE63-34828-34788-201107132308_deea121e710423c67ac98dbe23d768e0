package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      private var var_668:Number = 0.0;
      ...
      private function updateSliderPosition() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.x = this.getSliderPosition(this.var_1023);
         }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1024)
         {
            if(param1.type == WindowMouseEvent.const_56 || param1.type == WindowMouseEvent.const_310)
            {
               this.var_1024 = false;
            }
         }
         if(!this.var_1024 || param1.type != WindowEvent.const_442)
         {
            return;
         }
         if(this.var_668 != 0)
         {
            ...
            _loc4_ = Math.round(_loc3_ / this.var_668) * this.var_668;
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_668 != 0)
            {
               _loc3_ = this.var_1023 + this.var_668;
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null && this.var_760 != null)
            {
               ...
               this.var_1727 = _loc1_.width - _loc2_.width;
            }
         }
