package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1050:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1439:String = "sendAccessTokenToServer";
      
      private static const const_1438:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1439,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1438,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_1050);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_1050);
         }
      }
