package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      private static const const_1567:int = HabboMusicPrioritiesEnum.const_127;
      ...
      private var var_557:IPlayListController = null;
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_93.addEventListener(RoomEngineSoundMachineEvent.const_919,this.onJukeboxInit);
         this.var_93.addEventListener(RoomEngineSoundMachineEvent.const_311,this.onJukeboxDispose);
         this.var_93.addEventListener(RoomEngineSoundMachineEvent.const_1017,this.onSoundMachineInit);
         this.var_93.addEventListener(RoomEngineSoundMachineEvent.const_1010,this.onSoundMachineDispose);
         this.var_1270 = new Timer(1000);
         this.var_1270.start();
         this.var_1270.addEventListener(TimerEvent.TIMER,this.sendNextSongRequestMessage);
         this._events.addEventListener(SoundCompleteEvent.TRAX_SONG_COMPLETE,this.onSongFinishedPlayingEvent);
         _loc6_ = 0;
         while(_loc6_ < HabboMusicPrioritiesEnum.const_266)
         {
            this.var_335[_loc6_] = null;
            this.var_836[_loc6_] = 0;
            _loc6_++;
         }
      }
      ...
      protected function onSongFinishedPlayingEvent(param1:SoundCompleteEvent) : void
      {
         ...
         {
            if(this.getTopRequestPriority() == this._priorityPlaying && this.getSongRequestCountAtPriority(this._priorityPlaying) == this.var_1953)
            {
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_93)
            {
               this.var_93.removeEventListener(RoomEngineSoundMachineEvent.const_919,this.onJukeboxInit);
               this.var_93.removeEventListener(RoomEngineSoundMachineEvent.const_311,this.onJukeboxDispose);
               this.var_93.removeEventListener(RoomEngineSoundMachineEvent.const_1017,this.onSoundMachineInit);
               this.var_93.removeEventListener(RoomEngineSoundMachineEvent.const_1010,this.onSoundMachineDispose);
            }
      ...
      {
         if(param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_266)
         {
            return false;
         }
         var _loc7_:SongStartRequestData = new SongStartRequestData(param2,param3,param4,param5,param6);
         this.var_335[param1] = _loc7_;
         this.var_836[param1] += 1;
         return true;
      }
      ...
      private function getSongIdRequestedAtPriority(param1:int) : int
      {
         ...
         var _loc2_:SongStartRequestData = this.var_335[param1];
      ...
      private function getSongRequestCountAtPriority(param1:int) : int
      {
         ...
         return this.var_836[param1];
      }
      
      private function getTopRequestPriority() : int
      {
         var _loc1_:int = this.var_335.length - 1;
         while(_loc1_ >= 0)
         {
            if(this.var_335[_loc1_] != null)
            {
               return _loc1_;
            }
            _loc1_--;
      ...
      public function updateVolume(param1:Number) : void
      {
         ...
         var _loc4_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < HabboMusicPrioritiesEnum.const_266)
         {
      ...
      private function requestSong(param1:int, param2:Boolean) : void
      {
         ...
         {
            this.var_682.add(param1,param2);
      ...
      public function getSongDiskInventoryDiskId(param1:int) : int
      {
         ...
         {
            return this.var_393.getKey(param1);
         }
         return -1;
      }
      ...
      public function getSongDiskInventorySongId(param1:int) : int
      {
         if(param1 >= 0 && param1 < this.var_393.length)
         {
            return this.var_393.getWithIndex(param1);
         }
         return -1;
      }
      ...
      public function samplesUnloaded(param1:Array) : void
      {
         ...
         while(_loc2_ < this.var_287.length)
         {
            ...
            if(_loc3_.id != this.var_1560 && _loc4_ != null && _loc4_.ready)
            {
      ...
      public function get samplesIdsInUse() : Array
      {
         ...
         {
            if(this.var_335[_loc2_] != null)
            {
               _loc3_ = this.var_335[_loc2_];
      ...
      private function sendNextSongRequestMessage(param1:TimerEvent) : void
      {
         ...
         this._connection.send(new GetSongInfoMessageComposer(this.var_835));
         Logger.log("Requested song info\'s : " + this.var_835);
         this.var_835 = new Array();
      }
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            if(_loc7_)
            {
               ...
               while(this.var_837.indexOf(_loc6_.id) != -1)
               {
                  this.var_837.splice(this.var_837.indexOf(_loc6_.id),1);
      ...
      {
         if(param2 == -1 || param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_266)
         {
            return false;
         }
         ...
         this.var_1953 = this.getSongRequestCountAtPriority(param1);
         this.var_1560 = param2;
         if(this._priorityPlaying <= const_1567)
         {
            this.notifySongPlaying(_loc4_);
         }
         if(param1 > HabboMusicPrioritiesEnum.const_127)
         {
            this._events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_128,param1,_loc4_.id,-1));
         }
      ...
      private function notifySongPlaying(param1:SongDataEntry) : void
      {
         ...
         if(param1.length >= 8000 && (this.var_2663 != param1.id || _loc3_ > this.var_2664 + 8000))
         {
            this._soundManager.notifyPlayedSong(param1.name,param1.creator);
            this.var_2663 = param1.id;
      ...
      private function onSoundMachineInit(param1:Event) : void
      {
         ...
         this.var_557 = new SoundMachinePlayListController(this._soundManager,this,this._events,this.var_93,this._connection) as IPlayListController;
      }
      ...
      {
         this.disposeRoomPlaylist();
         this.var_557 = new JukeboxPlayListController(this._soundManager,this,this._events,this._connection) as IPlayListController;
