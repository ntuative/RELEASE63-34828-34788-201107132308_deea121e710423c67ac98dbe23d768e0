package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_93.addEventListener(RoomEngineSoundMachineEvent.const_842,this.onSoundMachinePlayEvent);
         this.var_93.addEventListener(RoomEngineSoundMachineEvent.const_848,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_93)
            {
               this.var_93.removeEventListener(RoomEngineSoundMachineEvent.const_842,this.onSoundMachinePlayEvent);
               this.var_93.removeEventListener(RoomEngineSoundMachineEvent.const_848,this.onSoundMachineStopEvent);
               this.var_93 = null;
            }
            this._disposed = true;
         }
      ...
      public function stopPlaying() : void
      {
         this.var_441 = -1;
         this.var_627 = false;
         this.var_242.stop(HabboMusicPrioritiesEnum.const_127);
      }
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_242.playSong(param1,HabboMusicPrioritiesEnum.const_127,_loc3_,0,0,0))
         {
