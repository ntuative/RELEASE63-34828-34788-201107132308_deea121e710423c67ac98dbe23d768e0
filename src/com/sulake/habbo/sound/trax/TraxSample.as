package com.sulake.habbo.sound.trax
{
   ...
   public class TraxSample implements IDisposable
   {
      ...
      public static const const_2014:String = "sample_44khz";
      
      public static const const_1859:String = "sample_22khz";
      
      public static const const_1978:String = "sample_11khz";
      
      public static const const_1953:String = "sample_16bit";
      
      public static const const_1940:String = "sample_8bit";
      ...
      private var var_132:Vector.<int> = null;
      ...
      public function TraxSample(param1:ByteArray, param2:int, param3:String = "sample_44khz", param4:String = "sample_16bit")
      {
         ...
         this.var_132 = new Vector.<int>(_loc7_ / _loc6_,true);
         ...
         while(_loc11_ < _loc10_)
         {
            ...
            {
               this.var_132[int(_loc11_ / this.var_176)] = _loc9_;
               _loc9_ = 0;
            }
            _loc11_++;
         }
      ...
      {
         return this.var_132.length * this.var_176 * this.var_85;
      }
      
      public function get usageCount() : int
      {
         return this.var_658.length;
      }
      ...
      public function setSample(param1:Vector.<int>, param2:int, param3:int, param4:int) : int
      {
         ...
         var _loc7_:int = 0;
         if(_loc6_ > this.var_132.length - param4)
         {
            _loc7_ = (_loc6_ - (this.var_132.length - param4)) * _loc5_;
            _loc6_ = this.var_132.length - param4;
      ...
      public function setUsageFromSong(param1:int, param2:uint) : void
      {
         ...
         if(this.var_658.indexOf(param1) == -1)
         {
