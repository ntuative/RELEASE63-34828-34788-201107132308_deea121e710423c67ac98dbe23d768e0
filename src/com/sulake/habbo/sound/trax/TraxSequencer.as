package com.sulake.habbo.sound.trax
{
   ...
   public class TraxSequencer implements IHabboSound, IDisposable
   {
      ...
      private static const const_118:uint = 8192;
      
      private static const const_1059:uint = 88000;
      
      private static const const_688:uint = 88000;
      
      private static const const_201:Vector.<int> = new Vector.<int>(const_118,true);
      
      private static const INTERPOLATION_BUFFER:Vector.<int> = new Vector.<int>(const_118,true);
      ...
      private var var_174:uint;
      
      private var var_327:Array;
      
      private var var_1471:Boolean;
      
      private var var_630:Boolean = true;
      
      private var var_277:uint;
      ...
      {
         this.var_1472 = uint(30);
         super();
         this._events = param4;
         this.var_1475 = param1;
         this.var_995 = 1;
         this.var_972 = new Sound();
         this.var_446 = null;
      ...
      {
         this.var_174 = uint(param1 * const_119);
      }
      ...
      {
         return this.var_784 / const_119;
      }
      
      public function set fadeInSeconds(param1:Number) : void
      {
         this.var_784 = int(param1 * const_119);
      }
      ...
      public function prepare() : Boolean
      {
         ...
         if(!this.var_1471)
         {
            if(this.var_444 != null)
            {
               ...
               {
                  this.var_1473 = this.var_444.metaCutMode;
               }
               if(this.var_1473)
               {
      ...
      private function prepareLegacySequence() : Boolean
      {
         ...
         while(_loc2_ < this.var_444.channels.length)
         {
            ...
            while(_loc7_ < _loc4_.itemCount)
            {
               ...
               _loc9_ = this.var_1474.getValue(_loc8_) as TraxSample;
               _loc9_.setUsageFromSong(this.var_1475,_loc1_);
               if(_loc9_ == null)
               {
               ...
               while(_loc12_ < _loc11_)
               {
                  ...
                  _loc6_ += _loc10_;
                  _loc5_ = uint(_loc6_ * const_688);
                  _loc12_++;
               }
               if(this.var_277 < _loc5_)
               {
                  this.var_277 = _loc5_;
               }
               _loc7_++;
      ...
      private function prepareSequence() : Boolean
      {
         ...
         while(_loc2_ < this.var_444.channels.length)
         {
            ...
            while(_loc8_ < _loc4_.itemCount)
            {
               ...
               _loc10_ = this.var_1474.getValue(_loc9_) as TraxSample;
               _loc10_.setUsageFromSong(this.var_1475,_loc1_);
               if(_loc10_ == null)
               {
      ...
      public function play(param1:Number = 0.0) : Boolean
      {
         ...
         this.var_532 = 0;
         this.var_630 = false;
         this.var_972.addEventListener(SampleDataEvent.SAMPLE_DATA,this.onSampleData);
         this.var_1476 = param1 * const_119;
         this.var_1187 = 0;
         this.var_1781 = 0;
         this.var_446 = this.var_972.play();
      ...
      {
         if(this.var_443 > 0 && !this.var_630)
         {
      ...
      private function stopImmediately() : void
      {
         ...
         {
            this.var_972.removeEventListener(SampleDataEvent.SAMPLE_DATA,this.onSampleData);
         }
      }
      ...
      private function stopWithFadeout() : void
      {
         if(this.var_631 == null)
         {
            this.var_783 = true;
            this.var_532 = 0;
            this.var_631 = new Timer(this.var_1472 + this.var_443 / (const_119 / 1000),1);
            this.var_631.start();
      ...
      private function getSampleBars(param1:uint) : int
      {
         if(this.var_1473)
         {
            return Math.round(param1 / const_1059);
         }
         return Math.ceil(param1 / const_1059);
      }
      ...
      private function getChannelSequenceOffsets() : Array
      {
         ...
         if(this.var_327 != null)
         {
            _loc2_ = this.var_327.length;
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
               _loc4_ = this.var_327[_loc3_];
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length && _loc4_.getKey(_loc5_) < this.var_174)
               {
                  _loc5_++;
               }
      ...
      private function mixChannelsIntoBuffer() : void
      {
         ...
         var _loc2_:int = this.var_327.length;
         var _loc3_:* = null;
         var _loc4_:int = _loc2_ - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.var_327[_loc4_];
            ...
            _loc8_ = const_118;
            if(this.var_277 - this.var_174 < _loc8_)
            {
               _loc8_ = this.var_277 - this.var_174;
            }
            _loc9_ = 0;
            while(_loc9_ < _loc8_)
            {
               ...
               if(_loc6_ < _loc5_.length - 1)
               {
                  ...
                  if(_loc8_ + this.var_174 >= _loc13_)
                  {
                     _loc12_ = _loc13_ - this.var_174;
                  }
               }
      ...
      {
         var _loc1_:int = this.var_277 < this.var_1476 ? int(this.var_277) : (this.var_1476 > 0 ? int(this.var_1476) : int(this.var_277));
         if(this.var_174 > _loc1_ + this.var_1472 * (const_119 / 1000) && !this.var_630)
         {
            this.var_630 = true;
         ...
         else if(this.var_174 > _loc1_ - this.var_443 && !this.var_783)
         {
            this.var_971 = false;
            this.var_783 = true;
            this.var_532 = 0;
      ...
      {
         if(param1.position > this.var_1187)
         {
            ++this.var_1781;
            Logger.log("Audio buffer under run...");
            this.var_1187 = param1.position;
         }
         if(this.volume > 0)
         {
            this.mixChannelsIntoBuffer();
         }
         var _loc2_:int = const_118;
         if(this.var_277 - this.var_174 < _loc2_)
         {
            _loc2_ = this.var_277 - this.var_174;
            if(_loc2_ < 0)
            {
               _loc2_ = 0;
            }
         ...
         this.var_174 += const_118;
         this.var_1187 += const_118;
         if(this.var_446 != null)
         {
            this.var_1472 = param1.position / const_119 * 1000 - this.var_446.position;
         }
         ...
         if(param2 > 0)
         {
            ...
            else
            {
               if(this.var_971)
               {
                  ...
                  _loc6_ = this.var_973 / Number(this.var_784);
                  this.var_973 += const_118;
                  if(this.var_973 > this.var_784)
                  {
                     this.var_971 = false;
                  }
               }
               else if(this.var_783)
               {
                  ...
                  _loc6_ = 1 - this.var_532 / Number(this.var_443);
                  this.var_532 += const_118;
                  if(this.var_532 > this.var_443)
                  {
                     this.var_532 = this.var_443;
                  }
               }
      ...
      {
         this.stopImmediately();
         this._events.dispatchEvent(new SoundCompleteEvent(SoundCompleteEvent.TRAX_SONG_COMPLETE,this.var_1475));
      }
