package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private static const const_1492:String = "purse";
      
      private static const const_1493:String = "extra_tools";
      ...
      private var var_640:ExtraToolsExtension;
      
      private var _connection:IConnection;
      
      private var _catalog:IHabboCatalog;
      
      private var var_1209:PurseExtension;
      
      private var var_1491:ClubDiscountPromoExtension;
      
      private var _localization:ICoreLocalizationManager;
      
      private var var_12:IHabboInventory;
      
      private var var_639:ExtensionView;
      ...
      private function onCommunicationManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._connection = this.var_302.getHabboMainConnection(null);
         this.tryInitialize();
      }
      ...
      {
         if(this.var_302 && this._windowManager && this._config && this._localization && this.var_12 && this._catalog)
         {
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_639 = new ExtensionView(this._windowManager,this._assetLibrary,this);
            if(this.var_639)
            {
               this.var_1209 = new PurseExtension(this._windowManager,this._assetLibrary,this._config,this._catalog,this.var_12,this._localization);
               this.var_640 = new ExtraToolsExtension(this,this._windowManager,this._assetLibrary,events,this._config);
               if(this._config.getBoolean("club.membership.extend.promotion.enabled",false))
               {
                  this.var_1491 = new ClubDiscountPromoExtension(this,this._windowManager,this._assetLibrary,events,this._config,this._localization,this.var_12,this._catalog,this._connection);
               }
               this.var_639.attachExtension(const_1492,this.var_1209.window,ExtensionFixedSlotsEnum.const_1901);
               this.var_639.attachExtension(const_1493,this.var_640.window,ExtensionFixedSlotsEnum.const_1748);
            }
         }
         if(this._view == null)
         {
      ...
      private function toolbarExtensionVisible(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            this.var_640.showRoomInfo();
         }
         else
         {
            this.var_640.hideRoomInfo();
         }
      }
