package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private static const const_1570:Point = new Point(3,3);
      
      private static const const_1590:uint = 7433577;
      
      private static const const_1592:uint = 5723213;
      ...
      private static const const_1593:int = 74;
      ...
      private static const const_1591:int = 10;
      ...
      public function ToolbarView(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:IHabboCatalog, param6:IEventDispatcher, param7:IHabboConfigurationManager)
      {
         ...
         this._window.position = const_1570;
         this._window.addEventListener(WindowEvent.const_588,this.onParentResized);
         ...
         this.var_225 = param2.buildFromXML(_loc12_.content as XML,2) as IWindowContainer;
         ...
         _loc13_.addChild(this.var_225);
         var _loc14_:ITextWindow = this.var_225.findChildByName("new_textfield") as ITextWindow;
         ...
         this.var_225.x = _loc13_.width - this.var_225.width - const_479;
         this.var_225.y = const_479;
         this.var_2721 = this.isNewItemsNotificationEnabled();
      ...
      private function checkSize(param1:Boolean = false) : void
      {
         ...
         if(!param1 && _loc2_ == this.var_1585)
         {
            return;
         }
         this.var_1585 = _loc2_;
         var _loc3_:int = !!_loc2_ ? int(const_1593) : int(const_1596);
         var _loc4_:int = !!_loc2_ ? int(const_1595) : int(ICON_SPACING_NORMAL);
         ...
         while(_loc7_ < _loc5_.length)
         {
            ...
            _loc6_.y = const_1594 + _loc7_ * (_loc3_ + _loc4_);
            _loc7_++;
         }
         this._window.height = _loc6_.rectangle.bottom + const_1591;
      }
      ...
      private function onCatalogEvent(param1:CatalogEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case CatalogEvent.CATALOG_NEW_ITEMS_SHOW:
               if(this.var_225 != null && this.var_2721)
               {
      ...
      public function setToolbarState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case HabboToolbarEnum.const_803:
               _loc3_ = false;
               break;
            case HabboToolbarEnum.const_850:
               _loc3_ = true;
         }
      ...
      private function setIconHoverState(param1:IBitmapWrapperWindow, param2:String) : void
      {
         ...
         {
            _loc4_ = param2 == const_478 ? this.var_1583 : this.var_1584;
         }
         else
         {
      ...
      public function getIconVerticalLocation(param1:String) : int
      {
         switch(param1)
         {
            case HabboToolbarIconEnum.NAVIGATOR:
               return !!this.var_1585 ? 45 : 50;
            case HabboToolbarIconEnum.QUESTS:
               return !!this.var_1585 ? 125 : 140;
            default:
               return 0;
         }
      }
      ...
      private function setMeMenuIconBitmaps(param1:BitmapData) : void
      {
         ...
         this.var_1584 = this.addShadow(param1,new Point(2,3),4280426782);
         if(this.var_1583)
         {
            this.var_1583.dispose();
         }
         this.var_1583 = this.addShadow(param1,new Point(4,5),4281150249);
         param1.dispose();
      }
      ...
      public function getUnseenItemCounter(param1:String) : IWindowContainer
      {
         ...
         var _loc2_:IWindowContainer = this.var_1055.getValue(param1) as IWindowContainer;
         if(!_loc2_)
         {
            ...
            _loc2_.y = const_479;
            this.var_1055.add(param1,_loc2_);
         }
         return _loc2_;
      }
