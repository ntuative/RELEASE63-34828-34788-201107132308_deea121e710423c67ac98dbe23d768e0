package com.sulake.habbo.toolbar.extensions
{
   ...
   public class ExtraToolsExtension
   {
      ...
      private static const const_1643:uint = 12247545;
      ...
      private function showConfirmation() : void
      {
         ...
         if(!this.var_346)
         {
            this.var_346 = this.createWindow("logout_confirmation_xml") as IWindowContainer;
            _loc1_ = new Point();
            this._window.getGlobalPosition(_loc1_);
            this.var_346.x = _loc1_.x + this._window.width - this.var_346.width;
            this.var_346.y = _loc1_.y + this._window.height - this.var_346.height;
         }
      }
