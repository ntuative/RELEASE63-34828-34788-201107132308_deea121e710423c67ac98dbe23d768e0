package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_1047:uint = 11;
      ...
      private var var_1161:IHabboWindowManager;
      ...
      private var var_437:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_437 = new ToolbarClickTracker(this);
         this.var_1439 = new Array(const_1047);
         var _loc4_:int = 0;
         while(_loc4_ < const_1047)
         {
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1903,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1802,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_924,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1312,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1161)
            {
               this.var_1161.release(new IIDHabboWindowManager());
               this.var_1161 = null;
            }
            if(this.var_354)
            {
            ...
            if(this.var_212)
            {
               if(!this.var_212.disposed)
               {
                  ...
                  Component(this.var_212).events.removeEventListener(HabboFriendListTrackingEvent.const_549,this.onFriendlistTrackingEvent);
               }
            ...
            {
               this.var_323.stop();
               this.var_323.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
               this.var_323 = null;
            }
      ...
      {
         this.var_144 = IHabboConfigurationManager(param2);
         if(this.var_144)
         {
            if(this.var_271 != null)
            {
               this.var_271.configuration = this.var_144;
            }
            if(this.var_272 != null)
            {
               this.var_272.configuration = this.var_144;
            }
            ...
            if(this.var_144)
            {
               ...
               {
                  this.var_616.configure(this.var_144);
               }
               if(this.var_436 != null)
               {
                  this.var_436.configure(this.var_144);
               }
               if(this.var_437 != null)
               {
                  this.var_437.configure(this.var_144);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_1027,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_754,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_74,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_596,this.onHotelViewEvent);
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_754)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1902);
         }
         else if(param1.type == HabboHotelViewEvent.const_596)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1851);
         }
         else if(param1.type == HabboHotelViewEvent.const_74)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1760);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1877);
               break;
            case HabboCommunicationEvent.const_1027:
               this.trackLoginStep(HabboLoginTrackingStep.const_1749,String(this._communication.port));
               break;
      ...
      {
         this.var_1161 = IHabboWindowManager(param2);
         if(this.var_1161)
         {
            Component(context).events.addEventListener(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT,this.method_3);
            Component(context).events.addEventListener(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER,this.method_3);
            Component(context).events.addEventListener(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP,this.method_3);
         }
      }
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_144)
            {
               if(this.var_144.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = this.var_144.getKey("client.fatal.error.url");
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1381);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1381,this.onCoreRunning);
         }
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_212).events.addEventListener(HabboFriendListTrackingEvent.const_549,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_549:
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1312,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_924,String(true));
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_354.events.addEventListener(AdEvent.const_492,this.onRoomAdLoad);
      }
      ...
      private function onRoomAction(param1:RoomEngineEvent) : void
      {
         if(param1.type == RoomEngineEvent.const_200)
         {
            if(this.var_1737 < 1)
            {
               if(!this.var_323)
               {
                  this.var_323 = new Timer(60000,1);
                  this.var_323.addEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
                  this.var_323.start();
               }
            }
         }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_437)
         {
            this.var_437.track(param1.iconName);
         }
      }
      ...
      private function onZoomToggle(param1:HabboNavigatorEvent) : void
      {
         if(this.var_437)
         {
            this.var_437.track(param1.type);
         }
      }
      ...
      {
         if(this.var_144 != null && !Boolean(this.var_144.getKey("processlog.enabled")))
         {
            return;
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_516 > -1 && _loc2_ < this.var_516)
         {
            ++this.var_1739;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1739);
         }
         if(this.var_516 > -1 && _loc2_ - this.var_516 > 15000)
         {
            ++this.var_1738;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1738);
         }
         this.var_516 = _loc2_;
         if(this.var_272 != null)
         {
            this.var_272.update(param1,this.var_516);
         }
         if(this.var_271 != null)
         {
            this.var_271.update(param1,this.var_516);
         }
         if(this.var_436 != null)
         {
            this.var_436.trackUpdate(param1,this,this.var_516);
         }
         if(this.var_616 != null)
         {
            this.var_616.update(this.var_516);
         }
      }
   }
}
