package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends ComponentContext implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_1265:IRoomWidgetFactory;
      ...
      private var var_1651:IHabboAvatarEditor = null;
      ...
      private var var_1340:IHabboHelp;
      
      private var var_1118:IHabboModeration;
      ...
      private var var_1373:IHabboUserDefinedRoomEvents;
      
      public function RoomUI(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_1668 = RoomDesktop.const_496;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1340.release(new IIDHabboHelp());
            this.var_1340 = null;
         }
         ...
         {
            this.var_1118.release(new IIDHabboModeration());
            this.var_1118 = null;
         }
         ...
         if(this.var_1373)
         {
            this.var_1373.release(new IIDHabboUserDefinedRoomEvents());
            this.var_1373 = null;
         }
         this.var_1651 = null;
         ...
         if(this.var_355)
         {
            while(this.var_355.length > 0)
            {
               _loc1_ = this.var_355.getKey(0) as String;
               _loc2_ = this.var_355.remove(_loc1_) as RoomDesktop;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function onAvatarEditorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1651 = param2 as IHabboAvatarEditor;
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         {
            this.var_354.events.addEventListener(InterstitialEvent.const_554,this.interstitialCompleteEventHandler);
            this.var_354.events.addEventListener(InterstitialEvent.const_545,this.adEventHandler);
            this.var_354.events.addEventListener(AdEvent.const_492,this.adEventHandler);
         }
      }
      ...
      private function onHabboHelpReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1340 = param2 as IHabboHelp;
      }
      ...
      private function onHabboModerationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1118 = param2 as IHabboModeration;
         Logger.log("XXXX GOT HABBO MODERATION: " + this.var_1118);
      }
      ...
      private function registerSessionEvents() : void
      {
         if(this.var_15)
         {
            ...
            this.var_15.events.addEventListener(RoomSessionChatEvent.const_206,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionChatEvent.const_630,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionPresentEvent.const_344,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionPetPackageEvent.const_500,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_1333,this.roomSessionDialogEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_295,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_281,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_287,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_823,this.roomSessionDialogEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_1008,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_1033,this.roomSessionDialogEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionPollEvent.const_158,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionDimmerPresetsEvent.const_499,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionFriendRequestEvent.const_162,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionUserNotificationEvent.const_136,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionUserDataUpdateEvent.const_122,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionDanceEvent.const_159,this.roomSessionEventHandler);
         }
      }
      ...
      private function roomSessionStateEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_78:
               this._toolbar.setToolbarState(HabboToolbarEnum.const_850);
               break;
            case RoomSessionEvent.const_85:
               if(param1.session != null)
               {
                  ...
                  this._toolbar.setToolbarState(HabboToolbarEnum.const_803);
               }
         }
      }
      ...
      private function roomSessionDialogEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomSessionErrorMessageEvent.const_309:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_1015:
            ...
            case RoomSessionErrorMessageEvent.const_281:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_823:
               errorMessage = "${room.error.pets.forbidden_in_hotel}";
               break;
            case RoomSessionErrorMessageEvent.const_949:
               errorMessage = "${room.error.pets.forbidden_in_flat}";
               break;
            case RoomSessionErrorMessageEvent.const_1008:
               errorMessage = "${room.error.pets.no_free_tiles}";
               break;
            case RoomSessionErrorMessageEvent.const_1033:
      ...
      private function interstitialCompleteEventHandler(param1:InterstitialEvent) : void
      {
         ...
         var _loc2_:String = this.getRoomIdentifier(this._interstitialRoomId,this.var_2954);
      ...
      private function onUserDefinedRoomEventsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1373 = param2 as IHabboUserDefinedRoomEvents;
      }
      ...
      private function initializeRoomEngineEvents() : void
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_841,this.roomEngineEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_640,this.roomEngineEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_999,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_805,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_674,this.roomObjectEventHandler);
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         if(param1.type == RoomEngineEvent.const_841)
         {
            if(this.var_15 != null)
            {
               this.var_15.roomEngineReady = true;
         ...
         else if(param1.type == RoomEngineEvent.const_559 || param1.type == RoomEngineEvent.const_640)
         {
      ...
      private function roomEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_200:
               ...
               _loc3_.disposeWidget(RoomWidgetEnum.const_628);
               ...
               if(this.var_1668 != RoomDesktop.const_496)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_338,this.var_1668);
               }
               if(this.var_354 != null)
               {
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         _loc3_.roomWidgetFactory = this.var_1265;
         _loc3_.sessionDataManager = this.var_425;
         ...
         _loc3_.avatarEditor = this.var_1651;
         _loc3_.catalog = this._catalog;
         _loc3_.adManager = this.var_354;
         _loc3_.localization = this._localization;
         _loc3_.habboHelp = this.var_1340;
         _loc3_.moderation = this.var_1118;
         _loc3_.config = this._config;
         _loc3_.soundManager = this._soundManager;
         _loc3_.habboTracking = this._habboTracking;
         _loc3_.userDefinedRoomEvents = this.var_1373;
         ...
         if(_loc3_.showInterstitial())
         {
            ...
            this.var_2954 = param1.roomCategory;
         }
         else
         {
            this.var_1667 = false;
         }
         this.var_355.add(_loc2_,_loc3_);
         return _loc3_;
      }
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:RoomDesktop = this.var_355.remove(param1) as RoomDesktop;
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getWidgetState(RoomWidgetEnum.const_338);
            if(_loc3_ != RoomDesktop.const_496)
            {
               this.var_1668 = _loc3_;
            }
            _loc2_.dispose();
            this.var_1667 = false;
         }
      ...
      {
         return this.var_355.getValue(param1) as RoomDesktop;
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            _loc3_ = this.var_355.getWithIndex(_loc2_) as RoomDesktop;
            if(_loc3_ != null)
            {
               _loc3_.update();
            }
