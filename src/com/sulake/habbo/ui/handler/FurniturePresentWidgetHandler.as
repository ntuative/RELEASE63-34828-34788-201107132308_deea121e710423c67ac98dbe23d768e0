package com.sulake.habbo.ui.handler
{
   ...
   public class FurniturePresentWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      private static const const_1571:String = "poster";
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_935,RoomWidgetPresentOpenMessage.const_198];
      }
            ...
            case RoomWidgetFurniToWidgetMessage.const_935:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = _loc5_.getNumber(RoomObjectVariableEnum.const_248);
                     _loc8_ = _loc5_.getString(RoomObjectVariableEnum.const_381);
               ...
               break;
            case RoomWidgetPresentOpenMessage.const_198:
      ...
      {
         return [RoomSessionPresentEvent.const_344];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         if(this._container != null && this._container.events != null && param1 != null)
         {
            switch(param1.type)
            {
               case RoomSessionPresentEvent.const_344:
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     switch(_loc2_.itemType)
                     {
                        case ProductTypeEnum.const_63:
                           ...
                           {
                              _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_617,0,this._container.localization.getKey("inventory.furni.item.floor.name"),false,null);
                           }
                           ...
                           {
                              _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_506,0,this._container.localization.getKey("inventory.furni.item.wallpaper.name"),false,null);
                           }
                           else
                           {
                              if(_loc3_ != null && _loc3_.name == const_1571)
                              {
                                 break;
                              }
                        ...
                        case ProductTypeEnum.const_375:
                           _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_673,0,this._container.localization.getKey("widget.furni.present.hc"),false,null);
                           break;
                        default:
