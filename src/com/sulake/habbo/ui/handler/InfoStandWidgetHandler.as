package com.sulake.habbo.ui.handler
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         {
            this.var_242.events.addEventListener(NowPlayingEvent.const_105,this.onNowPlayingChanged);
            this.var_242.events.addEventListener(SongInfoReceivedEvent.const_97,this.onSongInfoReceivedEvent);
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_192,this.onUserTags);
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_209,this.onBadgeImage);
            }
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_192,this.onUserTags);
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_209,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_242 != null)
         {
            this.var_242.events.removeEventListener(NowPlayingEvent.const_105,this.onNowPlayingChanged);
            this.var_242.events.removeEventListener(SongInfoReceivedEvent.const_97,this.onSongInfoReceivedEvent);
            this.var_242 = null;
         }
         this.var_1154 = true;
         this.container = null;
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_658);
         _loc1_.push(RoomWidgetRoomObjectMessage.const_762);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_284);
         _loc1_.push(RoomWidgetFurniActionMessage.const_824);
         _loc1_.push(RoomWidgetFurniActionMessage.const_958);
         _loc1_.push(RoomWidgetFurniActionMessage.const_956);
         _loc1_.push(RoomWidgetFurniActionMessage.const_1203);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_979);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_761);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1942);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_259);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_745);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_520)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_259 || param1.type == RoomWidgetUserActionMessage.const_614 || param1.type == RoomWidgetUserActionMessage.const_621)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_658:
               return this.handleGetObjectInfoMessage(param1 as RoomWidgetRoomObjectMessage);
            case RoomWidgetRoomObjectMessage.const_762:
            ...
            case RoomWidgetUserActionMessage.const_650:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1187,_loc3_.name);
            ...
            case RoomWidgetFurniActionMessage.const_824:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_284:
            ...
            case RoomWidgetFurniActionMessage.const_958:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_956:
               this._container.roomEngine.useRoomObjectInActiveRoom(_loc5_,_loc6_);
               break;
            case RoomWidgetFurniActionMessage.const_1203:
               ...
               break;
            case RoomWidgetUserActionMessage.const_259:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_979:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_761:
            ...
            case RoomWidgetPetCommandMessage.const_585:
               ...
               break;
            case RoomWidgetChangeMottoMessage.const_745:
      ...
      private function handleGetObjectNameMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               {
                  _loc11_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_248);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_322);
               _loc6_.id = param1.id;
               ...
               else if(_loc8_.getNumber(RoomObjectVariableEnum.const_867) == 1)
               {
                  _loc6_.extraParam = RoomWidgetInfostandExtraParamEnum.const_1371;
               }
               ...
               {
                  _loc24_ = _loc8_.getNumber(RoomObjectVariableEnum.const_248);
                  if(param1.category == RoomObjectCategoryEnum.const_27)
                  {
               ...
               _loc11_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1355);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc28_ = "";
                  _loc29_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_566)
                  {
                  ...
                  else if(_loc6_.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_406) == 0)
                  {
                     _loc31_ = _loc6_.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_406.length);
            ...
            case RoomObjectCategoryEnum.const_29:
               ...
               if(_loc12_.type == RoomObjectTypeEnum.const_220)
               {
                  this._container.roomSession.userDataManager.requestPetInfo(_loc12_.webID);
                  return null;
               }
               if(_loc12_.type == RoomObjectTypeEnum.const_129)
               {
                  _loc13_ = "null";
               ...
               {
                  if(_loc12_.type != RoomObjectTypeEnum.const_647)
                  {
                     return null;
                  }
                  _loc13_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc14_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_355);
               }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_168)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc38_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_837);
                  ...
                  if(!_loc34_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_747;
                  }
                  if(!_loc35_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_960;
                  }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc15_.push(RoomWidgetUserInfoUpdateEvent.const_1790);
               }
               else
               {
      ...
      {
         return [RoomSessionUserBadgesEvent.const_147];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_147:
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_837);
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_242 != null)
         {
            ...
            if(_loc2_ != null)
            {
               this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_435,param1.id,_loc2_.name,_loc2_.creator));
            }
         }
      }
   }
