package com.sulake.habbo.ui.widget
{
   ...
   public class RoomWidgetFactory extends Component implements IRoomWidgetFactory
   {
      ...
      private var var_3101:IAssetLibrary;
      ...
      public function RoomWidgetFactory(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_3101 = param1.root.assets;
      ...
      public function createWidget(param1:String, param2:IRoomWidgetHandler) : IRoomWidget
      {
         ...
         switch(param1)
         {
            case RoomWidgetEnum.const_405:
               _loc3_ = new RoomChatWidget(param2,this._windowManager,assets,this.var_76,this.var_156,this.var_3005++,this);
               break;
            case RoomWidgetEnum.const_335:
               _loc3_ = new RoomChatInputWidget(param2,this._windowManager,assets,this.var_76,this.var_156,this);
               break;
            case RoomWidgetEnum.const_611:
               _loc3_ = new InfostandWidget(param2,this._windowManager,assets,this.var_76,this.var_156,this._catalog);
               break;
            case RoomWidgetEnum.const_502:
               _loc3_ = new MeMenuWidget(param2,this._windowManager,assets,this.var_76,events,this.var_156);
               break;
            ...
            case RoomWidgetEnum.const_501:
               _loc3_ = new TeaserFurniWidget(param2,this._windowManager,assets,this.var_76,this.var_156,this.var_12);
               break;
            ...
            case RoomWidgetEnum.const_603:
               _loc3_ = new LoadingBarWidget(param2,this._windowManager,assets,this.var_76,this.var_156);
               break;
            case RoomWidgetEnum.const_628:
               _loc3_ = new RoomQueueWidget(param2,this._windowManager,assets,this.var_76,this.var_156);
               break;
            case RoomWidgetEnum.const_135:
               _loc3_ = new VoteWidget(param2,this._windowManager,assets,this.var_76,this.var_156);
               break;
            ...
            case RoomWidgetEnum.const_139:
               _loc3_ = new AvatarInfoWidget(param2,this._windowManager,assets,this.var_156,this.var_76,this);
               break;
            ...
            case RoomWidgetEnum.const_615:
               _loc3_ = new PlayListEditorWidget(param2,this._windowManager,this._soundManager,assets,this.var_76,this.var_156,this._catalog);
               break;
