package com.sulake.habbo.ui.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1579:int = 250;
      
      private static const const_1580:int = 0;
      
      private static const BOTTOM_MARGIN:int = 55;
      
      private static const const_1578:String = "${widgets.chatinput.say}";
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget)
      {
         super();
         this._widget = param1;
         this.var_1283 = param1.localizations.getKey("widgets.chatinput.mode.whisper",":tell");
         this.var_2715 = param1.localizations.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2714 = param1.localizations.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_399 = new Timer(1000,1);
         this.var_399.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_399.reset();
            this.var_399.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
            this.var_399 = null;
         }
      ...
      private function createWindow() : void
      {
         ...
         this.var_1976 = this._window.findChildByName("input_border");
         this._button = this._window.findChildByName("send_button");
         this.var_1975 = this._window.findChildByName("send_button_text");
         this.var_1580 = this._window.findChildByName("block_text");
         this.var_1975.caption = const_1578;
         ...
         this.var_27.addEventListener(WindowKeyboardEvent.const_191,this.windowKeyEventProcessor);
         this.var_27.addEventListener(WindowKeyboardEvent.const_362,this.keyUpHandler);
         this.var_27.addEventListener(WindowEvent.const_113,this.onInputChanged);
         ...
         this._window.addEventListener(WindowEvent.const_578,this.updatePosition);
      }
      ...
      private function updatePosition(param1:WindowEvent = null) : void
      {
         ...
         var _loc4_:int = (this._window.desktop.width - this.var_1976.width) / 2 - _loc3_;
         var _loc5_:int = this._window.desktop.width - this._window.width - const_1579 - _loc3_;
         this._window.x = Math.max(Math.min(_loc4_,_loc5_),const_1580);
      }
      ...
      private function windowKeyEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ == Keyboard.BACKSPACE)
         {
            if(this.var_27 != null)
            {
               ...
               _loc8_ = _loc7_.split(" ");
               if(_loc8_[0] == this.var_1283 && _loc8_.length == 3 && _loc8_[2] == "")
               {
                  this.var_27.text = "";
                  this.var_691 = "";
               }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(_loc2_.text.length > this.var_691.length + 1)
            {
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_690);
