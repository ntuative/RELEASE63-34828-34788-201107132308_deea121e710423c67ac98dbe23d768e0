package com.sulake.habbo.ui.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_79,HabboWindowStyle.const_31,0 | 0,new Rectangle(const_1442,const_1441,2,2),null,0) as IWindowContainer;
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         if(this.var_439 != null)
         {
            this.var_439.setValue(this.var_1459);
         }
         this.var_589 = this.colors.indexOf(_loc2_.color);
         if(this.var_621 != null)
         {
            this.var_621.setSelectedColorIndex(this.var_589);
         }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1458 = XML(_loc1_.content);
         return this.var_1458;
      }
