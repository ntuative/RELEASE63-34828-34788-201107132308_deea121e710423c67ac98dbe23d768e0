package com.sulake.habbo.ui.widget.furniture.stickie
{
   ...
   public class SpamWallPostItFurniWidget extends StickieFurniWidget
   {
      ...
      {
         param1.addEventListener(RoomWidgetSpamWallPostItEditEvent.const_569,this.onEditPostItRequest);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetSpamWallPostItEditEvent.const_569,this.onEditPostItRequest);
      }
      ...
      override protected function sendUpdate() : void
      {
         ...
         if(var_239 != -1)
         {
            ...
            {
               _loc1_ = new RoomWidgetSpamWallPostItFinishEditingMessage(RoomWidgetSpamWallPostItFinishEditingMessage.const_901,var_239,this.var_488,_text,var_362);
