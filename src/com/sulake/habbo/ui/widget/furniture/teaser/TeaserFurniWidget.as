package com.sulake.habbo.ui.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_2362:int = 1;
      
      private const const_2364:int = 2;
      ...
      private const const_2082:String = "deco_img";
      
      private const const_2085:String = "dialog_bg";
      
      private const const_2363:String = "%campaign%_dialog_bg.png";
      ...
      public function TeaserFurniWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IHabboConfigurationManager, param6:IHabboInventory)
      {
         ...
         this.var_1564 = this.var_156.getKey("image.library.url","http://images.habbo.com/c_images/");
         this.var_1564 += "Viral/";
      }
      ...
      override public function dispose() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1563.length)
         {
            _loc2_ = this.var_1563.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_156 = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_1019,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_1014,this.onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_533:
               ...
               this._shareId = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_1014:
               ...
               this._shareId = null;
               this.var_1562 = param1.itemCategory;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_1019:
               _loc2_ = this.const_2088;
         ...
         if(this._window && (this.var_1565 != _loc2_ || _loc3_ != this.var_198))
         {
            this._window.dispose();
            this._window = null;
         }
         this.var_198 = _loc3_;
         this.var_1565 = _loc2_;
         this.mainWindow;
         this.showInterface();
      }
         ...
         if(!this._window)
         {
            switch(this.var_1565)
            {
               case this.const_2083:
                  ...
                  break;
               case this.const_2088:
                  if(this.var_433 == this.const_2361)
                  {
                  ...
                  else if(this.var_433 == this.const_2362)
                  {
                  ...
                  else if(this.var_433 == this.const_2356)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                  ...
                  else if(this.var_433 == this.const_2358)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_198,"client.show.not_enough_fb_friends");
                  ...
                  else if(this.var_433 == this.const_2360)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
            ...
            _loc5_ = this.const_2363.replace("%campaign%",this.var_198);
            this.setDecoImage(_loc5_,this.const_2085);
            _loc2_ = _loc2_.replace("%campaign%",this.var_198);
            this.setDecoImage(_loc2_,this.const_2082);
            if(_loc3_)
            {
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(this.var_12)
         {
            if(this.var_1562 != 0)
            {
               this.var_12.toggleInventoryPage(this.var_1562 == 1 ? "null" : InventoryCategory.const_137);
            }
         }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_764,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1563.push(new ImageDownloader(this,_assets,this.var_198,this.var_1564,param1,param2));
            return;
         }
