package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private static const const_1645:uint = 14342874;
      
      private static const const_1647:uint = 3815994;
      
      private static const const_1651:uint = 2085362;
      
      private static const const_1654:uint = 39616;
      
      private static const const_1657:uint = 10513106;
      
      private static const const_1648:uint = 8734654;
      
      private static const const_1658:uint = 9094430;
      
      private static const const_1652:uint = 6200576;
      
      private static const const_1649:String = "happiness";
      
      private static const const_1655:String = "experience";
      
      private static const const_1650:String = "energy";
      
      private static const const_1653:int = 250;
      
      private static const const_1131:int = 25;
      ...
      private var var_228:PetCommandTool;
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(const_1649,param1.nutrition,param1.nutritionMax,const_1654,const_1651);
         this.updateStateElement(const_1655,param1.experience,param1.experienceMax,const_1648,const_1657);
         this.updateStateElement(const_1650,param1.energy,param1.energyMax,const_1652,const_1658);
         ...
         this.updateWindow();
         this.var_585 = param1.id;
         this._petData.remove(param1.id);
         this._petData.add(param1.id,param1);
         if(this.var_228 && this.var_228.isVisible() && param1.isOwnPet)
         {
            this.var_228.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:CommandConfiguration) : void
      {
         ...
         this.var_228.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(const_1656,const_1646,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),const_1645);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,const_1647);
      ...
      private function openTrainView() : void
      {
         if(this.var_228 == null)
         {
            this.var_228 = new PetCommandTool(this._widget);
         }
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_585) as InfoStandPetData;
         if(_loc1_ != null)
         {
            this.var_228.showWindow(true);
            this.var_228.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_228 && this.var_228.getPetId() == this.var_585)
               {
                  this.var_228.showWindow(false);
               }
               break;
            case "btn_train":
               this.openTrainView();
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_434,this._widget.petData.ownerId);
      ...
      private function arrangeButtons() : void
      {
         ...
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.visible)
            {
               ...
               {
                  _loc3_ = _loc1_;
                  _loc4_ += const_1131 + const_1132;
               }
               _loc5_.x = _loc3_ - _loc5_.width;
               _loc5_.y = _loc4_;
               _loc3_ = _loc5_.x - const_1132;
            }
         }
         this.var_108.height = _loc4_ + const_1131;
         this.updateWindow();
      }
   }
}
