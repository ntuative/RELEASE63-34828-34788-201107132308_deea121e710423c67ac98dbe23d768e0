package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_1069:TagListRenderer;
      ...
      private const const_1427:int = 11184810;
      
      private const const_1428:int = 16777215;
      
      private const const_2343:int = 2000;
      
      private const const_2344:int = 50;
      
      private const const_2342:int = 23;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1069 = new TagListRenderer(param1,this.onTagSelected);
         this.var_2332 = !this._widget.config.getBoolean("menu.avatar.enabled",false);
      }
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            ...
            if(param1 == "")
            {
               ...
               _loc5_.textColor = this.const_1427;
            }
            else
            {
               _loc5_.textColor = this.const_1428;
            }
            _loc5_.enable();
         }
         else
         ...
         _loc5_.text = param1;
         _loc5_.height = Math.min(_loc5_.textHeight + this.const_1049,this.const_2344);
         _loc5_.height = Math.max(_loc5_.height,this.const_2342);
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1069.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.const_747:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc6_ = getTimer();
            if(_loc6_ - this.var_2331 > this.const_2343 && _loc4_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               _loc3_.textColor = this.const_1428;
            }
         }
         else
         {
            _loc3_.textColor = this.const_1427;
         }
      }
