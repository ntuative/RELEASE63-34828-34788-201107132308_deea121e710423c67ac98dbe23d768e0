package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private const const_2374:int = 1100;
      ...
      public function PetCommandTool(param1:InfostandWidget)
      {
         ...
         this.var_416 = new Timer(this.const_2374);
         this.var_416.addEventListener(TimerEvent.TIMER,this.onButtonDisableTimeout);
      }
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:CommandConfiguration = this.var_1371.getValue(param1) as CommandConfiguration;
         if(_loc6_ == null)
         {
            this.disableAllButtons();
            this.requestEnabledCommands(this.var_585);
         }
         else
         {
      ...
      {
         var _loc2_:CommandConfiguration = this.var_1371.getValue(this.var_585) as CommandConfiguration;
      ...
      {
         this.var_1371.remove(param1);
         this.var_1371.add(param1,param2);
      ...
      private function createCommandWindow() : void
      {
         ...
         this.var_42.position = const_1570;
      }
      ...
      private function openInfoWindow() : void
      {
         ...
         if(this.var_495 == null)
         {
            ...
            this.var_495 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(this.var_495 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            this.var_495.x = 200;
            this.var_495.procedure = this.onInfoWindowProcedure;
         }
         else
         {
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_259,this.var_585));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_585,this.var_585,this.var_2138 + " " + _loc6_);
      ...
      private function onTrainButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc6_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_585,this.var_585,this.var_2138 + " " + _loc5_);
