package com.sulake.habbo.ui.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_523:Sprite = null;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_523.removeEventListener(MouseEvent.CLICK,this.clickHandler);
            this.var_523 = null;
         }
         if(this.var_48 != null)
         {
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         if(this.var_523 == null)
         {
            this.var_523 = new Sprite();
            this.var_523.addChild(new Bitmap(this.var_48));
            this.var_523.addEventListener(MouseEvent.CLICK,this.clickHandler);
         }
         else
         {
            _loc5_ = this.var_523.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = this.var_48;
            }
         }
         _loc2_.setDisplayObject(this.var_523);
      ...
      private function clickHandler(param1:Event) : void
      {
         if(this.var_1299 != "")
         {
            HabboWebTools.openWebPage(this.var_1299);
         }
      }
   }
}
