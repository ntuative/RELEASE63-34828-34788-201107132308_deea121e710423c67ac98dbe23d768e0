package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuSoundSettingsSlider
   {
      ...
      private var var_1874:MeMenuSoundSettingsView;
      ...
      {
         return int(this.var_1727 * (Number(param1 - this._minValue) / (this.var_1258 - this._minValue)));
      }
      
      private function getValue(param1:Number) : Number
      {
         return param1 / this.var_1727 * (this.var_1258 - this._minValue) + this._minValue;
      }
      ...
      private function buttonProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_1874.saveVolume(this.getValue(param2.x),false);
      }
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc3_ != null && this.var_761 != null)
         {
            _loc3_.bitmap = new BitmapData(this.var_761.width,this.var_761.height,true,16777215);
            _loc3_.bitmap.copyPixels(this.var_761,this.var_761.rect,new Point(0,0),null,null,true);
         }
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null && this.var_760 != null)
               {
                  _loc3_.bitmap = new BitmapData(this.var_760.width,this.var_760.height,true,16777215);
                  _loc3_.bitmap.copyPixels(this.var_760,this.var_760.rect,new Point(0,0),null,null,true);
                  _loc2_.procedure = this.buttonProcedure;
                  this.var_1727 = _loc1_.width - _loc3_.width;
               }
            }
         }
      }
