package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      private var var_1000:MeMenuSoundSettingsSlider;
      ...
      {
         this.var_995 = param1.volume;
         if(this.var_1000 != null)
         {
            this.var_1000.setValue(this.var_995);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_996 = (_loc5_.content as BitmapData).clone();
         }
         ...
         this.var_1000 = new MeMenuSoundSettingsSlider(this,this._window.findChildByName("volume_container") as IWindowContainer,this._widget.assets,0,1);
         this.updateSoundIcons();
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_973));
      }
      ...
      private function updateSoundIcons() : void
      {
         ...
         else
         {
            ...
            this.setBitmapWrapperContent("sounds_off_icon",this.var_996);
         }
      }
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_846);
         }
         else
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_822);
         }
