package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuWidget extends RoomWidgetBase
   {
      ...
      public static const const_523:String = "me_menu_my_clothes_view";
      
      public static const const_1288:String = "me_menu_dance_moves_view";
      
      public static const const_783:String = "me_menu_settings_view";
      
      public static const const_801:String = "me_menu_sound_settings";
      ...
      public function MeMenuWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IEventDispatcher, param6:IHabboConfigurationManager)
      {
         ...
         if(false)
         {
            this.var_2761 = param6.getBoolean("client.news.embed.enabled",false);
         }
         this.var_1918 = this._config.getBoolean("menu.own_avatar.enabled",false);
      ...
      {
         return var_943 as MeMenuWidgetHandler;
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWaveUpdateEvent.const_911,this.onWaveEvent);
         param1.addEventListener(RoomWidgetDanceUpdateEvent.const_873,this.onDanceEvent);
         param1.addEventListener(RoomWidgetUpdateEffectsUpdateEvent.const_811,this.onUpdateEffects);
         param1.addEventListener(RoomWidgetToolbarClickedUpdateEvent.const_813,this.onToolbarClicked);
         param1.addEventListener(RoomWidgetAvatarEditorUpdateEvent.const_1202,this.onAvatarEditorClosed);
         param1.addEventListener(RoomWidgetAvatarEditorUpdateEvent.const_1268,this.onHideAvatarEditor);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_166,this.onAvatarDeselected);
         param1.addEventListener(RoomWidgetHabboClubUpdateEvent.const_291,this.onHabboClubEvent);
         param1.addEventListener(RoomWidgetUserInfoUpdateEvent.const_108,this.onUserInfo);
         param1.addEventListener(RoomWidgetSettingsUpdateEvent.const_397,this.onSettingsUpdate);
         param1.addEventListener(RoomWidgetTutorialEvent.const_138,this.onTutorialEvent);
         ...
         param1.addEventListener(RoomWidgetRoomEngineUpdateEvent.const_411,this.onGameMode);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWaveUpdateEvent.const_911,this.onWaveEvent);
         param1.removeEventListener(RoomWidgetDanceUpdateEvent.const_873,this.onDanceEvent);
         param1.removeEventListener(RoomWidgetUpdateEffectsUpdateEvent.const_811,this.onUpdateEffects);
         param1.removeEventListener(RoomWidgetToolbarClickedUpdateEvent.const_813,this.onToolbarClicked);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_166,this.onAvatarDeselected);
         param1.removeEventListener(RoomWidgetHabboClubUpdateEvent.const_291,this.onHabboClubEvent);
         param1.removeEventListener(RoomWidgetAvatarEditorUpdateEvent.const_1202,this.onHideAvatarEditor);
         param1.removeEventListener(RoomWidgetAvatarEditorUpdateEvent.const_1268,this.onAvatarEditorClosed);
         param1.removeEventListener(RoomWidgetUserInfoUpdateEvent.const_108,this.onUserInfo);
         param1.removeEventListener(RoomWidgetSettingsUpdateEvent.const_397,this.onSettingsUpdate);
         param1.removeEventListener(RoomWidgetTutorialEvent.const_639,this.onTutorialEvent);
         param1.removeEventListener(RoomWidgetTutorialEvent.const_138,this.onTutorialEvent);
      ...
      private function onUserInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         if(!(this.var_566 && this.var_53.window.name == const_523))
         {
      ...
      private function onSettingsUpdate(param1:RoomWidgetSettingsUpdateEvent) : void
      {
         ...
         if(this.var_53.window.name == const_801)
         {
      ...
      private function onTutorialEvent(param1:RoomWidgetTutorialEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetTutorialEvent.const_639:
               Logger.log("* MeMenuWidget: onHighlightClothesIcon " + this.var_566 + " view: " + this.var_53.window.name);
               if(this.var_566 != true || this.var_53.window.name != const_196)
               {
                  return;
               }
               (this.var_53 as MeMenuMainView).setIconAssets("clothes_icon",const_196,"clothes_highlighter_blue");
               break;
            case RoomWidgetTutorialEvent.const_138:
               this.hide();
         }
      }
      ...
      private function onToolbarClicked(param1:RoomWidgetToolbarClickedUpdateEvent) : void
      {
         ...
         if(this.var_566)
         {
            _loc2_ = new RoomWidgetMeMenuMessage(RoomWidgetMeMenuMessage.const_925);
            if(messageListener != null)
            {
               messageListener.processWidgetMessage(_loc2_);
            }
      ...
      {
         if(this.var_53 != null && this.var_53.window.name != const_523)
         {
            this.hide();
         }
      }
      ...
      {
         var _loc2_:* = param1.daysLeft != this.var_1588;
         this.var_1588 = param1.daysLeft;
         this.var_2763 = param1.periodsLeft;
         this.var_3087 = param1.pastPeriods;
         this.var_2760 = param1.allowClubDances;
         _loc2_ = Boolean(_loc2_ || param1.clubLevel != this.var_2000);
         this.var_2000 = param1.clubLevel;
         if(_loc2_)
         {
            if(this.var_53 != null)
            {
      ...
      private function onCreditBalance(param1:RoomWidgetPurseUpdateEvent) : void
      {
         ...
         this.var_2762 = param1.balance;
         localizations.registerParameter("widget.memenu.credits","credits",this.var_2762.toString());
      }
