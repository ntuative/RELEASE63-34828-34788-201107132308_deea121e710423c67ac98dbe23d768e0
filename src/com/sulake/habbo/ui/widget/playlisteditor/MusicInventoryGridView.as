   ...
   public class MusicInventoryGridView
   {
      ...
      public function refresh() : void
      {
         ...
         while(_loc5_ < _loc4_)
         {
            ...
            this.var_686.addGridItem(_loc12_.window);
      ...
      public function setPreviewIconToPause() : void
      {
         ...
         {
            this.var_112.playButtonState = MusicInventoryGridItem.const_1302;
         }
      }
      ...
      public function setPreviewIconToPlay() : void
      {
         if(this.var_112 != null)
         {
            this.var_112.playButtonState = MusicInventoryGridItem.const_558;
         }
      }
      ...
      private function gridItemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || _loc3_)
         {
            ...
            {
               if(this.var_112.playButtonState == MusicInventoryGridItem.const_558)
               {
                  this.var_112.playButtonState = MusicInventoryGridItem.const_1266;
            ...
            {
               _loc4_ = this.var_686.getGridItemIndex(param1.window);
               if(_loc4_ != -1)
               {
