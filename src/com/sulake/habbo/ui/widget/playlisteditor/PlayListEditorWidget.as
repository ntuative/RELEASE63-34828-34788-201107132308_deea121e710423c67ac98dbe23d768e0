package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListEditorWidget extends RoomWidgetBase
   {
      ...
      private static const const_1555:int = 130;
      
      private static const const_1553:int = 100;
      
      private static const const_1554:int = 130;
      
      private static const const_1557:int = 100;
      
      private static const const_1558:int = 130;
      
      private static const const_1556:int = 100;
      ...
      {
         param1.addEventListener(RoomWidgetPlayListEditorEvent.const_1025,this.onShowPlayListEditorEvent);
         param1.addEventListener(RoomWidgetPlayListEditorEvent.const_736,this.onHidePlayListEditorEvent);
         ...
         param1.addEventListener(RoomWidgetPlayListEditorEvent.const_143,this.onPlayListFullEvent);
      ...
      {
         param1.removeEventListener(RoomWidgetPlayListEditorEvent.const_1025,this.onShowPlayListEditorEvent);
         param1.removeEventListener(RoomWidgetPlayListEditorEvent.const_736,this.onHidePlayListEditorEvent);
         ...
         param1.removeEventListener(RoomWidgetPlayListEditorEvent.const_143,this.onPlayListFullEvent);
      ...
      public function getDiskColorTransformFromSongData(param1:String) : ColorTransform
      {
         ...
         _loc2_ = uint(_loc2_ % const_1553 + const_1555);
         _loc3_ = uint(_loc3_ % const_1557 + const_1554);
         _loc4_ = uint(_loc4_ % const_1556 + const_1558);
      ...
      public function sendAddToPlayListMessage(param1:int) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc4_ = new RoomWidgetPlayListModificationMessage(RoomWidgetPlayListModificationMessage.const_855,_loc3_,param1);
      ...
      {
         var _loc2_:RoomWidgetPlayListModificationMessage = new RoomWidgetPlayListModificationMessage(RoomWidgetPlayListModificationMessage.const_814,param1);
         if(messageListener != null)
         {
      ...
      public function sendTogglePlayPauseStateMessage() : void
      {
         ...
         var _loc2_:RoomWidgetPlayListPlayStateMessage = new RoomWidgetPlayListPlayStateMessage(RoomWidgetPlayListPlayStateMessage.const_968,this._furniId,_loc1_);
         if(messageListener != null)
         {
            messageListener.processWidgetMessage(_loc2_);
         }
      ...
      {
         var _loc2_:String = this.var_144.getKey("image.library.playlist.url");
         ...
         _loc5_.addEventListener(AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE,this.method_12);
      }
      
      public function openSongDiskShopCataloguePage() : void
      {
         var _loc1_:RoomWidgetPlayListUserActionMessage = new RoomWidgetPlayListUserActionMessage(RoomWidgetPlayListUserActionMessage.const_833);
         if(messageListener != null)
         {
            messageListener.processWidgetMessage(_loc1_);
         }
         this._catalog.openCatalogPage(CatalogPageName.const_2017,true);
      }
      ...
      private function method_12(param1:AssetLoaderEvent) : void
      {
         var _loc2_:* = null;
