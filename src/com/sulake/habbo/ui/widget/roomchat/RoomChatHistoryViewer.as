package com.sulake.habbo.ui.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_1614:int = 18;
      ...
      private var var_204:RoomChatHistoryPulldown;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_1154 = false;
         this._widget = param1;
         this.var_204 = new RoomChatHistoryPulldown(param1,param2,param3,param4);
         this.var_204.state = RoomChatHistoryPulldown.const_296;
         ...
         this.var_54 = param2.createWindow("chatscroller","",HabboWindowType.const_1360,HabboWindowStyle.const_47,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         this.var_204.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_296);
      }
      ...
      public function get visible() : Boolean
      {
         ...
         return this.var_204.state == RoomChatHistoryPulldown.const_461 || this.var_204.state == RoomChatHistoryPulldown.const_623;
      }
      ...
      {
         if(!this.var_475 && !this.var_1765)
         {
            this.var_475 = true;
            this.setHistoryViewerScrollbar(true);
            this.var_204.state = RoomChatHistoryPulldown.const_461;
            if(this._widget != null)
            {
      ...
      public function containerResized(param1:Rectangle, param2:Boolean = false) : void
      {
         ...
         if(this.var_204 != null)
         {
            this.var_204.containerResized(param1);
         }
      }
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_476 > 0 && param2)
         {
            if(this.var_2039)
            {
               if(Math.abs(param1 - this.var_476) <= const_1189)
               {
                  return;
               }
               this.var_2039 = false;
            ...
            if(this.var_475)
            {
               ...
               _loc5_ = (param1 - this.var_476) / this.var_54.height;
               ...
               _loc7_ = true;
               _loc8_ = true;
               if(this.var_54.scrollV < 1 - const_1614 / this.var_54.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
