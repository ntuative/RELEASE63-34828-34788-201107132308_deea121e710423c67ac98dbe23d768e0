package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private var var_2048:ProfilerOutput;
      
      private var var_1612:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_227 = new Array(const_483);
         ...
         this.var_687 = this.var_227[const_1617];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_2048)
            {
               this.var_2048 = new ProfilerOutput(context,this,this._windowRenderer);
            }
            this.var_2048.profiler = _loc3_;
            this.var_1612 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1612);
            this.var_1613 = new ProfilerAgentTask("Redraw","Window rasterizer");
      ...
      {
         return this.var_687.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      {
         return this.var_687.getWindowParser().windowToXMLString(param1);
      }
      ...
      {
         return this.var_227[param1].getDesktopWindow().getChildAt(this.var_687.getDesktopWindow().numChildren - 1);
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1962,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1922,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1786,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1779,param2.name + ": " + param2.toString());
            }
         }
      }
