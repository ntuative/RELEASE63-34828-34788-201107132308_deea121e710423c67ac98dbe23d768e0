package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_1722:int = 50;
      
      private static const const_1164:Number = 60;
      
      private static const const_1721:Number = 50;
      ...
      private var var_311:BitmapDataCache;
      
      private var var_732:RoomObjectCache;
      
      private var var_594:Array;
      
      private var var_735:Array;
      
      private var var_1690:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_3001:Number = -1.0E7;
      
      private var var_3004:Number = -1.0E7;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this.var_310.addChild(this.var_116);
         ...
         this.var_311 = new BitmapDataCache(16,32,1);
         var _loc6_:* = null;
         ...
         this.var_732 = new RoomObjectCache(_loc6_);
         this.var_819 = new ColorTransform();
         this.var_731 = new Matrix();
      ...
      {
         this.var_592.x -= param1 - this.var_736;
         this.var_736 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_592.y -= param1 - this.var_734;
         this.var_734 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_969 = true;
            if(this.var_164 != null && !this.var_310.contains(this.var_164))
            {
               this.var_310.addChild(this.var_164);
               this.var_116.mask = this.var_164;
            }
         }
         else if(!param1 && this.var_969)
         {
            ...
            if(this.var_164 != null && this.var_310.contains(this.var_164))
            {
               this.var_310.removeChild(this.var_164);
      ...
      {
         this.var_732.removeObjectCache(param1);
      }
      
      public function render(param1:int) : void
      {
         this.var_2171 = !this.var_2171;
         ...
         if(this.var_593 != this.var_2999 || this.var_591 != this.var_3000)
         {
            _loc8_ = true;
         }
         if(this.var_116.x != this.var_736 || this.var_116.y != this.var_734)
         {
            this.var_116.x = this.var_736;
            this.var_116.y = this.var_734;
            _loc8_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_594.sortOn("z",0 | 0);
         if(_loc5_ < this.var_594.length)
         {
            this.var_594.splice(_loc5_);
         }
         var _loc9_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc9_ = this.var_594[_loc4_] as SortableSprite;
            if(_loc9_ != null)
            {
         ...
         this.var_2999 = this.var_593;
         this.var_3000 = this.var_591;
      }
      ...
      private function calculateUpdateInterval(param1:int) : void
      {
         ...
         if(this.var_1689 > 0)
         {
            _loc2_ = param1 - this.var_1689;
            if(_loc2_ > const_1164 * 3)
            {
               Logger.log("Really slow frame update " + _loc2_ + "ms");
               this.var_3003 = _loc2_;
            }
            if(_loc2_ <= MAXIMUM_VALID_FRAME_UPDATE_INTERVAL)
            {
               ++this.var_918;
               if(this.var_918 == const_391 + 1)
               {
                  this.var_547 = _loc2_;
                  this.var_2170 = this.var_3002;
               }
               else if(this.var_918 > const_391 + 1)
               {
                  _loc3_ = Number(this.var_918 - const_391);
                  this.var_547 = this.var_547 * (_loc3_ - 1) / _loc3_ + Number(_loc2_) / _loc3_;
                  this.var_2170 = this.var_2170 * (_loc3_ - 1) / _loc3_ + Number(this.var_3002) / _loc3_;
                  if(this.var_918 > const_391 + const_1722)
                  {
                     this.var_918 = const_391;
                     if(!this.var_1394 && this.var_547 > const_1164)
                     {
                        this.var_1394 = true;
                        Logger.log("Room canvas updating really slow - now entering frame skipping mode...");
                     }
                     else if(this.var_1394 && this.var_547 < const_1721)
                     {
                        this.var_1394 = false;
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            this.var_732.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = this.var_732.getObjectCache(param2);
         ...
         _loc6_.update(this._geometry,param3,!_loc9_.isEmpty || param4,this.var_2171 && this.var_1394);
         ...
         _loc13_ += int(this.var_593 / 2);
         _loc14_ += int(this.var_591 / 2);
         var _loc16_:int = 0;
         var _loc17_:* = null;
         var _loc18_:* = null;
         var _loc19_:int = 0;
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_736;
                  ...
                  if(this.rectangleVisible(_loc19_,_loc20_,_loc22_.width,_loc22_.height))
                  {
                     ...
                     if(_loc17_ == null)
                     {
                        ...
                        this.var_594.push(_loc17_);
                        _loc17_.name = param2;
                     }
                     _loc17_.sprite = _loc18_;
                     _loc17_.x = _loc19_ - this.var_736;
      ...
      {
         if(param1 < this.var_593 && param1 + param3 >= 0 && (param2 < this.var_591 && param2 + param4 >= 0))
         {
            if(!this.var_3099)
            {
               return true;
      ...
      private function rectangleVisibleWithExclusion(param1:int, param2:int, param3:int, param4:int) : Boolean
      {
         ...
         if(param1 + param3 >= this.var_593)
         {
            param3 -= this.var_593 + 1 - (param1 + param3);
         }
         if(param2 + param4 >= this.var_591)
         {
            param4 -= this.var_591 + 1 - (param2 + param4);
         }
         for each(_loc5_ in this.var_2998)
         {
      ...
      {
         if(param1 < 0 || param1 >= this.var_1133)
         {
            return null;
         }
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(param2 < 0 || param2 >= this.var_1133)
         {
      ...
      {
         if(param1 < 0 || param1 >= this.var_594.length)
         {
            return null;
         }
         return this.var_594[param1] as SortableSprite;
      }
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:Boolean, param5:int) : BitmapData
      {
         ...
         if((param3 || param4) && param5 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc6_ = this.var_311.getBitmapData(_loc7_);
            }
            if(_loc6_ == null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     this.var_311.addBitmapData(_loc7_,_loc6_);
                  }
                  return _loc6_;
               }
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false, param4:Boolean = true, param5:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(name.length > 0)
         {
            finalData = this.var_311.getBitmapData(cacheName);
            if(!allowCreation)
            {
               return finalData;
            }
         ...
         if(finalData == null)
         {
            ...
            this.var_731.identity();
            if(flipH)
            {
               this.var_731.scale(-1,1);
               this.var_731.translate(data.width,0);
            }
            if(flipV)
            {
               this.var_731.scale(1,-1);
               this.var_731.translate(0,data.height);
            }
            finalData.draw(data,this.var_731);
            if(name.length > 0)
            {
               this.var_311.addBitmapData(cacheName,finalData);
            }
         }
         return finalData;
      }
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            this.var_819.redMultiplier = tR;
            this.var_819.greenMultiplier = tG;
            this.var_819.blueMultiplier = tB;
            finalData.colorTransform(finalData.rect,this.var_819);
            if(name.length > 0)
            {
               this.var_311.addBitmapData(cacheName,finalData);
            }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         param1 -= this.var_736;
         param2 -= this.var_734;
         this.var_592.x = param1;
         this.var_592.y = param2;
         if(this.var_1395 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_2172;
         }
         this.var_2172 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1395;
         return this.var_2172;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_593 / 2;
         var _loc12_:Number = param2 - this.var_591 / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_2173,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_733.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_733.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_3001 || param2 != this.var_3004)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_733.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_733.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  this.bufferMouseEvent(_loc11_,_loc9_);
         ...
         while(_loc1_ < this.var_423.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1690.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
      ...
      public function update() : void
      {
         if(this.var_1395 == 0)
         {
            this.checkMouseHits(this.var_592.x,this.var_592.y,MouseEvent.MOUSE_MOVE);
         }
         this.var_1395 = 0;
         ++this.var_2173;
      }
