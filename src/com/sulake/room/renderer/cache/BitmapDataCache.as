package com.sulake.room.renderer.cache
{
   ...
   public class BitmapDataCache
   {
      ...
      public function BitmapDataCache(param1:int, param2:int, param3:int = 1)
      {
         ...
         this.var_2151 = param2 * 1024 * 1024;
         this.var_1676 = param3 * 1024 * 1024;
         if(this.var_1676 < 0)
         {
            this.var_1676 = 0;
         }
      ...
      {
         this.var_1125 += this.var_1676;
         if(this.var_1125 > this.var_2151)
         {
            this.var_1125 = this.var_2151;
         }
      }
      ...
      public function addBitmapData(param1:String, param2:ExtendedBitmapData) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               this.var_902 -= _loc4_.width * _loc4_.height * 4;
            }
         ...
         this.var_902 += param2.width * param2.height * 4;
      }
   }
}
