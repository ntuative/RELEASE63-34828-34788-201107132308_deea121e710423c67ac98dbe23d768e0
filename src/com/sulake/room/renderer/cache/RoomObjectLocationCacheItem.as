package com.sulake.room.renderer.cache
{
   ...
   public class RoomObjectLocationCacheItem
   {
      ...
      public function getScreenLocation(param1:IRoomObject, param2:IRoomGeometry) : IVector3d
      {
         ...
         if(param2.updateId != this.var_1852 || param1.getUpdateID() != this.var_2539)
         {
            this.var_2539 = param1.getUpdateID();
            if(param2.updateId != this.var_1852 || _loc4_.x != this.var_1236.x || _loc4_.y != this.var_1236.y || _loc4_.z != this.var_1236.z)
            {
               this.var_1852 = param2.updateId;
               this.var_1236.assign(_loc4_);
               _loc3_ = true;
            }
         }
         this.var_2540 = _loc3_;
         if(_loc3_)
         {
