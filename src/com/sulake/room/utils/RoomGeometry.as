package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_601:Number = 64;
      
      public static const const_1276:Number = 32;
      ...
      private var var_1353:Vector3d;
      
      private var var_488:Vector3d;
      
      private var _direction:Vector3d;
      
      private var var_1352:Vector3d;
      ...
      private var var_2118:Number = 1.0;
      
      private var var_2119:Number = 1.0;
      
      private var var_2117:Number = 1.0;
      
      private var var_106:Vector3d;
      
      private var var_490:Vector3d;
      
      private var var_3092:Number = -500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_1353 = new Vector3d();
         this.var_488 = new Vector3d();
         this._direction = new Vector3d();
         this.var_1352 = new Vector3d();
         this.var_2118 = 1;
         this.var_2119 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_2117 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         this.var_488.assign(this.var_106);
         this.var_488.x *= this.var_487;
         this.var_488.y *= this.var_489;
      ...
      {
         if(this.var_487 != param1 * this.var_2118)
         {
            this.var_487 = param1 * this.var_2118;
            ++this.var_185;
         }
      }
      ...
      {
         if(this.var_489 != param1 * this.var_2119)
         {
            this.var_489 = param1 * this.var_2119;
            ++this.var_185;
         }
      }
      ...
      {
         if(this.var_486 != param1 * this.var_2117)
         {
            this.var_486 = param1 * this.var_2117;
            ++this.var_185;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_106.x /= this.var_487;
         this.var_106.y /= this.var_489;
         this.var_106.z /= this.var_486;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_1353.assign(this.var_171);
         }
         else
         {
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1352.assign(_loc22_);
         }
         else
         {
            this.var_1352.assign(_loc17_);
         }
         ++this.var_185;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.x *= this.var_487;
         _loc2_.y *= this.var_489;
         _loc2_.z *= this.var_486;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1352);
         if(_loc3_ < this.var_3092 || _loc3_ > this.var_3093)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_489;
            _loc2_.z *= this.var_486;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1352);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_106.x * this.var_487,this.var_106.y * this.var_489,this.var_106.z * this.var_486);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_171;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_487,param2.y * this.var_489,param2.z * this.var_486);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_487,param3.y * this.var_489,param3.z * this.var_486);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_487,param4.y * this.var_489,param4.z * this.var_486);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1276;
         }
         else
         {
            this.scale = const_601;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_601;
      }
